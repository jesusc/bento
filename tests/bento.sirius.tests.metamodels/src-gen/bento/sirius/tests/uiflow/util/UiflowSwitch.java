 ...
 * @generated
 */
public class UiflowSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case UiflowPackage.VIEW: {
				View view = (View)theEObject;
				T result = caseView(view);
				if (result == null) result = caseFlowElement(view);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
