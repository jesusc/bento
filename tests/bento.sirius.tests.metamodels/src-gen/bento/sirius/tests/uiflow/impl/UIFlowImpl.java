 ...
 * </p>
 * <ul>
 *   <li>{@link bento.sirius.tests.uiflow.impl.UIFlowImpl#getElements <em>Elements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UIFlowImpl extends MinimalEObjectImpl.Container implements UIFlow {
	/**
	...
	protected EClass eStaticClass() {
		return UiflowPackage.Literals.UI_FLOW;
	}
	...
	public EList<FlowElement> getElements() {
		if (elements == null) {
			elements = new EObjectContainmentEList<FlowElement>(FlowElement.class, this, UiflowPackage.UI_FLOW__ELEMENTS);
		}
		return elements;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case UiflowPackage.UI_FLOW__ELEMENTS:
