...
public class LinkedListImpl extends MinimalEObjectImpl.Container implements LinkedList {
	 ...
	 * @ordered
	 */
	protected EList<ListNode> nodes;
	 ...
	 */
	@Override
	public EList<ListNode> getNodes() {
		if (nodes == null) {
			nodes = new EObjectContainmentEList<ListNode>(ListNode.class, this, LinkedlistPackage.LINKED_LIST__NODES);
		}
		return nodes;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case LinkedlistPackage.LINKED_LIST__NODES:
				getNodes().clear();
				getNodes().addAll((Collection<? extends ListNode>)newValue);
				return;
		}
