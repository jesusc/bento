...
public class NetworkSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case NetworkPackage.NETWORK_MODEL: {
				NetworkModel networkModel = (NetworkModel)theEObject;
				T result = caseNetworkModel(networkModel);
			...
			case NetworkPackage.COMPUTER: {
				Computer computer = (Computer)theEObject;
				T result = caseComputer(computer);
				if (result == null) result = caseNetworkNode(computer);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case NetworkPackage.ROUTER: {
				...
				if (result == null) result = caseNetworkNode(router);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case NetworkPackage.NETWORK_CONNECTION: {
	 ...
	 * @generated
	 */
	public T caseNetworkModel(NetworkModel object) {
		return null;
	}
