...
public class WorkflowSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case WorkflowPackage.FLOW_DIAGRAM: {
			...
			case WorkflowPackage.FINAL_TASK: {
			...
			case WorkflowPackage.SYNCHRONIZATION: {
			...
			case WorkflowPackage.EXCLUSIVE_CHOICE: {
			...
			case WorkflowPackage.SIMPLE_MERGE: {
			...
			case WorkflowPackage.FLOW_EDGE: {
