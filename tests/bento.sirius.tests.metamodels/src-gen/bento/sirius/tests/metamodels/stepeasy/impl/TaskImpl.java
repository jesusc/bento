 ...
 * </p>
 * <ul>
 *   <li>{@link bento.sirius.tests.metamodels.stepeasy.impl.TaskImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class TaskImpl extends MinimalEObjectImpl.Container implements Task {
	...
	protected EClass eStaticClass() {
		return StepeasyPackage.Literals.TASK;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StepeasyPackage.TASK__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case StepeasyPackage.TASK__NAME:
				return getName();
		}
