 ...
 * </p>
 * <ul>
 *   <li>{@link metamodel.impl.StorageOutputFlowImpl#getSource <em>Source</em>}</li>
 *   <li>{@link metamodel.impl.StorageOutputFlowImpl#getDestination <em>Destination</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StorageOutputFlowImpl extends FlowImpl implements StorageOutputFlow {
	 ...
	 * @ordered
	 */
	protected metamodel.Process destination;
	...
	public metamodel.Process getDestination() {
		if (destination != null && destination.eIsProxy()) {
			...
			destination = (metamodel.Process)eResolveProxy(oldDestination);
	 ...
	 * @generated
	 */
	public metamodel.Process basicGetDestination() {
		return destination;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetDestination(metamodel.Process newDestination, NotificationChain msgs) {
		metamodel.Process oldDestination = destination;
	...
	public void setDestination(metamodel.Process newDestination) {
		if (newDestination != destination) {
			NotificationChain msgs = null;
			if (destination != null)
				msgs = ((InternalEObject)destination).eInverseRemove(this, MetamodelPackage.PROCESS__STORAGE_OUTPUT_FLOW, metamodel.Process.class, msgs);
			if (newDestination != null)
				msgs = ((InternalEObject)newDestination).eInverseAdd(this, MetamodelPackage.PROCESS__STORAGE_OUTPUT_FLOW, metamodel.Process.class, msgs);
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case MetamodelPackage.STORAGE_OUTPUT_FLOW__DESTINATION:
				if (destination != null)
					msgs = ((InternalEObject)destination).eInverseRemove(this, MetamodelPackage.PROCESS__STORAGE_OUTPUT_FLOW, metamodel.Process.class, msgs);
				return basicSetDestination((metamodel.Process)otherEnd, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case MetamodelPackage.STORAGE_OUTPUT_FLOW__SOURCE:
				...
				return;
			case MetamodelPackage.STORAGE_OUTPUT_FLOW__DESTINATION:
				setDestination((metamodel.Process)newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case MetamodelPackage.STORAGE_OUTPUT_FLOW__SOURCE:
				...
				return;
			case MetamodelPackage.STORAGE_OUTPUT_FLOW__DESTINATION:
				setDestination((metamodel.Process)null);
				return;
		}
