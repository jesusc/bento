 ...
 * </p>
 * <ul>
 *   <li>{@link metamodel.impl.OrderOnStockThresholdImpl#getPeriod <em>Period</em>}</li>
 *   <li>{@link metamodel.impl.OrderOnStockThresholdImpl#getThreshold <em>Threshold</em>}</li>
 *   <li>{@link metamodel.impl.OrderOnStockThresholdImpl#getName <em>Name</em>}</li>
 *   <li>{@link metamodel.impl.OrderOnStockThresholdImpl#getOrderQuantity <em>Order Quantity</em>}</li>
 *   <li>{@link metamodel.impl.OrderOnStockThresholdImpl#getOrderType <em>Order Type</em>}</li>
 *   <li>{@link metamodel.impl.OrderOnStockThresholdImpl#getSupplier <em>Supplier</em>}</li>
 *   <li>{@link metamodel.impl.OrderOnStockThresholdImpl#getStorage <em>Storage</em>}</li>
 * </ul>
 *
 * @generated
 */
