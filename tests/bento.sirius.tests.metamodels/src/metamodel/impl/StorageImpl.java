 ...
 * </p>
 * <ul>
 *   <li>{@link metamodel.impl.StorageImpl#getSize <em>Size</em>}</li>
 *   <li>{@link metamodel.impl.StorageImpl#getInitialContent <em>Initial Content</em>}</li>
 *   <li>{@link metamodel.impl.StorageImpl#isOverflow <em>Overflow</em>}</li>
 *   <li>{@link metamodel.impl.StorageImpl#getStorageOutputFlow <em>Storage Output Flow</em>}</li>
 *   <li>{@link metamodel.impl.StorageImpl#getOrderOnStockThreshold <em>Order On Stock Threshold</em>}</li>
 *   <li>{@link metamodel.impl.StorageImpl#getProcessOutputFlow <em>Process Output Flow</em>}</li>
 * </ul>
 *
 * @generated
 */
