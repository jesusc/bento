 ...
 * </p>
 * <ul>
 *   <li>{@link sequence_bdsl.impl.IntemediateElementImpl#getBindingElement <em>Binding Element</em>}</li>
 *   <li>{@link sequence_bdsl.impl.IntemediateElementImpl#getMetamodElelement <em>Metamod Elelement</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IntemediateElementImpl extends MinimalEObjectImpl.Container implements IntemediateElement {
	...
	protected EClass eStaticClass() {
		return Sequence_bdslPackage.Literals.INTEMEDIATE_ELEMENT;
	}
		...
		if (bindingElement != null && bindingElement.eIsProxy()) {
			...
			if (bindingElement != oldBindingElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Sequence_bdslPackage.INTEMEDIATE_ELEMENT__BINDING_ELEMENT, oldBindingElement, bindingElement));
			}
		}
	...
	public void setBindingElement(BindingElement newBindingElement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Sequence_bdslPackage.INTEMEDIATE_ELEMENT__BINDING_ELEMENT, oldBindingElement, bindingElement));
	}
	...
	public MetamodelElement getMetamodElelement() {
		if (metamodElelement != null && metamodElelement.eIsProxy()) {
			...
			if (metamodElelement != oldMetamodElelement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Sequence_bdslPackage.INTEMEDIATE_ELEMENT__METAMOD_ELELEMENT, oldMetamodElelement, metamodElelement));
			}
		}
	...
	public void setMetamodElelement(MetamodelElement newMetamodElelement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Sequence_bdslPackage.INTEMEDIATE_ELEMENT__METAMOD_ELELEMENT, oldMetamodElelement, metamodElelement));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Sequence_bdslPackage.INTEMEDIATE_ELEMENT__BINDING_ELEMENT:
				if (resolve) return getBindingElement();
				return basicGetBindingElement();
			case Sequence_bdslPackage.INTEMEDIATE_ELEMENT__METAMOD_ELELEMENT:
