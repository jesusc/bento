 ...
 * </p>
 * <ul>
 *   <li>{@link workflow_bdsl.impl.VirtualAttributeImpl#getTo_virtualAttribute <em>To virtual Attribute</em>}</li>
 *   <li>{@link workflow_bdsl.impl.VirtualAttributeImpl#getName <em>Name</em>}</li>
 *   <li>{@link workflow_bdsl.impl.VirtualAttributeImpl#getExpression <em>Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VirtualAttributeImpl extends MinimalEObjectImpl.Container implements VirtualAttribute {
	...
	protected EClass eStaticClass() {
		return Workflow_bdslPackage.Literals.VIRTUAL_ATTRIBUTE;
	}
		...
		if (to_virtualAttribute != null && to_virtualAttribute.eIsProxy()) {
			...
			if (to_virtualAttribute != oldTo_virtualAttribute) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Workflow_bdslPackage.VIRTUAL_ATTRIBUTE__TO_VIRTUAL_ATTRIBUTE, oldTo_virtualAttribute, to_virtualAttribute));
			}
		}
	...
	public void setTo_virtualAttribute(BindingAttribute newTo_virtualAttribute) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Workflow_bdslPackage.VIRTUAL_ATTRIBUTE__TO_VIRTUAL_ATTRIBUTE, oldTo_virtualAttribute, to_virtualAttribute));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Workflow_bdslPackage.VIRTUAL_ATTRIBUTE__NAME, oldName, name));
	}
	...
	public void setExpression(String newExpression) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Workflow_bdslPackage.VIRTUAL_ATTRIBUTE__EXPRESSION, oldExpression, expression));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Workflow_bdslPackage.VIRTUAL_ATTRIBUTE__TO_VIRTUAL_ATTRIBUTE:
				if (resolve) return getTo_virtualAttribute();
				return basicGetTo_virtualAttribute();
			case Workflow_bdslPackage.VIRTUAL_ATTRIBUTE__NAME:
				return getName();
			case Workflow_bdslPackage.VIRTUAL_ATTRIBUTE__EXPRESSION:
