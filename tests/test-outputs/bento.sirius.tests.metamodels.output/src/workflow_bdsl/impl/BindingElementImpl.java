 ...
 * </p>
 * <ul>
 *   <li>{@link workflow_bdsl.impl.BindingElementImpl#getNoneElement <em>None Element</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class BindingElementImpl extends MinimalEObjectImpl.Container implements BindingElement {
	...
	protected EClass eStaticClass() {
		return Workflow_bdslPackage.Literals.BINDING_ELEMENT;
	}
	...
	public EList<NoneElement> getNoneElement() {
		if (noneElement == null) {
			noneElement = new EObjectResolvingEList<NoneElement>(NoneElement.class, this, Workflow_bdslPackage.BINDING_ELEMENT__NONE_ELEMENT);
		}
		return noneElement;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Workflow_bdslPackage.BINDING_ELEMENT__NONE_ELEMENT:
