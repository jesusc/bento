 ...
 * </p>
 * <ul>
 *   <li>{@link workflow_bdsl.impl.MetamodelElementImpl#getVirtualAttribute <em>Virtual Attribute</em>}</li>
 *   <li>{@link workflow_bdsl.impl.MetamodelElementImpl#getMetamodelElementFeature <em>Metamodel Element Feature</em>}</li>
 *   <li>{@link workflow_bdsl.impl.MetamodelElementImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MetamodelElementImpl extends MinimalEObjectImpl.Container implements MetamodelElement {
	...
	protected EClass eStaticClass() {
		return Workflow_bdslPackage.Literals.METAMODEL_ELEMENT;
	}
	...
	public EList<VirtualAttribute> getVirtualAttribute() {
		if (virtualAttribute == null) {
			virtualAttribute = new EObjectContainmentEList<VirtualAttribute>(VirtualAttribute.class, this, Workflow_bdslPackage.METAMODEL_ELEMENT__VIRTUAL_ATTRIBUTE);
		}
	...
	public EList<MetamodelElementFeature> getMetamodelElementFeature() {
		if (metamodelElementFeature == null) {
			metamodelElementFeature = new EObjectContainmentEList<MetamodelElementFeature>(MetamodelElementFeature.class, this, Workflow_bdslPackage.METAMODEL_ELEMENT__METAMODEL_ELEMENT_FEATURE);
		}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Workflow_bdslPackage.METAMODEL_ELEMENT__NAME, oldName, name));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Workflow_bdslPackage.METAMODEL_ELEMENT__VIRTUAL_ATTRIBUTE:
				return ((InternalEList<?>)getVirtualAttribute()).basicRemove(otherEnd, msgs);
			case Workflow_bdslPackage.METAMODEL_ELEMENT__METAMODEL_ELEMENT_FEATURE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case Workflow_bdslPackage.METAMODEL_ELEMENT__NAME:
				return getName();
		}
