 ...
 * </p>
 * <ul>
 *   <li>{@link mindstorms_bdsl.impl.MetamodelElementFeatureImpl#getFeatureClass <em>Feature Class</em>}</li>
 *   <li>{@link mindstorms_bdsl.impl.MetamodelElementFeatureImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MetamodelElementFeatureImpl extends MinimalEObjectImpl.Container implements MetamodelElementFeature {
	...
	protected EClass eStaticClass() {
		return Mindstorms_bdslPackage.Literals.METAMODEL_ELEMENT_FEATURE;
	}
	...
	public EList<BindingAttribute> getFeatureClass() {
		if (featureClass == null) {
			featureClass = new EObjectResolvingEList<BindingAttribute>(BindingAttribute.class, this, Mindstorms_bdslPackage.METAMODEL_ELEMENT_FEATURE__FEATURE_CLASS);
		}
		return featureClass;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Mindstorms_bdslPackage.METAMODEL_ELEMENT_FEATURE__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Mindstorms_bdslPackage.METAMODEL_ELEMENT_FEATURE__FEATURE_CLASS:
				return getFeatureClass();
			case Mindstorms_bdslPackage.METAMODEL_ELEMENT_FEATURE__NAME:
				return getName();
		}
