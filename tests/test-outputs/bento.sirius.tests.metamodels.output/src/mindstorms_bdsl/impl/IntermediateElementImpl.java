 ...
 * </p>
 * <ul>
 *   <li>{@link mindstorms_bdsl.impl.IntermediateElementImpl#getBindingElement <em>Binding Element</em>}</li>
 *   <li>{@link mindstorms_bdsl.impl.IntermediateElementImpl#getMetamodelElement <em>Metamodel Element</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IntermediateElementImpl extends MinimalEObjectImpl.Container implements IntermediateElement {
	...
	protected EClass eStaticClass() {
		return Mindstorms_bdslPackage.Literals.INTERMEDIATE_ELEMENT;
	}
		...
		if (bindingElement != null && bindingElement.eIsProxy()) {
			...
			if (bindingElement != oldBindingElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Mindstorms_bdslPackage.INTERMEDIATE_ELEMENT__BINDING_ELEMENT, oldBindingElement, bindingElement));
			}
		}
	...
	public void setBindingElement(BindingElement newBindingElement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Mindstorms_bdslPackage.INTERMEDIATE_ELEMENT__BINDING_ELEMENT, oldBindingElement, bindingElement));
	}
	...
	public EList<MetamodelElement> getMetamodelElement() {
		if (metamodelElement == null) {
			metamodelElement = new EObjectResolvingEList<MetamodelElement>(MetamodelElement.class, this, Mindstorms_bdslPackage.INTERMEDIATE_ELEMENT__METAMODEL_ELEMENT);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Mindstorms_bdslPackage.INTERMEDIATE_ELEMENT__BINDING_ELEMENT:
				if (resolve) return getBindingElement();
				return basicGetBindingElement();
			case Mindstorms_bdslPackage.INTERMEDIATE_ELEMENT__METAMODEL_ELEMENT:
