 ...
 * </p>
 * <ul>
 *   <li>{@link scenes_bdsl.impl.MetamodelElementFeatureImpl#getName <em>Name</em>}</li>
 *   <li>{@link scenes_bdsl.impl.MetamodelElementFeatureImpl#getFeatureClass <em>Feature Class</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MetamodelElementFeatureImpl extends MinimalEObjectImpl.Container implements MetamodelElementFeature {
	...
	protected EClass eStaticClass() {
		return Scenes_bdslPackage.Literals.METAMODEL_ELEMENT_FEATURE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Scenes_bdslPackage.METAMODEL_ELEMENT_FEATURE__NAME, oldName, name));
	}
	...
	public EList<FeatureClass> getFeatureClass() {
		if (featureClass == null) {
			featureClass = new EObjectResolvingEList<FeatureClass>(FeatureClass.class, this, Scenes_bdslPackage.METAMODEL_ELEMENT_FEATURE__FEATURE_CLASS);
		}
		return featureClass;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Scenes_bdslPackage.METAMODEL_ELEMENT_FEATURE__NAME:
				return getName();
			case Scenes_bdslPackage.METAMODEL_ELEMENT_FEATURE__FEATURE_CLASS:
