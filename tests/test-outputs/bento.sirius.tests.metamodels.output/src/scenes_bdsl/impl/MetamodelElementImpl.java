 ...
 * </p>
 * <ul>
 *   <li>{@link scenes_bdsl.impl.MetamodelElementImpl#getName <em>Name</em>}</li>
 *   <li>{@link scenes_bdsl.impl.MetamodelElementImpl#getMetamodelElementFeature <em>Metamodel Element Feature</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MetamodelElementImpl extends MinimalEObjectImpl.Container implements MetamodelElement {
	...
	protected EClass eStaticClass() {
		return Scenes_bdslPackage.Literals.METAMODEL_ELEMENT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Scenes_bdslPackage.METAMODEL_ELEMENT__NAME, oldName, name));
	}
	...
	public EList<MetamodelElementFeature> getMetamodelElementFeature() {
		if (metamodelElementFeature == null) {
			metamodelElementFeature = new EObjectContainmentEList<MetamodelElementFeature>(MetamodelElementFeature.class, this, Scenes_bdslPackage.METAMODEL_ELEMENT__METAMODEL_ELEMENT_FEATURE);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Scenes_bdslPackage.METAMODEL_ELEMENT__METAMODEL_ELEMENT_FEATURE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Scenes_bdslPackage.METAMODEL_ELEMENT__NAME:
				return getName();
			case Scenes_bdslPackage.METAMODEL_ELEMENT__METAMODEL_ELEMENT_FEATURE:
