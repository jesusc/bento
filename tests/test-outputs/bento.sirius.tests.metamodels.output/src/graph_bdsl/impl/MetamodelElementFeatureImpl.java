 ...
 * </p>
 * <ul>
 *   <li>{@link graph_bdsl.impl.MetamodelElementFeatureImpl#getFeatureClass <em>Feature Class</em>}</li>
 *   <li>{@link graph_bdsl.impl.MetamodelElementFeatureImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MetamodelElementFeatureImpl extends MinimalEObjectImpl.Container implements MetamodelElementFeature {
	...
	protected EClass eStaticClass() {
		return Graph_bdslPackage.Literals.METAMODEL_ELEMENT_FEATURE;
	}
	...
	public EList<BindingAttribute> getFeatureClass() {
		if (featureClass == null) {
			featureClass = new EObjectResolvingEList<BindingAttribute>(BindingAttribute.class, this, Graph_bdslPackage.METAMODEL_ELEMENT_FEATURE__FEATURE_CLASS);
		}
		return featureClass;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Graph_bdslPackage.METAMODEL_ELEMENT_FEATURE__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Graph_bdslPackage.METAMODEL_ELEMENT_FEATURE__FEATURE_CLASS:
				return getFeatureClass();
			case Graph_bdslPackage.METAMODEL_ELEMENT_FEATURE__NAME:
				return getName();
		}
