 ...
 * <ul>
 *   <li>{@link org.emftext.language.gbind.impl.ClassBindingImpl#getConcept <em>Concept</em>}</li>
 *   <li>{@link org.emftext.language.gbind.impl.ClassBindingImpl#getConcrete <em>Concrete</em>}</li>
 *   <li>{@link org.emftext.language.gbind.impl.ClassBindingImpl#getWhenClause <em>When Clause</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ClassBindingImpl extends ConceptBindingImpl implements ClassBinding {
	...
	protected EClass eStaticClass() {
		return GbindPackage.Literals.CLASS_BINDING;
	}
		...
		if (concept != null && concept.eIsProxy()) {
			...
			if (concept != oldConcept) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, GbindPackage.CLASS_BINDING__CONCEPT, oldConcept, concept));
			}
		}
		return concept;
	}
	...
	public void setConcept(ConceptMetaclass newConcept) {
		...
		concept = newConcept;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GbindPackage.CLASS_BINDING__CONCEPT, oldConcept, concept));
	}
	...
	public EList<ConcreteMetaclass> getConcrete() {
		if (concrete == null) {
			concrete = new EObjectResolvingEList<ConcreteMetaclass>(ConcreteMetaclass.class, this, GbindPackage.CLASS_BINDING__CONCRETE);
		}
		return concrete;
	}
	...
	public NotificationChain basicSetWhenClause(OclExpression newWhenClause, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, GbindPackage.CLASS_BINDING__WHEN_CLAUSE, oldWhenClause, newWhenClause);
	...
	public void setWhenClause(OclExpression newWhenClause) {
		if (newWhenClause != whenClause) {
			...
			if (whenClause != null)
				msgs = ((InternalEObject)whenClause).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - GbindPackage.CLASS_BINDING__WHEN_CLAUSE, null, msgs);
			if (newWhenClause != null)
				msgs = ((InternalEObject)newWhenClause).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - GbindPackage.CLASS_BINDING__WHEN_CLAUSE, null, msgs);
			msgs = basicSetWhenClause(newWhenClause, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GbindPackage.CLASS_BINDING__WHEN_CLAUSE, newWhenClause, newWhenClause));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case GbindPackage.CLASS_BINDING__WHEN_CLAUSE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case GbindPackage.CLASS_BINDING__CONCEPT:
				if (resolve) return getConcept();
				return basicGetConcept();
			case GbindPackage.CLASS_BINDING__CONCRETE:
				return getConcrete();
			case GbindPackage.CLASS_BINDING__WHEN_CLAUSE:
