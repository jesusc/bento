 ...
 * <ul>
 *   <li>{@link org.emftext.language.gbind.impl.RenamingFeatureBindingImpl#getConcreteFeature <em>Concrete Feature</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RenamingFeatureBindingImpl extends BaseFeatureBindingImpl implements RenamingFeatureBinding {
	...
	protected EClass eStaticClass() {
		return GbindPackage.Literals.RENAMING_FEATURE_BINDING;
	}
	...
	public void setConcreteFeature(String newConcreteFeature) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GbindPackage.RENAMING_FEATURE_BINDING__CONCRETE_FEATURE, oldConcreteFeature, concreteFeature));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case GbindPackage.RENAMING_FEATURE_BINDING__CONCRETE_FEATURE:
