 ...
 * <ul>
 *   <li>{@link org.emftext.language.gbind.impl.ConceptBindingImpl#getDebugName <em>Debug Name</em>}</li>
 *   <li>{@link org.emftext.language.gbind.impl.ConceptBindingImpl#getModel_ <em>Model </em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class ConceptBindingImpl extends EObjectImpl implements ConceptBinding {
	...
	protected EClass eStaticClass() {
		return GbindPackage.Literals.CONCEPT_BINDING;
	}
	...
	public void setDebugName(String newDebugName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GbindPackage.CONCEPT_BINDING__DEBUG_NAME, oldDebugName, debugName));
	}
	...
	public BindingModel getModel_() {
		if (eContainerFeatureID() != GbindPackage.CONCEPT_BINDING__MODEL_) return null;
	...
	public NotificationChain basicSetModel_(BindingModel newModel_, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newModel_, GbindPackage.CONCEPT_BINDING__MODEL_, msgs);
		return msgs;
	}
	...
	public void setModel_(BindingModel newModel_) {
		if (newModel_ != eInternalContainer() || (eContainerFeatureID() != GbindPackage.CONCEPT_BINDING__MODEL_ && newModel_ != null)) {
			...
			if (newModel_ != null)
				msgs = ((InternalEObject)newModel_).eInverseAdd(this, GbindPackage.BINDING_MODEL__BINDINGS, BindingModel.class, msgs);
			msgs = basicSetModel_(newModel_, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GbindPackage.CONCEPT_BINDING__MODEL_, newModel_, newModel_));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case GbindPackage.CONCEPT_BINDING__MODEL_:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case GbindPackage.CONCEPT_BINDING__MODEL_:
				return eInternalContainer().eInverseRemove(this, GbindPackage.BINDING_MODEL__BINDINGS, BindingModel.class, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case GbindPackage.CONCEPT_BINDING__DEBUG_NAME:
				return getDebugName();
			case GbindPackage.CONCEPT_BINDING__MODEL_:
				return getModel_();
		}
