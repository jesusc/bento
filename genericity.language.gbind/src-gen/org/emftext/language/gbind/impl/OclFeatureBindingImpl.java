 ...
 * <ul>
 *   <li>{@link org.emftext.language.gbind.impl.OclFeatureBindingImpl#getConcrete <em>Concrete</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OclFeatureBindingImpl extends BaseFeatureBindingImpl implements OclFeatureBinding {
	...
	protected EClass eStaticClass() {
		return GbindPackage.Literals.OCL_FEATURE_BINDING;
	}
	...
	public NotificationChain basicSetConcrete(OclExpression newConcrete, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, GbindPackage.OCL_FEATURE_BINDING__CONCRETE, oldConcrete, newConcrete);
	...
	public void setConcrete(OclExpression newConcrete) {
		if (newConcrete != concrete) {
			...
			if (concrete != null)
				msgs = ((InternalEObject)concrete).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - GbindPackage.OCL_FEATURE_BINDING__CONCRETE, null, msgs);
			if (newConcrete != null)
				msgs = ((InternalEObject)newConcrete).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - GbindPackage.OCL_FEATURE_BINDING__CONCRETE, null, msgs);
			msgs = basicSetConcrete(newConcrete, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GbindPackage.OCL_FEATURE_BINDING__CONCRETE, newConcrete, newConcrete));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case GbindPackage.OCL_FEATURE_BINDING__CONCRETE:
