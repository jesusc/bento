...
import gbind.dsl.impl.DslPackageImpl;

import gbind.simpleocl.AddOpCallExp;
import gbind.simpleocl.Attribute;
import gbind.simpleocl.BagExp;
import gbind.simpleocl.BagType;
import gbind.simpleocl.BooleanExp;
import gbind.simpleocl.BooleanType;
import gbind.simpleocl.BraceExp;
import gbind.simpleocl.CollectionExp;
import gbind.simpleocl.CollectionOperationCall;
import gbind.simpleocl.CollectionType;
import gbind.simpleocl.EnumLiteralExp;
import gbind.simpleocl.EnvExp;
import gbind.simpleocl.EnvType;
import gbind.simpleocl.EqOpCallExp;
import gbind.simpleocl.IfExp;
import gbind.simpleocl.Import;
...
import gbind.simpleocl.LambdaCallExp;
import gbind.simpleocl.LambdaType;
import gbind.simpleocl.LetExp;
import gbind.simpleocl.LocalVariable;
import gbind.simpleocl.LocatedElement;
import gbind.simpleocl.LoopExp;
import gbind.simpleocl.MapElement;
import gbind.simpleocl.MapExp;
import gbind.simpleocl.MapType;
import gbind.simpleocl.Module;
import gbind.simpleocl.ModuleElement;
...
import gbind.simpleocl.NumericExp;
import gbind.simpleocl.NumericType;
import gbind.simpleocl.OclAnyType;
import gbind.simpleocl.OclContextDefinition;
import gbind.simpleocl.OclExpression;
import gbind.simpleocl.OclFeature;
import gbind.simpleocl.OclFeatureDefinition;
import gbind.simpleocl.OclInstanceModel;
import gbind.simpleocl.OclMetamodel;
import gbind.simpleocl.OclModel;
import gbind.simpleocl.OclModelElement;
...
import gbind.simpleocl.OrderedSetExp;
import gbind.simpleocl.OrderedSetType;
import gbind.simpleocl.Parameter;
import gbind.simpleocl.Primitive;
import gbind.simpleocl.PrimitiveExp;
...
import gbind.simpleocl.SequenceType;
import gbind.simpleocl.SetExp;
import gbind.simpleocl.SetType;
import gbind.simpleocl.SimpleoclFactory;
import gbind.simpleocl.SimpleoclPackage;
import gbind.simpleocl.StaticNavigationOrAttributeCall;
import gbind.simpleocl.StaticOperationCall;
import gbind.simpleocl.StaticPropertyCall;
import gbind.simpleocl.StaticPropertyCallExp;
import gbind.simpleocl.StringExp;
import gbind.simpleocl.StringType;
import gbind.simpleocl.SuperExp;
import gbind.simpleocl.TupleExp;
import gbind.simpleocl.TuplePart;
import gbind.simpleocl.TupleType;
import gbind.simpleocl.TupleTypeAttribute;
...
public class SimpleoclPackageImpl extends EPackageImpl implements SimpleoclPackage {
	 ...
	 * @see gbind.simpleocl.SimpleoclPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
