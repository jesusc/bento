 ...
 * <ul>
 *   <li>{@link gbind.dsl.impl.BaseFeatureBindingImpl#getConceptFeature <em>Concept Feature</em>}</li>
 *   <li>{@link gbind.dsl.impl.BaseFeatureBindingImpl#getConceptClass <em>Concept Class</em>}</li>
 *   <li>{@link gbind.dsl.impl.BaseFeatureBindingImpl#getQualifier <em>Qualifier</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BaseFeatureBindingImpl extends ConceptBindingImpl implements BaseFeatureBinding {
	...
	protected EClass eStaticClass() {
		return DslPackage.Literals.BASE_FEATURE_BINDING;
	}
	...
	public void setConceptFeature(String newConceptFeature) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DslPackage.BASE_FEATURE_BINDING__CONCEPT_FEATURE, oldConceptFeature, conceptFeature));
	}
	...
	public ConceptMetaclass getConceptClass() {
		if (conceptClass != null && conceptClass.eIsProxy()) {
			...
			if (conceptClass != oldConceptClass) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DslPackage.BASE_FEATURE_BINDING__CONCEPT_CLASS, oldConceptClass, conceptClass));
			}
		}
		return conceptClass;
	}
	...
	public void setConceptClass(ConceptMetaclass newConceptClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DslPackage.BASE_FEATURE_BINDING__CONCEPT_CLASS, oldConceptClass, conceptClass));
	}
	...
	public ConcreteMetaclass getQualifier() {
		if (qualifier != null && qualifier.eIsProxy()) {
			...
			if (qualifier != oldQualifier) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DslPackage.BASE_FEATURE_BINDING__QUALIFIER, oldQualifier, qualifier));
			}
		}
		return qualifier;
	}
	...
	public void setQualifier(ConcreteMetaclass newQualifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DslPackage.BASE_FEATURE_BINDING__QUALIFIER, oldQualifier, qualifier));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DslPackage.BASE_FEATURE_BINDING__CONCEPT_FEATURE:
				return getConceptFeature();
			case DslPackage.BASE_FEATURE_BINDING__CONCEPT_CLASS:
				if (resolve) return getConceptClass();
				return basicGetConceptClass();
			case DslPackage.BASE_FEATURE_BINDING__QUALIFIER:
