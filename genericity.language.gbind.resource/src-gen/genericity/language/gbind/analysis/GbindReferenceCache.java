 ...
 * given name.
 */
public class GbindReferenceCache extends org.eclipse.emf.common.notify.impl.AdapterImpl implements genericity.language.gbind.IGbindReferenceCache {
	...
	private genericity.language.gbind.IGbindNameProvider nameProvider;
	
	public GbindReferenceCache(genericity.language.gbind.IGbindNameProvider nameProvider) {
		super();
