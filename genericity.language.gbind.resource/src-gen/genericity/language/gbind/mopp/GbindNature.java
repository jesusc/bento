...
public class GbindNature implements org.eclipse.core.resources.IProjectNature {
	...
	public static final String NATURE_ID = "genericity.language.gbind.resource.nature";
	 ...
	 */
	public final static String[] BUILDER_IDS = {genericity.language.gbind.mopp.GbindBuilderAdapter.BUILDER_ID};
	...
	public void configure() throws org.eclipse.core.runtime.CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(genericity.language.gbind.mopp.GbindBuilderAdapter.BUILDER_ID)) {
				return;
			}
		}
