 ...
 */
public class GbindResourceUtil {
	...
	public static java.util.Set<org.eclipse.emf.ecore.EObject> findUnresolvedProxies(org.eclipse.emf.ecore.resource.ResourceSet resourceSet) {
		return new genericity.language.gbind.util.GbindInterruptibleEcoreResolver().findUnresolvedProxies(resourceSet);
	}
	...
	public static java.util.Set<org.eclipse.emf.ecore.EObject> findUnresolvedProxies(org.eclipse.emf.ecore.resource.Resource resource) {
		return new genericity.language.gbind.util.GbindInterruptibleEcoreResolver().findUnresolvedProxies(resource);
	}
	...
	public static genericity.language.gbind.mopp.GbindResource getResource(java.io.File file) {
	...
	public static genericity.language.gbind.mopp.GbindResource getResource(org.eclipse.emf.common.util.URI uri, java.util.Map<?,?> options) {
		new genericity.language.gbind.mopp.GbindMetaInformation().registerResourceFactory();
		org.eclipse.emf.ecore.resource.ResourceSet rs = new org.eclipse.emf.ecore.resource.impl.ResourceSetImpl();
		if (options != null) {
			rs.getLoadOptions().putAll(options);
		}
		org.eclipse.emf.ecore.resource.Resource resource = rs.getResource(uri, true);
		return (genericity.language.gbind.mopp.GbindResource) resource;
	}
	 ...
	 */
	public static gbind.dsl.BindingModel getResourceContent(org.eclipse.emf.common.util.URI uri) {
	 ...
	 * Returns the root element of the resource with the given URI.
	 */
	public static gbind.dsl.BindingModel getResourceContent(org.eclipse.emf.common.util.URI uri, java.util.Map<?,?> options) {
		...
		return (gbind.dsl.BindingModel) root;
	}
	
	/**
	 * Returns the root element after parsing the given text.
	 */
	public static gbind.dsl.BindingModel getResourceContent(String text) {
	...
	public static String getText(org.eclipse.emf.ecore.EObject eObject) {
		...
		genericity.language.gbind.IGbindTextResource resource = (genericity.language.gbind.IGbindTextResource) eObject.eResource();
		if (resource != null) {
		...
		if (resource == null) {
			org.eclipse.emf.common.util.URI uri = org.eclipse.emf.common.util.URI.createURI("temp." + metaInformation.getSyntaxName());
			resource = (genericity.language.gbind.IGbindTextResource) rs.createResource(uri);
		}
		java.io.ByteArrayOutputStream outputStream = new java.io.ByteArrayOutputStream();
		genericity.language.gbind.IGbindTextPrinter printer = metaInformation.createPrinter(outputStream, resource);
		try {
