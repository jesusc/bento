...
public class TestClassMerge_EPC {
	...
	public static final String BOUND_METAMODEL  = "../genericity.benchmarks/components/flowdiagrams/epc2pn/epc.ecore";

	public static final String BINDING_MODEL    = "../genericity.benchmarks/components/flowdiagrams/epc2pn/epc.gbind.xmi";

	private static final String BOUND_METAMODEL_NAME = "EPC";
	...
	public static void main(String[] args) throws IOException {
		...
		System.out.println("Finished typing of " + TestClassMerge_EPC.class.getSimpleName());
		...
		System.out.println("Finished class merge adaptation of " + TestClassMerge_EPC.class.getSimpleName());

		atlTransformation.serialize(new FileOutputStream("tmp_/epc.adapted.atl.xmi"));
	}
