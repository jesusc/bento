...
public class AdaptCheckTransformation {
...
//	public static final String TARGET_METAMODEL_NAME = "ECORE";
	...
	public static final String ATL_TRANSFORMATION = "../genericity.benchmarks/components/flowdiagrams/trafo/flow2pn_check.atl.xmi";
...
//	public static final String TARGET_METAMODEL_NAME = "ECORE";
	...
	public static void main(String[] args) throws IOException {
		...
		inout.serialize(new FileOutputStream(
				withDir("tmp_/check_adapted.atl.xmi")));
		System.out.println("Finished "
				+ AdaptCheckTransformation.class.getSimpleName());
