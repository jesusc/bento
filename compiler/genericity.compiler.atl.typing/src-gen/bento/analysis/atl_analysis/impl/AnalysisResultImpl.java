 ...
 * <ul>
 *   <li>{@link bento.analysis.atl_analysis.impl.AnalysisResultImpl#getProblems <em>Problems</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AnalysisResultImpl extends EObjectImpl implements AnalysisResult {
	...
	public EList<Problem> getProblems() {
		if (problems == null) {
			problems = new EObjectContainmentEList<Problem>(Problem.class, this, AtlAnalysisPackage.ANALYSIS_RESULT__PROBLEMS);
		}
		return problems;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AtlAnalysisPackage.ANALYSIS_RESULT__PROBLEMS:
