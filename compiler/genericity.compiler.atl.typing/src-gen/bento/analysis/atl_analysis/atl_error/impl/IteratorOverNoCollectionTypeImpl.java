 ...
 * <ul>
 *   <li>{@link bento.analysis.atl_analysis.atl_error.impl.IteratorOverNoCollectionTypeImpl#getIteratorName <em>Iterator Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IteratorOverNoCollectionTypeImpl extends LocalProblemImpl implements IteratorOverNoCollectionType {
	...
	protected EClass eStaticClass() {
		return AtlErrorsPackage.Literals.ITERATOR_OVER_NO_COLLECTION_TYPE;
	}
	...
	public void setIteratorName(String newIteratorName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AtlErrorsPackage.ITERATOR_OVER_NO_COLLECTION_TYPE__ITERATOR_NAME, oldIteratorName, iteratorName));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AtlErrorsPackage.ITERATOR_OVER_NO_COLLECTION_TYPE__ITERATOR_NAME:
