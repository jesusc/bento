 ...
 * <ul>
 *   <li>{@link bento.analysis.atl_analysis.atl_error.impl.DifferentBranchTypesImpl#getThenType <em>Then Type</em>}</li>
 *   <li>{@link bento.analysis.atl_analysis.atl_error.impl.DifferentBranchTypesImpl#getElseType <em>Else Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DifferentBranchTypesImpl extends NavigationProblemImpl implements DifferentBranchTypes {
	...
	protected EClass eStaticClass() {
		return AtlErrorsPackage.Literals.DIFFERENT_BRANCH_TYPES;
	}
		...
		if (thenType != null && thenType.eIsProxy()) {
			...
			if (thenType != oldThenType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AtlErrorsPackage.DIFFERENT_BRANCH_TYPES__THEN_TYPE, oldThenType, thenType));
			}
		}
		return thenType;
	}
	...
	public void setThenType(Type newThenType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AtlErrorsPackage.DIFFERENT_BRANCH_TYPES__THEN_TYPE, oldThenType, thenType));
	}
	...
	public Type getElseType() {
		if (elseType != null && elseType.eIsProxy()) {
			...
			if (elseType != oldElseType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AtlErrorsPackage.DIFFERENT_BRANCH_TYPES__ELSE_TYPE, oldElseType, elseType));
			}
		}
		return elseType;
	}
	...
	public void setElseType(Type newElseType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AtlErrorsPackage.DIFFERENT_BRANCH_TYPES__ELSE_TYPE, oldElseType, elseType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AtlErrorsPackage.DIFFERENT_BRANCH_TYPES__THEN_TYPE:
				if (resolve) return getThenType();
				return basicGetThenType();
			case AtlErrorsPackage.DIFFERENT_BRANCH_TYPES__ELSE_TYPE:
