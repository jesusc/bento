 ...
 * <ul>
 *   <li>{@link bento.analysis.atl_analysis.atl_error.impl.NoContainerForRefImmediateCompositeImpl#getClassName <em>Class Name</em>}</li>
 *   <li>{@link bento.analysis.atl_analysis.atl_error.impl.NoContainerForRefImmediateCompositeImpl#getMetamodelName <em>Metamodel Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class NoContainerForRefImmediateCompositeImpl extends NavigationProblemImpl implements NoContainerForRefImmediateComposite {
	...
	protected EClass eStaticClass() {
		return AtlErrorsPackage.Literals.NO_CONTAINER_FOR_REF_IMMEDIATE_COMPOSITE;
	}
	...
	public void setClassName(String newClassName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AtlErrorsPackage.NO_CONTAINER_FOR_REF_IMMEDIATE_COMPOSITE__CLASS_NAME, oldClassName, className));
	}
	...
	public void setMetamodelName(String newMetamodelName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AtlErrorsPackage.NO_CONTAINER_FOR_REF_IMMEDIATE_COMPOSITE__METAMODEL_NAME, oldMetamodelName, metamodelName));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AtlErrorsPackage.NO_CONTAINER_FOR_REF_IMMEDIATE_COMPOSITE__CLASS_NAME:
				return getClassName();
			case AtlErrorsPackage.NO_CONTAINER_FOR_REF_IMMEDIATE_COMPOSITE__METAMODEL_NAME:
