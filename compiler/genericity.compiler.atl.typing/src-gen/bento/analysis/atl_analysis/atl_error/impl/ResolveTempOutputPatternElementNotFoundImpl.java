 ...
 * <ul>
 *   <li>{@link bento.analysis.atl_analysis.atl_error.impl.ResolveTempOutputPatternElementNotFoundImpl#getSourceType <em>Source Type</em>}</li>
 *   <li>{@link bento.analysis.atl_analysis.atl_error.impl.ResolveTempOutputPatternElementNotFoundImpl#getRules <em>Rules</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ResolveTempOutputPatternElementNotFoundImpl extends ResolveTempProblemImpl implements ResolveTempOutputPatternElementNotFound {
	...
	protected EClass eStaticClass() {
		return AtlErrorsPackage.Literals.RESOLVE_TEMP_OUTPUT_PATTERN_ELEMENT_NOT_FOUND;
	}
		...
		if (sourceType != null && sourceType.eIsProxy()) {
			...
			if (sourceType != oldSourceType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AtlErrorsPackage.RESOLVE_TEMP_OUTPUT_PATTERN_ELEMENT_NOT_FOUND__SOURCE_TYPE, oldSourceType, sourceType));
			}
		}
		return sourceType;
	}
	...
	public void setSourceType(EClass newSourceType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AtlErrorsPackage.RESOLVE_TEMP_OUTPUT_PATTERN_ELEMENT_NOT_FOUND__SOURCE_TYPE, oldSourceType, sourceType));
	}
	...
	public EList<ResolvedRuleInfo> getRules() {
		if (rules == null) {
			rules = new EObjectContainmentEList<ResolvedRuleInfo>(ResolvedRuleInfo.class, this, AtlErrorsPackage.RESOLVE_TEMP_OUTPUT_PATTERN_ELEMENT_NOT_FOUND__RULES);
		}
		return rules;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AtlErrorsPackage.RESOLVE_TEMP_OUTPUT_PATTERN_ELEMENT_NOT_FOUND__RULES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AtlErrorsPackage.RESOLVE_TEMP_OUTPUT_PATTERN_ELEMENT_NOT_FOUND__SOURCE_TYPE:
