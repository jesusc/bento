 ...
 * <ul>
 *   <li>{@link bento.analysis.atl_analysis.atl_error.impl.NoModelFoundImpl#getModelName <em>Model Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class NoModelFoundImpl extends LocalProblemImpl implements NoModelFound {
	...
	protected EClass eStaticClass() {
		return AtlErrorsPackage.Literals.NO_MODEL_FOUND;
	}
	...
	public void setModelName(String newModelName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AtlErrorsPackage.NO_MODEL_FOUND__MODEL_NAME, oldModelName, modelName));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AtlErrorsPackage.NO_MODEL_FOUND__MODEL_NAME:
				return getModelName();
		}
