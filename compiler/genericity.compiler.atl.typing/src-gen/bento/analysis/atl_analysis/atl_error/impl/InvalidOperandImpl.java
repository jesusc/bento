 ...
 * <ul>
 *   <li>{@link bento.analysis.atl_analysis.atl_error.impl.InvalidOperandImpl#getOperatorSymbol <em>Operator Symbol</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class InvalidOperandImpl extends InvalidArgumentProblemImpl implements InvalidOperand {
	...
	protected EClass eStaticClass() {
		return AtlErrorsPackage.Literals.INVALID_OPERAND;
	}
	...
	public void setOperatorSymbol(String newOperatorSymbol) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AtlErrorsPackage.INVALID_OPERAND__OPERATOR_SYMBOL, oldOperatorSymbol, operatorSymbol));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AtlErrorsPackage.INVALID_OPERAND__OPERATOR_SYMBOL:
