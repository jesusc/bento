 ...
 * <ul>
 *   <li>{@link bento.analysis.atl_analysis.atl_error.impl.OperationNotFoundInThisModuleImpl#getName <em>Name</em>}</li>
 *   <li>{@link bento.analysis.atl_analysis.atl_error.impl.OperationNotFoundInThisModuleImpl#isMaybeRule <em>Maybe Rule</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OperationNotFoundInThisModuleImpl extends NavigationProblemImpl implements OperationNotFoundInThisModule {
	...
	protected EClass eStaticClass() {
		return AtlErrorsPackage.Literals.OPERATION_NOT_FOUND_IN_THIS_MODULE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AtlErrorsPackage.OPERATION_NOT_FOUND_IN_THIS_MODULE__NAME, oldName, name));
	}
	...
	public void setMaybeRule(boolean newMaybeRule) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AtlErrorsPackage.OPERATION_NOT_FOUND_IN_THIS_MODULE__MAYBE_RULE, oldMaybeRule, maybeRule));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AtlErrorsPackage.OPERATION_NOT_FOUND_IN_THIS_MODULE__NAME:
				return getName();
			case AtlErrorsPackage.OPERATION_NOT_FOUND_IN_THIS_MODULE__MAYBE_RULE:
				return isMaybeRule();
		}
