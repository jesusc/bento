 ...
 * @generated
 */
public class AtlAnalysisSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case AtlAnalysisPackage.ANALYSIS_RESULT: {
				AnalysisResult analysisResult = (AnalysisResult)theEObject;
				T result = caseAnalysisResult(analysisResult);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AtlAnalysisPackage.ANALYSIS_INFO: {
				AnalysisInfo analysisInfo = (AnalysisInfo)theEObject;
				T result = caseAnalysisInfo(analysisInfo);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AtlAnalysisPackage.ERROR: {
				bento.analysis.atl_errors.Error error = (bento.analysis.atl_errors.Error)theEObject;
				T result = caseError(error);
				if (result == null) result = caseAnalysisInfo(error);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseError(bento.analysis.atl_errors.Error object) {
		return null;
	}
