...
public class PatternElementImpl extends atl.metamodel.ATLModelBaseObject implements PatternElement {
	
	public PatternElementImpl(atl.metamodel.ATLModel manager, EObject object) {
	...
	public Class<PatternElement> getImplementedInterface() { return PatternElement.class; }

	@Override
	public void visit(atl.metamodel.ATLModelVisitor visitor) {
		atl.metamodel.ATLModelVisitor.VisitedReferences v = visitor.prePatternElement(this);
		if ( v == null ) {
			return;
		}
		...
		visitor.beforePatternElement(this);
