...
public class LazyMatchedRuleImpl extends atl.metamodel.ATLModelBaseObject implements LazyMatchedRule {
	
	public LazyMatchedRuleImpl(atl.metamodel.ATLModel manager, EObject object) {
	...
	public Boolean getIsUnique() {
		EStructuralFeature f = object.eClass().getEStructuralFeature("isUnique");
		Object result = object.eGet(f);
		if ( result == null ) 
			return null;
		return (Boolean) result;
	...
	public Class<LazyMatchedRule> getImplementedInterface() { return LazyMatchedRule.class; }

	@Override
	public void visit(atl.metamodel.ATLModelVisitor visitor) {
		atl.metamodel.ATLModelVisitor.VisitedReferences v = visitor.preLazyMatchedRule(this);
		if ( v == null ) {
			return;
		}
		...
		visitor.beforeLazyMatchedRule(this);
