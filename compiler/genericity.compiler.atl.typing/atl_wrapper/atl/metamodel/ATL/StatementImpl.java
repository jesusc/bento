...
public class StatementImpl extends atl.metamodel.ATLModelBaseObject implements Statement {
	
	public StatementImpl(atl.metamodel.ATLModel manager, EObject object) {
	...
	public Class<Statement> getImplementedInterface() { return Statement.class; }

	@Override
	public void visit(atl.metamodel.ATLModelVisitor visitor) {
		atl.metamodel.ATLModelVisitor.VisitedReferences v = visitor.preStatement(this);
		if ( v == null ) {
			return;
		}
