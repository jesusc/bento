...
public class SimpleInPatternElementImpl extends atl.metamodel.ATLModelBaseObject implements SimpleInPatternElement {
	
	public SimpleInPatternElementImpl(atl.metamodel.ATLModel manager, EObject object) {
	...
	public Class<SimpleInPatternElement> getImplementedInterface() { return SimpleInPatternElement.class; }

	@Override
	public void visit(atl.metamodel.ATLModelVisitor visitor) {
		atl.metamodel.ATLModelVisitor.VisitingActions v = visitor.preSimpleInPatternElement(this);
		if ( v == null ) {
			return;
		}
		...
		visitor.beforeSimpleInPatternElement(this);
		...
		visitor.inSimpleInPatternElement(this);
		visitor.afterSimpleInPatternElement(this);
