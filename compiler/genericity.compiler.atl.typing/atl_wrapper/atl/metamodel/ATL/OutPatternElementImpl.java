...
public class OutPatternElementImpl extends atl.metamodel.ATLModelBaseObject implements OutPatternElement {
	
	public OutPatternElementImpl(atl.metamodel.ATLModel manager, EObject object) {
	...
	public Class<OutPatternElement> getImplementedInterface() { return OutPatternElement.class; }

	@Override
	public void visit(atl.metamodel.ATLModelVisitor visitor) {
		atl.metamodel.ATLModelVisitor.VisitedReferences v = visitor.preOutPatternElement(this);
		if ( v == null ) {
			return;
		}
		...
		visitor.beforeOutPatternElement(this);
