...
public class ExpressionStatImpl extends atl.metamodel.ATLModelBaseObject implements ExpressionStat {
	
	public ExpressionStatImpl(atl.metamodel.ATLModel manager, EObject object) {
	...
	public void visit(atl.metamodel.ATLModelVisitor visitor) {
		atl.metamodel.ATLModelVisitor.VisitedReferences v = visitor.preExpressionStat(this);
		if ( v == null ) {
			return;
		}
		...
		visitor.beforeExpressionStat(this);
