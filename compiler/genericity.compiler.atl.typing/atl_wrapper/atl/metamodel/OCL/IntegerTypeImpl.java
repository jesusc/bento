...
public class IntegerTypeImpl extends atl.metamodel.ATLModelBaseObject implements IntegerType {
	
	public IntegerTypeImpl(atl.metamodel.ATLModel manager, EObject object) {
	...
	public Class<IntegerType> getImplementedInterface() { return IntegerType.class; }

	@Override
	public void visit(atl.metamodel.ATLModelVisitor visitor) {
		atl.metamodel.ATLModelVisitor.VisitedReferences v = visitor.preIntegerType(this);
		if ( v == null ) {
			return;
		}
		...
		visitor.beforeIntegerType(this);
