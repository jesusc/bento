...
public class TuplePartImpl extends atl.metamodel.ATLModelBaseObject implements TuplePart {
	
	public TuplePartImpl(atl.metamodel.ATLModel manager, EObject object) {
	...
	public atl.metamodel.OCL.TupleExp getTuple() {
		EStructuralFeature f = object.eClass().getEStructuralFeature("tuple");
		Object result = object.eGet(f);
		if ( result == null ) 
			return null;
		result = manager.wrap(result);
		return (atl.metamodel.OCL.TupleExp) result;
	}
	...
	public Class<TuplePart> getImplementedInterface() { return TuplePart.class; }

	@Override
	public void visit(atl.metamodel.ATLModelVisitor visitor) {
		atl.metamodel.ATLModelVisitor.VisitedReferences v = visitor.preTuplePart(this);
		if ( v == null ) {
			return;
		}
