...
public class OperatorCallExpImpl extends atl.metamodel.ATLModelBaseObject implements OperatorCallExp {
	
	public OperatorCallExpImpl(atl.metamodel.ATLModel manager, EObject object) {
	...
	public Class<OperatorCallExp> getImplementedInterface() { return OperatorCallExp.class; }

	@Override
	public void visit(atl.metamodel.ATLModelVisitor visitor) {
		atl.metamodel.ATLModelVisitor.VisitedReferences v = visitor.preOperatorCallExp(this);
		if ( v == null ) {
			return;
		}
		...
		visitor.beforeOperatorCallExp(this);
