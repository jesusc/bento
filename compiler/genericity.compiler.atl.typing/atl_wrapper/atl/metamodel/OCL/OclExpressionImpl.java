...
public class OclExpressionImpl extends atl.metamodel.ATLModelBaseObject implements OclExpression {
	
	public OclExpressionImpl(atl.metamodel.ATLModel manager, EObject object) {
	...
	public Class<OclExpression> getImplementedInterface() { return OclExpression.class; }

	@Override
	public void visit(atl.metamodel.ATLModelVisitor visitor) {
		atl.metamodel.ATLModelVisitor.VisitedReferences v = visitor.preOclExpression(this);
		if ( v == null ) {
			return;
		}
		...
		visitor.beforeOclExpression(this);
