...
public class IntegerExpImpl extends atl.metamodel.ATLModelBaseObject implements IntegerExp {
	
	public IntegerExpImpl(atl.metamodel.ATLModel manager, EObject object) {
	...
	public Integer getIntegerSymbol() {
		EStructuralFeature f = object.eClass().getEStructuralFeature("integerSymbol");
		Object result = object.eGet(f);
		if ( result == null ) 
			return null;
	...
	@Override
	public void setIntegerSymbol(Integer v) {
		EStructuralFeature f = object.eClass().getEStructuralFeature("integerSymbol");
		Object o = v;
	...
	public Class<IntegerExp> getImplementedInterface() { return IntegerExp.class; }

	@Override
	public void visit(atl.metamodel.ATLModelVisitor visitor) {
		atl.metamodel.ATLModelVisitor.VisitedReferences v = visitor.preIntegerExp(this);
		if ( v == null ) {
			return;
		}
