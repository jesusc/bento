...
public class IteratorImpl extends atl.metamodel.ATLModelBaseObject implements Iterator {
	
	public IteratorImpl(atl.metamodel.ATLModel manager, EObject object) {
	...
	public Class<Iterator> getImplementedInterface() { return Iterator.class; }

	@Override
	public void visit(atl.metamodel.ATLModelVisitor visitor) {
		atl.metamodel.ATLModelVisitor.VisitingActions v = visitor.preIterator(this);
		if ( v == null ) {
			return;
		}
		...
		visitor.inIterator(this);
		visitor.afterIterator(this);
