...
public class BagExpImpl extends atl.metamodel.ATLModelBaseObject implements BagExp {
	
	public BagExpImpl(atl.metamodel.ATLModel manager, EObject object) {
	...
	public Class<BagExp> getImplementedInterface() { return BagExp.class; }

	@Override
	public void visit(atl.metamodel.ATLModelVisitor visitor) {
		atl.metamodel.ATLModelVisitor.VisitedReferences v = visitor.preBagExp(this);
		if ( v == null ) {
			return;
		}
