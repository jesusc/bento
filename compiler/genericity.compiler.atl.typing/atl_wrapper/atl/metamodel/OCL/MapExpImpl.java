...
public class MapExpImpl extends atl.metamodel.ATLModelBaseObject implements MapExp {
	
	public MapExpImpl(atl.metamodel.ATLModel manager, EObject object) {
	...
	public List<atl.metamodel.OCL.MapElement> getElements() {
		...
		if ( result == null ) 
			return null;
		result = manager.wrap(result);
		return (List<atl.metamodel.OCL.MapElement>) result;
	}
	
	@Override
	public void addElements(atl.metamodel.OCL.MapElement v) {
		EStructuralFeature f = object.eClass().getEStructuralFeature("elements");
		Object o = v;
	...
	public Class<MapExp> getImplementedInterface() { return MapExp.class; }

	@Override
	public void visit(atl.metamodel.ATLModelVisitor visitor) {
		atl.metamodel.ATLModelVisitor.VisitedReferences v = visitor.preMapExp(this);
		if ( v == null ) {
			return;
		}
