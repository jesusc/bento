...
public class SequenceTypeImpl extends atl.metamodel.ATLModelBaseObject implements SequenceType {
	
	public SequenceTypeImpl(atl.metamodel.ATLModel manager, EObject object) {
	...
	public Class<SequenceType> getImplementedInterface() { return SequenceType.class; }

	@Override
	public void visit(atl.metamodel.ATLModelVisitor visitor) {
		atl.metamodel.ATLModelVisitor.VisitedReferences v = visitor.preSequenceType(this);
		if ( v == null ) {
			return;
		}
		...
		visitor.beforeSequenceType(this);
