...
public class RealExpImpl extends atl.metamodel.ATLModelBaseObject implements RealExp {
	
	public RealExpImpl(atl.metamodel.ATLModel manager, EObject object) {
	...
	public Double getRealSymbol() {
		EStructuralFeature f = object.eClass().getEStructuralFeature("realSymbol");
		Object result = object.eGet(f);
		if ( result == null ) 
			return null;
	...
	@Override
	public void setRealSymbol(Double v) {
		EStructuralFeature f = object.eClass().getEStructuralFeature("realSymbol");
		Object o = v;
	...
	public Class<RealExp> getImplementedInterface() { return RealExp.class; }

	@Override
	public void visit(atl.metamodel.ATLModelVisitor visitor) {
		atl.metamodel.ATLModelVisitor.VisitedReferences v = visitor.preRealExp(this);
		if ( v == null ) {
			return;
		}
