...
public class SuperExpImpl extends atl.metamodel.ATLModelBaseObject implements SuperExp {
	
	public SuperExpImpl(atl.metamodel.ATLModel manager, EObject object) {
	...
	public Class<SuperExp> getImplementedInterface() { return SuperExp.class; }

	@Override
	public void visit(atl.metamodel.ATLModelVisitor visitor) {
		atl.metamodel.ATLModelVisitor.VisitedReferences v = visitor.preSuperExp(this);
		if ( v == null ) {
			return;
		}
