...
public class NavigationOrAttributeCallExpImpl extends atl.metamodel.ATLModelBaseObject implements NavigationOrAttributeCallExp {
	
	public NavigationOrAttributeCallExpImpl(atl.metamodel.ATLModel manager, EObject object) {
	...
	public Class<NavigationOrAttributeCallExp> getImplementedInterface() { return NavigationOrAttributeCallExp.class; }

	@Override
	public void visit(atl.metamodel.ATLModelVisitor visitor) {
		atl.metamodel.ATLModelVisitor.VisitedReferences v = visitor.preNavigationOrAttributeCallExp(this);
		if ( v == null ) {
			return;
		}
		...
		visitor.beforeNavigationOrAttributeCallExp(this);
