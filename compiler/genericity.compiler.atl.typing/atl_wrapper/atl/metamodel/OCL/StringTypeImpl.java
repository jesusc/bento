...
public class StringTypeImpl extends atl.metamodel.ATLModelBaseObject implements StringType {
	
	public StringTypeImpl(atl.metamodel.ATLModel manager, EObject object) {
	...
	public Class<StringType> getImplementedInterface() { return StringType.class; }

	@Override
	public void visit(atl.metamodel.ATLModelVisitor visitor) {
		atl.metamodel.ATLModelVisitor.VisitedReferences v = visitor.preStringType(this);
		if ( v == null ) {
			return;
		}
