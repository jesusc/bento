...
public class TupleExpImpl extends atl.metamodel.ATLModelBaseObject implements TupleExp {
	
	public TupleExpImpl(atl.metamodel.ATLModel manager, EObject object) {
	...
	@Override
	public List<atl.metamodel.OCL.TuplePart> getTuplePart() {
		EStructuralFeature f = object.eClass().getEStructuralFeature("tuplePart");
		Object result = object.eGet(f);
		if ( result == null ) 
			return null;
		result = manager.wrap(result);
		return (List<atl.metamodel.OCL.TuplePart>) result;
	}
	
	@Override
	public void addTuplePart(atl.metamodel.OCL.TuplePart v) {
		EStructuralFeature f = object.eClass().getEStructuralFeature("tuplePart");
		Object o = v;
	...
	public Class<TupleExp> getImplementedInterface() { return TupleExp.class; }

	@Override
	public void visit(atl.metamodel.ATLModelVisitor visitor) {
		atl.metamodel.ATLModelVisitor.VisitedReferences v = visitor.preTupleExp(this);
		if ( v == null ) {
			return;
		}
