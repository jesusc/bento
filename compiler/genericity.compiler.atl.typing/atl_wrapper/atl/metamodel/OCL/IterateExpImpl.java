...
public class IterateExpImpl extends atl.metamodel.ATLModelBaseObject implements IterateExp {
	
	public IterateExpImpl(atl.metamodel.ATLModel manager, EObject object) {
	...
	@Override
	public void addIterators(atl.metamodel.OCL.Iterator v) {
		EStructuralFeature f = object.eClass().getEStructuralFeature("iterators");
		Object o = v;
	...
	@Override
	public atl.metamodel.OCL.VariableDeclaration getResult() {
		EStructuralFeature f = object.eClass().getEStructuralFeature("result");
		Object result = object.eGet(f);
		if ( result == null ) 
			return null;
		result = manager.wrap(result);
	...
	@Override
	public void setResult(atl.metamodel.OCL.VariableDeclaration v) {
		EStructuralFeature f = object.eClass().getEStructuralFeature("result");
		Object o = v;
	...
	public Class<IterateExp> getImplementedInterface() { return IterateExp.class; }

	@Override
	public void visit(atl.metamodel.ATLModelVisitor visitor) {
		atl.metamodel.ATLModelVisitor.VisitedReferences v = visitor.preIterateExp(this);
		if ( v == null ) {
			return;
		}
