...
public class NumericExpImpl extends atl.metamodel.ATLModelBaseObject implements NumericExp {
	
	public NumericExpImpl(atl.metamodel.ATLModel manager, EObject object) {
	...
	public Class<NumericExp> getImplementedInterface() { return NumericExp.class; }

	@Override
	public void visit(atl.metamodel.ATLModelVisitor visitor) {
		atl.metamodel.ATLModelVisitor.VisitedReferences v = visitor.preNumericExp(this);
		if ( v == null ) {
			return;
		}
