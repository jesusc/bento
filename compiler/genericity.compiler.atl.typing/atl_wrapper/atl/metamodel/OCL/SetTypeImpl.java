...
public class SetTypeImpl extends atl.metamodel.ATLModelBaseObject implements SetType {
	
	public SetTypeImpl(atl.metamodel.ATLModel manager, EObject object) {
	...
	public Class<SetType> getImplementedInterface() { return SetType.class; }

	@Override
	public void visit(atl.metamodel.ATLModelVisitor visitor) {
		atl.metamodel.ATLModelVisitor.VisitedReferences v = visitor.preSetType(this);
		if ( v == null ) {
			return;
		}
