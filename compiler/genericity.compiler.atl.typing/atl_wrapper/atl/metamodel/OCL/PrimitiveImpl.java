...
public class PrimitiveImpl extends atl.metamodel.ATLModelBaseObject implements Primitive {
	
	public PrimitiveImpl(atl.metamodel.ATLModel manager, EObject object) {
	...
	public Class<Primitive> getImplementedInterface() { return Primitive.class; }

	@Override
	public void visit(atl.metamodel.ATLModelVisitor visitor) {
		atl.metamodel.ATLModelVisitor.VisitedReferences v = visitor.prePrimitive(this);
		if ( v == null ) {
			return;
		}
