...
public class OrderedSetTypeImpl extends atl.metamodel.ATLModelBaseObject implements OrderedSetType {
	
	public OrderedSetTypeImpl(atl.metamodel.ATLModel manager, EObject object) {
	...
	public Class<OrderedSetType> getImplementedInterface() { return OrderedSetType.class; }

	@Override
	public void visit(atl.metamodel.ATLModelVisitor visitor) {
		atl.metamodel.ATLModelVisitor.VisitedReferences v = visitor.preOrderedSetType(this);
		if ( v == null ) {
			return;
		}
		...
		visitor.beforeOrderedSetType(this);
