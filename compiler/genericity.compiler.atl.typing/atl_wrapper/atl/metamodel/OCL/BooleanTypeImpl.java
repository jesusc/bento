...
public class BooleanTypeImpl extends atl.metamodel.ATLModelBaseObject implements BooleanType {
	
	public BooleanTypeImpl(atl.metamodel.ATLModel manager, EObject object) {
	...
	public Class<BooleanType> getImplementedInterface() { return BooleanType.class; }

	@Override
	public void visit(atl.metamodel.ATLModelVisitor visitor) {
		atl.metamodel.ATLModelVisitor.VisitedReferences v = visitor.preBooleanType(this);
		if ( v == null ) {
			return;
		}
		...
		visitor.beforeBooleanType(this);
