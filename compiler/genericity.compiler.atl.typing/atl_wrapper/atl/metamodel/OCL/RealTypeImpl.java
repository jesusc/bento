...
public class RealTypeImpl extends atl.metamodel.ATLModelBaseObject implements RealType {
	
	public RealTypeImpl(atl.metamodel.ATLModel manager, EObject object) {
	...
	public Class<RealType> getImplementedInterface() { return RealType.class; }

	@Override
	public void visit(atl.metamodel.ATLModelVisitor visitor) {
		atl.metamodel.ATLModelVisitor.VisitedReferences v = visitor.preRealType(this);
		if ( v == null ) {
			return;
		}
