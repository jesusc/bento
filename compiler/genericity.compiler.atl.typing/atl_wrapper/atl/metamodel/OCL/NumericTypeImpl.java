...
public class NumericTypeImpl extends atl.metamodel.ATLModelBaseObject implements NumericType {
	
	public NumericTypeImpl(atl.metamodel.ATLModel manager, EObject object) {
	...
	public Class<NumericType> getImplementedInterface() { return NumericType.class; }

	@Override
	public void visit(atl.metamodel.ATLModelVisitor visitor) {
		atl.metamodel.ATLModelVisitor.VisitedReferences v = visitor.preNumericType(this);
		if ( v == null ) {
			return;
		}
		...
		visitor.beforeNumericType(this);
