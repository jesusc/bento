...
public class OclTypeImpl extends atl.metamodel.ATLModelBaseObject implements OclType {
	
	public OclTypeImpl(atl.metamodel.ATLModel manager, EObject object) {
	...
	public Class<OclType> getImplementedInterface() { return OclType.class; }

	@Override
	public void visit(atl.metamodel.ATLModelVisitor visitor) {
		atl.metamodel.ATLModelVisitor.VisitedReferences v = visitor.preOclType(this);
		if ( v == null ) {
			return;
		}
