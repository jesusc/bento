...
public class MapTypeImpl extends atl.metamodel.ATLModelBaseObject implements MapType {
	
	public MapTypeImpl(atl.metamodel.ATLModel manager, EObject object) {
	...
	@Override
	public atl.metamodel.OCL.OclType getValueType() {
		EStructuralFeature f = object.eClass().getEStructuralFeature("valueType");
		Object result = object.eGet(f);
		if ( result == null ) 
			return null;
		result = manager.wrap(result);
	...
	@Override
	public void setValueType(atl.metamodel.OCL.OclType v) {
		EStructuralFeature f = object.eClass().getEStructuralFeature("valueType");
		Object o = v;
	...
	@Override
	public atl.metamodel.OCL.OclType getKeyType() {
		EStructuralFeature f = object.eClass().getEStructuralFeature("keyType");
		Object result = object.eGet(f);
		if ( result == null ) 
			return null;
		result = manager.wrap(result);
	...
	@Override
	public void setKeyType(atl.metamodel.OCL.OclType v) {
		EStructuralFeature f = object.eClass().getEStructuralFeature("keyType");
		Object o = v;
	...
	public Class<MapType> getImplementedInterface() { return MapType.class; }

	@Override
	public void visit(atl.metamodel.ATLModelVisitor visitor) {
		atl.metamodel.ATLModelVisitor.VisitedReferences v = visitor.preMapType(this);
		if ( v == null ) {
			return;
		}
