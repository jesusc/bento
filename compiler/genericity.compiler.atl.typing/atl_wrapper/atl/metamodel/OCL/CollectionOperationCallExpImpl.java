...
public class CollectionOperationCallExpImpl extends atl.metamodel.ATLModelBaseObject implements CollectionOperationCallExp {
	
	public CollectionOperationCallExpImpl(atl.metamodel.ATLModel manager, EObject object) {
	...
	public Class<CollectionOperationCallExp> getImplementedInterface() { return CollectionOperationCallExp.class; }

	@Override
	public void visit(atl.metamodel.ATLModelVisitor visitor) {
		atl.metamodel.ATLModelVisitor.VisitedReferences v = visitor.preCollectionOperationCallExp(this);
		if ( v == null ) {
			return;
		}
		...
		visitor.beforeCollectionOperationCallExp(this);
