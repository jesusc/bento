...
public class VariableExpImpl extends atl.metamodel.ATLModelBaseObject implements VariableExp {
	
	public VariableExpImpl(atl.metamodel.ATLModel manager, EObject object) {
	...
	@Override
	public atl.metamodel.OCL.VariableDeclaration getReferredVariable() {
		EStructuralFeature f = object.eClass().getEStructuralFeature("referredVariable");
		Object result = object.eGet(f);
		if ( result == null ) 
			return null;
		result = manager.wrap(result);
	...
	@Override
	public void setReferredVariable(atl.metamodel.OCL.VariableDeclaration v) {
		EStructuralFeature f = object.eClass().getEStructuralFeature("referredVariable");
		Object o = v;
	...
	public Class<VariableExp> getImplementedInterface() { return VariableExp.class; }

	@Override
	public void visit(atl.metamodel.ATLModelVisitor visitor) {
		atl.metamodel.ATLModelVisitor.VisitedReferences v = visitor.preVariableExp(this);
		if ( v == null ) {
			return;
		}
		...
		visitor.beforeVariableExp(this);
