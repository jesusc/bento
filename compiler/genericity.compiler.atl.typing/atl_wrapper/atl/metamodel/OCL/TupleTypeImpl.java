...
public class TupleTypeImpl extends atl.metamodel.ATLModelBaseObject implements TupleType {
	
	public TupleTypeImpl(atl.metamodel.ATLModel manager, EObject object) {
	...
	public List<atl.metamodel.OCL.TupleTypeAttribute> getAttributes() {
		EStructuralFeature f = object.eClass().getEStructuralFeature("attributes");
		Object result = object.eGet(f);
		if ( result == null ) 
			return null;
		result = manager.wrap(result);
		return (List<atl.metamodel.OCL.TupleTypeAttribute>) result;
	}
	...
	public Class<TupleType> getImplementedInterface() { return TupleType.class; }

	@Override
	public void visit(atl.metamodel.ATLModelVisitor visitor) {
		atl.metamodel.ATLModelVisitor.VisitedReferences v = visitor.preTupleType(this);
		if ( v == null ) {
			return;
		}
