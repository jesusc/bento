...
public class LetExpImpl extends atl.metamodel.ATLModelBaseObject implements LetExp {
	
	public LetExpImpl(atl.metamodel.ATLModel manager, EObject object) {
	...
	@Override
	public atl.metamodel.OCL.VariableDeclaration getVariable() {
		EStructuralFeature f = object.eClass().getEStructuralFeature("variable");
		Object result = object.eGet(f);
		if ( result == null ) 
			return null;
		result = manager.wrap(result);
	...
	@Override
	public void setVariable(atl.metamodel.OCL.VariableDeclaration v) {
		EStructuralFeature f = object.eClass().getEStructuralFeature("variable");
		Object o = v;
	...
	@Override
	public atl.metamodel.OCL.OclExpression getIn_() {
		EStructuralFeature f = object.eClass().getEStructuralFeature("in_");
		Object result = object.eGet(f);
		if ( result == null ) 
			return null;
		result = manager.wrap(result);
	...
	@Override
	public void setIn_(atl.metamodel.OCL.OclExpression v) {
		EStructuralFeature f = object.eClass().getEStructuralFeature("in_");
		Object o = v;
	...
	public Class<LetExp> getImplementedInterface() { return LetExp.class; }

	@Override
	public void visit(atl.metamodel.ATLModelVisitor visitor) {
		atl.metamodel.ATLModelVisitor.VisitedReferences v = visitor.preLetExp(this);
		if ( v == null ) {
			return;
		}
