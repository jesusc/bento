...
public class IteratorExpImpl extends atl.metamodel.ATLModelBaseObject implements IteratorExp {
	
	public IteratorExpImpl(atl.metamodel.ATLModel manager, EObject object) {
	...
	public Class<IteratorExp> getImplementedInterface() { return IteratorExp.class; }

	@Override
	public void visit(atl.metamodel.ATLModelVisitor visitor) {
		atl.metamodel.ATLModelVisitor.VisitingActions v = visitor.preIteratorExp(this);
		if ( v == null ) {
			return;
		}
		...
		visitor.beforeIteratorExp(this);
		...
		visitor.inIteratorExp(this);
		visitor.afterIteratorExp(this);
