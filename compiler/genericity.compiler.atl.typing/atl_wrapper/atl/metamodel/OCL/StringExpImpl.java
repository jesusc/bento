...
public class StringExpImpl extends atl.metamodel.ATLModelBaseObject implements StringExp {
	
	public StringExpImpl(atl.metamodel.ATLModel manager, EObject object) {
	...
	public java.lang.String getStringSymbol() {
		EStructuralFeature f = object.eClass().getEStructuralFeature("stringSymbol");
		Object result = object.eGet(f);
		if ( result == null ) 
			return null;
		return (java.lang.String) result;
	...
	@Override
	public void setStringSymbol(java.lang.String v) {
		EStructuralFeature f = object.eClass().getEStructuralFeature("stringSymbol");
		Object o = v;
	...
	public Class<StringExp> getImplementedInterface() { return StringExp.class; }

	@Override
	public void visit(atl.metamodel.ATLModelVisitor visitor) {
		atl.metamodel.ATLModelVisitor.VisitedReferences v = visitor.preStringExp(this);
		if ( v == null ) {
			return;
		}
