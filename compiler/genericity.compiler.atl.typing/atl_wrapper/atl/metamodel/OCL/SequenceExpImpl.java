...
public class SequenceExpImpl extends atl.metamodel.ATLModelBaseObject implements SequenceExp {
	
	public SequenceExpImpl(atl.metamodel.ATLModel manager, EObject object) {
	...
	public Class<SequenceExp> getImplementedInterface() { return SequenceExp.class; }

	@Override
	public void visit(atl.metamodel.ATLModelVisitor visitor) {
		atl.metamodel.ATLModelVisitor.VisitedReferences v = visitor.preSequenceExp(this);
		if ( v == null ) {
			return;
		}
		...
		visitor.beforeSequenceExp(this);
