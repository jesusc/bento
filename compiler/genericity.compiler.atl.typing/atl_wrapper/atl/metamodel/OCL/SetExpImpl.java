...
public class SetExpImpl extends atl.metamodel.ATLModelBaseObject implements SetExp {
	
	public SetExpImpl(atl.metamodel.ATLModel manager, EObject object) {
	...
	public Class<SetExp> getImplementedInterface() { return SetExp.class; }

	@Override
	public void visit(atl.metamodel.ATLModelVisitor visitor) {
		atl.metamodel.ATLModelVisitor.VisitedReferences v = visitor.preSetExp(this);
		if ( v == null ) {
			return;
		}
