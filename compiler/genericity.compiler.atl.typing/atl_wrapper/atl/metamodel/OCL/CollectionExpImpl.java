...
public class CollectionExpImpl extends atl.metamodel.ATLModelBaseObject implements CollectionExp {
	
	public CollectionExpImpl(atl.metamodel.ATLModel manager, EObject object) {
	...
	public Class<CollectionExp> getImplementedInterface() { return CollectionExp.class; }
	...
	public void visit(atl.metamodel.ATLModelVisitor visitor) {
		...
		visitor.inCollectionExp(this);
		visitor.afterCollectionExp(this);
