...
public class EnumLiteralExpImpl extends atl.metamodel.ATLModelBaseObject implements EnumLiteralExp {
	
	public EnumLiteralExpImpl(atl.metamodel.ATLModel manager, EObject object) {
	...
	public Class<EnumLiteralExp> getImplementedInterface() { return EnumLiteralExp.class; }

	@Override
	public void visit(atl.metamodel.ATLModelVisitor visitor) {
		atl.metamodel.ATLModelVisitor.VisitedReferences v = visitor.preEnumLiteralExp(this);
		if ( v == null ) {
			return;
		}
		...
		visitor.beforeEnumLiteralExp(this);
