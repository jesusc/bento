...
public class OclUndefinedExpImpl extends atl.metamodel.ATLModelBaseObject implements OclUndefinedExp {
	
	public OclUndefinedExpImpl(atl.metamodel.ATLModel manager, EObject object) {
	...
	public Class<OclUndefinedExp> getImplementedInterface() { return OclUndefinedExp.class; }

	@Override
	public void visit(atl.metamodel.ATLModelVisitor visitor) {
		atl.metamodel.ATLModelVisitor.VisitedReferences v = visitor.preOclUndefinedExp(this);
		if ( v == null ) {
			return;
		}
		...
		visitor.beforeOclUndefinedExp(this);
