...
public class PropertyCallExpImpl extends atl.metamodel.ATLModelBaseObject implements PropertyCallExp {
	
	public PropertyCallExpImpl(atl.metamodel.ATLModel manager, EObject object) {
	...
	public Class<PropertyCallExp> getImplementedInterface() { return PropertyCallExp.class; }

	@Override
	public void visit(atl.metamodel.ATLModelVisitor visitor) {
		atl.metamodel.ATLModelVisitor.VisitedReferences v = visitor.prePropertyCallExp(this);
		if ( v == null ) {
			return;
		}
		...
		visitor.beforePropertyCallExp(this);
