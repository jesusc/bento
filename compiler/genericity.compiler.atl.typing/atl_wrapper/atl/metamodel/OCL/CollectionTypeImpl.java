...
public class CollectionTypeImpl extends atl.metamodel.ATLModelBaseObject implements CollectionType {
	
	public CollectionTypeImpl(atl.metamodel.ATLModel manager, EObject object) {
	...
	public Class<CollectionType> getImplementedInterface() { return CollectionType.class; }

	@Override
	public void visit(atl.metamodel.ATLModelVisitor visitor) {
		atl.metamodel.ATLModelVisitor.VisitedReferences v = visitor.preCollectionType(this);
		if ( v == null ) {
			return;
		}
		...
		visitor.beforeCollectionType(this);
