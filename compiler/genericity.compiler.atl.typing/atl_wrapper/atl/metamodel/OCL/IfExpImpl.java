...
public class IfExpImpl extends atl.metamodel.ATLModelBaseObject implements IfExp {
	
	public IfExpImpl(atl.metamodel.ATLModel manager, EObject object) {
	...
	@Override
	public atl.metamodel.OCL.OclExpression getThenExpression() {
		EStructuralFeature f = object.eClass().getEStructuralFeature("thenExpression");
		Object result = object.eGet(f);
		if ( result == null ) 
			return null;
		result = manager.wrap(result);
	...
	@Override
	public void setThenExpression(atl.metamodel.OCL.OclExpression v) {
		EStructuralFeature f = object.eClass().getEStructuralFeature("thenExpression");
		Object o = v;
	...
	@Override
	public atl.metamodel.OCL.OclExpression getElseExpression() {
		EStructuralFeature f = object.eClass().getEStructuralFeature("elseExpression");
		Object result = object.eGet(f);
		if ( result == null ) 
			return null;
		result = manager.wrap(result);
	...
	@Override
	public void setElseExpression(atl.metamodel.OCL.OclExpression v) {
		EStructuralFeature f = object.eClass().getEStructuralFeature("elseExpression");
		Object o = v;
	...
	public Class<IfExp> getImplementedInterface() { return IfExp.class; }

	@Override
	public void visit(atl.metamodel.ATLModelVisitor visitor) {
		atl.metamodel.ATLModelVisitor.VisitedReferences v = visitor.preIfExp(this);
		if ( v == null ) {
			return;
		}
