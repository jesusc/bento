...
public class OclAnyTypeImpl extends atl.metamodel.ATLModelBaseObject implements OclAnyType {
	
	public OclAnyTypeImpl(atl.metamodel.ATLModel manager, EObject object) {
	...
	public Class<OclAnyType> getImplementedInterface() { return OclAnyType.class; }

	@Override
	public void visit(atl.metamodel.ATLModelVisitor visitor) {
		atl.metamodel.ATLModelVisitor.VisitingActions v = visitor.preOclAnyType(this);
		if ( v == null ) {
			return;
		}
		...
		visitor.inOclAnyType(this);
		visitor.afterOclAnyType(this);
