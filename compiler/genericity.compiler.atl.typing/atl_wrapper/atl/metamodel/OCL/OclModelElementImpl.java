...
public class OclModelElementImpl extends atl.metamodel.ATLModelBaseObject implements OclModelElement {
	
	public OclModelElementImpl(atl.metamodel.ATLModel manager, EObject object) {
	...
	public Class<OclModelElement> getImplementedInterface() { return OclModelElement.class; }

	@Override
	public void visit(atl.metamodel.ATLModelVisitor visitor) {
		atl.metamodel.ATLModelVisitor.VisitedReferences v = visitor.preOclModelElement(this);
		if ( v == null ) {
			return;
		}
		...
		visitor.beforeOclModelElement(this);
