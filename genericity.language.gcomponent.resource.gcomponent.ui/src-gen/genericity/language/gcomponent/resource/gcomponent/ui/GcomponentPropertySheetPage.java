...
public class GcomponentPropertySheetPage extends org.eclipse.ui.views.properties.PropertySheetPage implements org.eclipse.jface.viewers.ISelectionChangedListener {
	...
	public void selectionChanged(org.eclipse.ui.IWorkbenchPart part, org.eclipse.jface.viewers.ISelection iSelection) {
		...
		if (iSelection instanceof genericity.language.gcomponent.resource.gcomponent.ui.GcomponentEObjectSelection) {
			final genericity.language.gcomponent.resource.gcomponent.ui.GcomponentEObjectSelection selection = (genericity.language.gcomponent.resource.gcomponent.ui.GcomponentEObjectSelection) iSelection;
