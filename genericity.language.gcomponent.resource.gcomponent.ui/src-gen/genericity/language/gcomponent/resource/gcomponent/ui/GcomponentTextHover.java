 ...
 */
public class GcomponentTextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2 {
	...
	private genericity.language.gcomponent.resource.gcomponent.IGcomponentHoverTextProvider hoverTextProvider;
	/**
	 * The style sheet (css).
	 */
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final genericity.language.gcomponent.resource.gcomponent.ui.GcomponentBrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(genericity.language.gcomponent.resource.gcomponent.ui.GcomponentBrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			genericity.language.gcomponent.resource.gcomponent.ui.GcomponentDocBrowserInformationControlInput infoInput = (genericity.language.gcomponent.resource.gcomponent.ui.GcomponentDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					genericity.language.gcomponent.resource.gcomponent.ui.GcomponentHyperlink hyperlink = new genericity.language.gcomponent.resource.gcomponent.ui.GcomponentHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (genericity.language.gcomponent.resource.gcomponent.ui.GcomponentBrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				genericity.language.gcomponent.resource.gcomponent.ui.GcomponentBrowserInformationControl iControl = new genericity.language.gcomponent.resource.gcomponent.ui.GcomponentBrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(Object newInput) {
						...
						} else if (newInput instanceof genericity.language.gcomponent.resource.gcomponent.ui.GcomponentDocBrowserInformationControlInput) {
							genericity.language.gcomponent.resource.gcomponent.ui.GcomponentDocBrowserInformationControlInput input = (genericity.language.gcomponent.resource.gcomponent.ui.GcomponentDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (genericity.language.gcomponent.resource.gcomponent.ui.GcomponentBrowserInformationControl.isAvailable(parent)) {
				genericity.language.gcomponent.resource.gcomponent.ui.GcomponentBrowserInformationControl iControl = new genericity.language.gcomponent.resource.gcomponent.ui.GcomponentBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	 ...
	 */
	public GcomponentTextHover(genericity.language.gcomponent.resource.gcomponent.IGcomponentResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
		this.hoverTextProvider = new genericity.language.gcomponent.resource.gcomponent.ui.GcomponentUIMetaInformation().getHoverTextProvider();
	}
	 ...
	 */
	private genericity.language.gcomponent.resource.gcomponent.ui.GcomponentDocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, genericity.language.gcomponent.resource.gcomponent.ui.GcomponentDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				genericity.language.gcomponent.resource.gcomponent.ui.GcomponentHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(containerObject, declarationObject));
			}
		} else {
			genericity.language.gcomponent.resource.gcomponent.ui.GcomponentHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			genericity.language.gcomponent.resource.gcomponent.ui.GcomponentHTMLPrinter.insertPageProlog(buffer, 0, genericity.language.gcomponent.resource.gcomponent.ui.GcomponentTextHover.getStyleSheet());
			genericity.language.gcomponent.resource.gcomponent.ui.GcomponentHTMLPrinter.addPageEpilog(buffer);
			return new genericity.language.gcomponent.resource.gcomponent.ui.GcomponentDocBrowserInformationControlInput(previousInput, declarationObject, resourceProvider.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String loadStyleSheet() {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(genericity.language.gcomponent.resource.gcomponent.ui.GcomponentUIPlugin.PLUGIN_ID);
		java.net.URL styleSheetURL = bundle.getEntry("/css/hover_style.css");
		if (styleSheetURL != null) {
			try {
				return genericity.language.gcomponent.resource.gcomponent.util.GcomponentStreamUtil.getContent(styleSheetURL.openStream());
