 ...
 */
public class GcomponentNewProjectWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard, org.eclipse.core.runtime.IExecutableExtension {
	 ...
	 */
	private String pageName = "New " + new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentMetaInformation().getSyntaxName() + " Project";
	 ...
	 * The constructor.
	 */
	public GcomponentNewProjectWizard() {
		super();
	}
				...
				public void execute(org.eclipse.core.runtime.IProgressMonitor monitor) throws InterruptedException {
					try {
						...
						if (!project.exists()) {
							...
							org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle("genericity.language.gcomponent.resource.gcomponent.ui");
							...
							String natureID = genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentNature.NATURE_ID;
							...
							for (String builderID : genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentNature.BUILDER_IDS) {
							...
							if (defaultNewFile.exists()) {
								genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentMetaInformation info = new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentMetaInformation();
	...
	public void init(org.eclipse.ui.IWorkbench workbench, org.eclipse.jface.viewers.IStructuredSelection selection) {
		...
		org.osgi.framework.Bundle bundle = genericity.language.gcomponent.resource.gcomponent.ui.GcomponentUIPlugin.getDefault().getBundle();
