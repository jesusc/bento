 ...
 * </ul>
 */
public class GcomponentBracketPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	
	private static final String[] ALL_LEFT_BRACKETS = new String[] { "{", "(", "[", "<", "\"", "'", };
	private static final String[] ALL_RIGHT_BRACKETS = new String[] { "}", ")", "]", ">", "\"", "'", };
	
	private String BRACKETS_COLOR = genericity.language.gcomponent.resource.gcomponent.ui.GcomponentPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR;
	...
	private String language = new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentMetaInformation().getSyntaxName();
	
	private genericity.language.gcomponent.resource.gcomponent.ui.GcomponentBracketSet bracketsTmp;
	
	/**
	 * Creates a preference page for bracket setting.
	 */
	public GcomponentBracketPreferencePage() {
		super();
		
		genericity.language.gcomponent.resource.gcomponent.IGcomponentMetaInformation metaInformation = new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentMetaInformation();
	...
	public void init(org.eclipse.ui.IWorkbench workbench) {
		setPreferenceStore(genericity.language.gcomponent.resource.gcomponent.ui.GcomponentUIPlugin.getDefault().getPreferenceStore());
		setDescription("Define the coloring of matching brackets.");
		
		bracketsTmp = new genericity.language.gcomponent.resource.gcomponent.ui.GcomponentBracketSet(null, null);
		for (String languageID : languageIDs) {
			bracketSetTemp.put(languageID, getPreferenceStore().getString(languageID + genericity.language.gcomponent.resource.gcomponent.ui.GcomponentPreferenceConstants.EDITOR_BRACKETS_SUFFIX));
		}
	}
	...
	private void handleMatchingBracketsSelection() {
		...
		enableCheckbox.setSelection(getPreferenceStore().getBoolean(		genericity.language.gcomponent.resource.gcomponent.ui.GcomponentPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX));
		enableClosingInside.setSelection(false);
		matchingBracketsColorButton.setEnabled(getPreferenceStore().getBoolean(		genericity.language.gcomponent.resource.gcomponent.ui.GcomponentPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX));
		...
		initializeLanguage();
		bracketsTmp.setBrackets(getPreferenceStore().getString(language + genericity.language.gcomponent.resource.gcomponent.ui.GcomponentPreferenceConstants.EDITOR_BRACKETS_SUFFIX));
		...
		bracketsList.addSelectionListener(new org.eclipse.swt.events.SelectionListener() {
			...
			public void widgetSelected(org.eclipse.swt.events.SelectionEvent e) {
				...
				for (int index : itemIndices) {
					genericity.language.gcomponent.resource.gcomponent.IGcomponentBracketPair bracketPair = bracketsTmp.getBracketPair(index);
		...
		enableClosingInside.addSelectionListener(new org.eclipse.swt.events.SelectionListener() {
			...
			public void widgetSelected(org.eclipse.swt.events.SelectionEvent e) {
				...
				for (int idx : itemIndices) {
					genericity.language.gcomponent.resource.gcomponent.IGcomponentBracketPair bracketPair = bracketsTmp.getBracketPair(idx);
	...
	protected void performDefaults() {
		enableCheckbox.setSelection(getPreferenceStore().getDefaultBoolean(genericity.language.gcomponent.resource.gcomponent.ui.GcomponentPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX));
		matchingBracketsColorButton.setEnabled(enableCheckbox.getSelection());
		...
		bracketSetTemp.put(language, getPreferenceStore().getDefaultString(language + genericity.language.gcomponent.resource.gcomponent.ui.GcomponentPreferenceConstants.EDITOR_BRACKETS_SUFFIX));
		bracketsTmp.setBrackets(bracketSetTemp.get(language));
		bracketsList.setItems(bracketsTmp.getBracketArray());
		enableClosingInside.setSelection(false);
	}
	...
	private void updateActiveEditor() {
		...
		getPreferenceStore().setValue(genericity.language.gcomponent.resource.gcomponent.ui.GcomponentPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX, enableCheckbox.getSelection());
		getPreferenceStore().setValue(language + genericity.language.gcomponent.resource.gcomponent.ui.GcomponentPreferenceConstants.EDITOR_BRACKETS_SUFFIX, bracketSetTemp.get(language));
		...
		if (editor != null && editor instanceof genericity.language.gcomponent.resource.gcomponent.ui.GcomponentEditor) {
			((genericity.language.gcomponent.resource.gcomponent.ui.GcomponentEditor) editor).invalidateTextRepresentation();
		}
	}
