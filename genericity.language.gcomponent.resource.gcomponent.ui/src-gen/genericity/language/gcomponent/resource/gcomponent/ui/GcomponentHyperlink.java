 ...
 */
public class GcomponentHyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	 ...
	 */
	public GcomponentHyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentPlugin.logError("Exception while opening hyperlink target.", e);
			}
		}
	}
