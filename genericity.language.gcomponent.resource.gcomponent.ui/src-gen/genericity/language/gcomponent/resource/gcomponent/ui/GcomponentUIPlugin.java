 ...
 */
public class GcomponentUIPlugin extends org.eclipse.ui.plugin.AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "genericity.language.gcomponent.resource.gcomponent.ui";
	public static final String EDITOR_ID = "genericity.language.gcomponent.resource.gcomponent.ui.GcomponentEditor";
	...
	private static GcomponentUIPlugin plugin;
	
	public GcomponentUIPlugin() {
		super();
	}
	...
	public static GcomponentUIPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, GcomponentUIPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, GcomponentUIPlugin.PLUGIN_ID, message);
		}
		final GcomponentUIPlugin pluginInstance = GcomponentUIPlugin.getDefault();
