 ...
 */
public class GcomponentLaunchShortcut implements org.eclipse.debug.ui.ILaunchShortcut2 {
	...
	private void launch(org.eclipse.core.resources.IFile file, String mode) {
		try {
			...
			org.eclipse.debug.core.ILaunchConfigurationType type = lm.getLaunchConfigurationType(new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentMetaInformation().getLaunchConfigurationType());
			...
			workingCopy.setAttribute(genericity.language.gcomponent.resource.gcomponent.launch.GcomponentLaunchConfigurationDelegate.ATTR_RESOURCE_URI, uri.toString());
			...
			genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentPlugin.logError("Exception while launching selection", e);
		}
	}
