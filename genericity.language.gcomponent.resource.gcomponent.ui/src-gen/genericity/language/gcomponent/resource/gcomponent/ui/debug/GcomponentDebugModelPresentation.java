...
public class GcomponentDebugModelPresentation implements org.eclipse.debug.ui.IDebugModelPresentation {
	
	public GcomponentDebugModelPresentation() {
		super();
	}
	...
	public String getEditorId(org.eclipse.ui.IEditorInput input, Object element) {
		if (element instanceof org.eclipse.core.resources.IFile || element instanceof org.eclipse.debug.core.model.ILineBreakpoint) {
			return genericity.language.gcomponent.resource.gcomponent.ui.GcomponentUIPlugin.EDITOR_ID;
		}
		return null;
	}
