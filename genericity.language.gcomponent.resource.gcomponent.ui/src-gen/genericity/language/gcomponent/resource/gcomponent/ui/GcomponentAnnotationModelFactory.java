...
public class GcomponentAnnotationModelFactory implements org.eclipse.core.filebuffers.IAnnotationModelFactory {
	...
	public org.eclipse.jface.text.source.IAnnotationModel createAnnotationModel(org.eclipse.core.runtime.IPath location) {
		...
		return new genericity.language.gcomponent.resource.gcomponent.ui.GcomponentAnnotationModel(resource);
	}
