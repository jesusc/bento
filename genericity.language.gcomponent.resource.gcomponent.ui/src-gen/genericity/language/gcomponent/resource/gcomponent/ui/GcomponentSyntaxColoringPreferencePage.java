 ...
 */
public class GcomponentSyntaxColoringPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	public GcomponentSyntaxColoringPreferencePage() {
		super();
		
		genericity.language.gcomponent.resource.gcomponent.IGcomponentMetaInformation syntaxPlugin = new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentMetaInformation();
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = genericity.language.gcomponent.resource.gcomponent.ui.GcomponentSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, genericity.language.gcomponent.resource.gcomponent.ui.GcomponentSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = genericity.language.gcomponent.resource.gcomponent.ui.GcomponentSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, genericity.language.gcomponent.resource.gcomponent.ui.GcomponentSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = genericity.language.gcomponent.resource.gcomponent.ui.GcomponentSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, genericity.language.gcomponent.resource.gcomponent.ui.GcomponentSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = genericity.language.gcomponent.resource.gcomponent.ui.GcomponentSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, genericity.language.gcomponent.resource.gcomponent.ui.GcomponentSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = genericity.language.gcomponent.resource.gcomponent.ui.GcomponentSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, genericity.language.gcomponent.resource.gcomponent.ui.GcomponentSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = genericity.language.gcomponent.resource.gcomponent.ui.GcomponentSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, genericity.language.gcomponent.resource.gcomponent.ui.GcomponentSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(org.eclipse.swt.widgets.Composite composite, int horizontalSpan) {
		genericity.language.gcomponent.resource.gcomponent.ui.GcomponentPixelConverter pixelConverter = new genericity.language.gcomponent.resource.gcomponent.ui.GcomponentPixelConverter(composite);
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof genericity.language.gcomponent.resource.gcomponent.ui.GcomponentEditor) {
			genericity.language.gcomponent.resource.gcomponent.ui.GcomponentEditor emfTextEditor = (genericity.language.gcomponent.resource.gcomponent.ui.GcomponentEditor) editor;
