 ...
 * olInput</code>.
 */
public class GcomponentDocBrowserInformationControlInput {
	
	private final GcomponentDocBrowserInformationControlInput fPrevious;
	private GcomponentDocBrowserInformationControlInput fNext;
	 ...
	 */
	public GcomponentDocBrowserInformationControlInput(GcomponentDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public GcomponentDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public GcomponentDocBrowserInformationControlInput getNext() {
		return fNext;
	}
