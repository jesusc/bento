...
public class GbindCodeFoldingManager {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(gbind.resource.gbind.ui.GbindEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof gbind.resource.gbind.ui.GbindEditor) {
				gbind.resource.gbind.ui.GbindEditor editor = (gbind.resource.gbind.ui.GbindEditor) workbenchPart;
	...
	protected gbind.resource.gbind.ui.GbindEditor editor;
	 ...
	 */
	public GbindCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,gbind.resource.gbind.ui.GbindEditor textEditor) {
	...
	private void addCloseListener(final gbind.resource.gbind.ui.GbindEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			gbind.resource.gbind.ui.GbindUIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
			return "";
		}
		String swap = "";
		String byteStr = "";
