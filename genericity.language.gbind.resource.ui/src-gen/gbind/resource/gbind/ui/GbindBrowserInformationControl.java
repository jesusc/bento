...
public class GbindBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private gbind.resource.gbind.ui.GbindDocBrowserInformationControlInput fInput;
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof gbind.resource.gbind.ui.GbindDocBrowserInformationControlInput);
		...
		fInput= (gbind.resource.gbind.ui.GbindDocBrowserInformationControlInput) input;
		...
		gbind.resource.gbind.ui.GbindHTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = gbind.resource.gbind.ui.GbindHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	 ...
	 */
	public gbind.resource.gbind.ui.GbindDocBrowserInformationControlInput getInput() {
		return fInput;
	}
