 ...
 */
public class GbindNewProjectWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard, org.eclipse.core.runtime.IExecutableExtension {
	 ...
	 */
	private String pageName = "New " + new genericity.language.gbind.mopp.GbindMetaInformation().getSyntaxName() + " Project";
				...
				public void execute(org.eclipse.core.runtime.IProgressMonitor monitor) throws InterruptedException {
					try {
						...
						if (!project.exists()) {
							...
							org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle("genericity.language.gbind.resource.ui");
							...
							String natureID = genericity.language.gbind.mopp.GbindNature.NATURE_ID;
							...
							for (String builderID : genericity.language.gbind.mopp.GbindNature.BUILDER_IDS) {
							...
							if (defaultNewFile.exists()) {
								genericity.language.gbind.mopp.GbindMetaInformation info = new genericity.language.gbind.mopp.GbindMetaInformation();
	...
	public void init(org.eclipse.ui.IWorkbench workbench, org.eclipse.jface.viewers.IStructuredSelection selection) {
		...
		org.osgi.framework.Bundle bundle = genericity.language.gbind.resource.gbind.ui.GbindUIPlugin.getDefault().getBundle();
