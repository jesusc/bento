 ...
 */
public class GbindCompletionProposal implements java.lang.Comparable<GbindCompletionProposal> {
	 ...
	 */
	private genericity.language.gbind.mopp.GbindExpectedTerminal expectedTerminal;
	...
	public GbindCompletionProposal(genericity.language.gbind.mopp.GbindExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container) {
		super();
	...
	public GbindCompletionProposal(genericity.language.gbind.mopp.GbindExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.swt.graphics.Image image) {
		this(expectedTerminal, insertString, prefix, matchesPrefix, structuralFeature, container);
		this.image = image;
	}
	
	public GbindCompletionProposal(genericity.language.gbind.mopp.GbindExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.swt.graphics.Image image, String displayString) {
	...
	public genericity.language.gbind.mopp.GbindExpectedTerminal getExpectedTerminal() {
		return expectedTerminal;
	}
	
	public boolean equals(Object object) {
		if (object instanceof GbindCompletionProposal) {
			GbindCompletionProposal other = (GbindCompletionProposal) object;
	...
	public int compareTo(GbindCompletionProposal object) {
		if (object instanceof GbindCompletionProposal) {
			GbindCompletionProposal other = (GbindCompletionProposal) object;
