 ...
 */
public class GcomponentResourceUtil {
	...
	public static genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentResource getResource(org.eclipse.emf.common.util.URI uri, java.util.Map<?,?> options) {
		new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentMetaInformation().registerResourceFactory();
		org.eclipse.emf.ecore.resource.ResourceSet rs = new org.eclipse.emf.ecore.resource.impl.ResourceSetImpl();
		if (options != null) {
			rs.getLoadOptions().putAll(options);
		}
		org.eclipse.emf.ecore.resource.Resource resource = rs.getResource(uri, true);
		return (genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentResource) resource;
	}
