 ...
 * to 4 bytes).
 */
public class GcomponentUnicodeConverter extends genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentInputStreamProcessor {
	 ...
	 */
	public GcomponentUnicodeConverter(java.io.InputStream inputStream) {
