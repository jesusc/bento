...
public class GcomponentTextToken implements genericity.language.gcomponent.resource.gcomponent.IGcomponentTextToken {
	...
	private final genericity.language.gcomponent.resource.gcomponent.IGcomponentMetaInformation metaInformation = new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentMetaInformation();
	private final org.antlr.runtime3_3_0.Token antlrToken;
	
	public GcomponentTextToken(org.antlr.runtime3_3_0.Token antlrToken) {
		super();
