...
/**
 * A GcomponentLayoutInformationAdapter is used to store layout information that
 ...
 * GcomponentLayoutInformationAdapters are attached to EObjects and aggregate
 ...
 */
public class GcomponentLayoutInformationAdapter implements org.eclipse.emf.common.notify.Adapter {
	 ...
	 * reference.
	 */
	private java.util.List<genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentLayoutInformation> layoutInformations = new java.util.ArrayList<genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentLayoutInformation>();
	...
	public java.util.List<genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentLayoutInformation> getLayoutInformations() {
		return layoutInformations;
	}
	
	public void addLayoutInformation(genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentLayoutInformation layoutInformation) {
