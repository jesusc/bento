...
public class GcomponentANTLRTextToken extends genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentTextToken {
	
	private final static genericity.language.gcomponent.resource.gcomponent.IGcomponentMetaInformation metaInformation = new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentMetaInformation();
	
	public GcomponentANTLRTextToken(org.antlr.runtime3_4_0.Token antlrToken) {
