...
public class GcomponentPlugin extends org.eclipse.core.runtime.Plugin {
	...
	protected static org.eclipse.core.runtime.IStatus log(int type, String message, Throwable throwable) {
		...
		if (throwable != null) {
			status = new org.eclipse.core.runtime.Status(type, GcomponentPlugin.PLUGIN_ID, 0, message, throwable);
		} else {
			status = new org.eclipse.core.runtime.Status(type, GcomponentPlugin.PLUGIN_ID, message);
		}
