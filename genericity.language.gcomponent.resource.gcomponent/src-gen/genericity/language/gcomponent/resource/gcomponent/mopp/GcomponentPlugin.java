 ...
 */
public class GcomponentPlugin extends org.eclipse.core.runtime.Plugin {
	
	public static final String PLUGIN_ID = "genericity.language.gcomponent.resource.gcomponent";
	/**
	...
	private static GcomponentPlugin plugin;
	
	public GcomponentPlugin() {
		super();
	}
	...
	public static GcomponentPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, GcomponentPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, GcomponentPlugin.PLUGIN_ID, message);
		}
		final GcomponentPlugin pluginInstance = GcomponentPlugin.getDefault();
