...
public class GcomponentStackFrame extends genericity.language.gcomponent.resource.gcomponent.debug.GcomponentDebugElement implements org.eclipse.debug.core.model.IStackFrame {
	
	private genericity.language.gcomponent.resource.gcomponent.debug.GcomponentDebugTarget target;
	private String name;
	private int id;
	...
	public GcomponentStackFrame(genericity.language.gcomponent.resource.gcomponent.debug.GcomponentDebugTarget target, String data) {
		super(target);
		this.target = target;
		
		java.util.List<String> dataParts = genericity.language.gcomponent.resource.gcomponent.util.GcomponentStringUtil.decode(data, ',');
	...
	private genericity.language.gcomponent.resource.gcomponent.debug.GcomponentDebugTarget getTarget() {
		return target;
	}
	...
	public boolean equals(Object obj) {
		...
		genericity.language.gcomponent.resource.gcomponent.debug.GcomponentStackFrame other = (genericity.language.gcomponent.resource.gcomponent.debug.GcomponentStackFrame) obj;
		if (name == null) {
