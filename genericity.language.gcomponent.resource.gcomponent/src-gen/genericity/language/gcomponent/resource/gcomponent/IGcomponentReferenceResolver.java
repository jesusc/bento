 ...
 * resolver
 */
public interface IGcomponentReferenceResolver<ContainerType extends org.eclipse.emf.ecore.EObject, ReferenceType extends org.eclipse.emf.ecore.EObject> extends genericity.language.gcomponent.resource.gcomponent.IGcomponentConfigurable {
	 ...
	 * operation.
	 */
	public void resolve(String identifier, ContainerType container, org.eclipse.emf.ecore.EReference reference, int position, boolean resolveFuzzy, genericity.language.gcomponent.resource.gcomponent.IGcomponentReferenceResolveResult<ReferenceType> result);
