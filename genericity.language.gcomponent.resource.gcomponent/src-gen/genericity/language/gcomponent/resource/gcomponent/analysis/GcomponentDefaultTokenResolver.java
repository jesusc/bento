 ...
 */
public class GcomponentDefaultTokenResolver implements genericity.language.gcomponent.resource.gcomponent.IGcomponentTokenResolver {
	 ...
	 */
	public GcomponentDefaultTokenResolver() {
		this(false);
	}
	 ...
	 */
	public GcomponentDefaultTokenResolver(boolean escapeKeywords) {
		super();
	...
	public void resolve(String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, genericity.language.gcomponent.resource.gcomponent.IGcomponentTokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
