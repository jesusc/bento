...
public class GcomponentFollowSetProvider {
	...
	public static void initializeTerminals0() {
		...
		TERMINALS[40] = new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentExpectedCsString(genericity.language.gcomponent.resource.gcomponent.grammar.GcomponentGrammarInformationProvider.GCOMPONENT_8_0_0_0);
		TERMINALS[41] = new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentExpectedCsString(genericity.language.gcomponent.resource.gcomponent.grammar.GcomponentGrammarInformationProvider.GCOMPONENT_7_0_0_5_0_0_0_0_0_0);
		TERMINALS[42] = new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentExpectedCsString(genericity.language.gcomponent.resource.gcomponent.grammar.GcomponentGrammarInformationProvider.GCOMPONENT_7_0_0_5_0_0_2_0_0_0);
		...
		TERMINALS[56] = new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentExpectedStructuralFeature(genericity.language.gcomponent.resource.gcomponent.grammar.GcomponentGrammarInformationProvider.GCOMPONENT_13_0_0_0_0_0_0);
		TERMINALS[57] = new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentExpectedStructuralFeature(genericity.language.gcomponent.resource.gcomponent.grammar.GcomponentGrammarInformationProvider.GCOMPONENT_13_0_0_0_0_1_0);
		TERMINALS[58] = new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentExpectedCsString(genericity.language.gcomponent.resource.gcomponent.grammar.GcomponentGrammarInformationProvider.GCOMPONENT_12_0_0_4_0_0_0);
		TERMINALS[59] = new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentExpectedCsString(genericity.language.gcomponent.resource.gcomponent.grammar.GcomponentGrammarInformationProvider.GCOMPONENT_12_0_0_5);
		TERMINALS[60] = new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentExpectedCsString(genericity.language.gcomponent.resource.gcomponent.grammar.GcomponentGrammarInformationProvider.GCOMPONENT_12_0_0_6);
		TERMINALS[61] = new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentExpectedCsString(genericity.language.gcomponent.resource.gcomponent.grammar.GcomponentGrammarInformationProvider.GCOMPONENT_12_0_0_7);
		TERMINALS[62] = new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentExpectedCsString(genericity.language.gcomponent.resource.gcomponent.grammar.GcomponentGrammarInformationProvider.GCOMPONENT_12_0_0_9_0_0_0);
		TERMINALS[63] = new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentExpectedCsString(genericity.language.gcomponent.resource.gcomponent.grammar.GcomponentGrammarInformationProvider.GCOMPONENT_12_0_0_10);
		TERMINALS[64] = new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentExpectedCsString(genericity.language.gcomponent.resource.gcomponent.grammar.GcomponentGrammarInformationProvider.GCOMPONENT_13_0_0_0_0_1_1);
		TERMINALS[65] = new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentExpectedStructuralFeature(genericity.language.gcomponent.resource.gcomponent.grammar.GcomponentGrammarInformationProvider.GCOMPONENT_13_0_0_0_0_1_2);
		TERMINALS[66] = new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentExpectedCsString(genericity.language.gcomponent.resource.gcomponent.grammar.GcomponentGrammarInformationProvider.GCOMPONENT_13_0_0_0_0_1_3);
		TERMINALS[67] = new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentExpectedStructuralFeature(genericity.language.gcomponent.resource.gcomponent.grammar.GcomponentGrammarInformationProvider.GCOMPONENT_16_0_0_1);
	...
	public static void initializeFeatures0() {
		...
		FEATURES[8] = genericity.language.gcomponent.core.CorePackage.eINSTANCE.getCompositeComponent().getEStructuralFeature(genericity.language.gcomponent.core.CorePackage.COMPOSITE_COMPONENT__BINDINGS);
		FEATURES[9] = genericity.language.gcomponent.flowcontrol.FlowcontrolPackage.eINSTANCE.getComposition().getEStructuralFeature(genericity.language.gcomponent.flowcontrol.FlowcontrolPackage.COMPOSITION__STEP);
		FEATURES[10] = genericity.language.gcomponent.flowcontrol.FlowcontrolPackage.eINSTANCE.getXorCond().getEStructuralFeature(genericity.language.gcomponent.flowcontrol.FlowcontrolPackage.XOR_COND__VALUE);
		FEATURES[11] = genericity.language.gcomponent.flowcontrol.FlowcontrolPackage.eINSTANCE.getXor().getEStructuralFeature(genericity.language.gcomponent.flowcontrol.FlowcontrolPackage.XOR__CONDITIONS);
		FEATURES[12] = genericity.language.gcomponent.flowcontrol.FlowcontrolPackage.eINSTANCE.getXorCond().getEStructuralFeature(genericity.language.gcomponent.flowcontrol.FlowcontrolPackage.XOR_COND__STEP);
		FEATURES[13] = genericity.language.gcomponent.flowcontrol.FlowcontrolPackage.eINSTANCE.getApply().getEStructuralFeature(genericity.language.gcomponent.flowcontrol.FlowcontrolPackage.APPLY__INPUT_MODELS);
		FEATURES[14] = genericity.language.gcomponent.flowcontrol.FlowcontrolPackage.eINSTANCE.getApply().getEStructuralFeature(genericity.language.gcomponent.flowcontrol.FlowcontrolPackage.APPLY__OUTPUT_MODELS);
		FEATURES[15] = genericity.language.gcomponent.flowcontrol.FlowcontrolPackage.eINSTANCE.getSeq().getEStructuralFeature(genericity.language.gcomponent.flowcontrol.FlowcontrolPackage.SEQ__STEPS);
		FEATURES[16] = genericity.language.gcomponent.technologies.TechnologiesPackage.eINSTANCE.getAtlTemplate().getEStructuralFeature(genericity.language.gcomponent.technologies.TechnologiesPackage.ATL_TEMPLATE__PARAMETERS);
		FEATURES[17] = genericity.language.gcomponent.dsl.DslPackage.eINSTANCE.getDefinitionRoot().getEStructuralFeature(genericity.language.gcomponent.dsl.DslPackage.DEFINITION_ROOT__COMPONENT);
	}
	...
	public static void initializeLinks0() {
		LINKS[0] = new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentContainedFeature(genericity.language.gcomponent.core.CorePackage.eINSTANCE.getTransformationComponent(), FEATURES[17]);
		LINKS[1] = new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentContainedFeature(genericity.language.gcomponent.core.CorePackage.eINSTANCE.getCompositeComponent(), FEATURES[17]);
		...
		LINKS[25] = new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentContainedFeature(genericity.language.gcomponent.core.CorePackage.eINSTANCE.getConcept(), FEATURES[1]);
		LINKS[26] = new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentContainedFeature(genericity.language.gcomponent.core.CorePackage.eINSTANCE.getParameterModel(), FEATURES[2]);
		LINKS[27] = new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentContainedFeature(genericity.language.gcomponent.core.CorePackage.eINSTANCE.getParameterModel(), FEATURES[3]);
		...
		LINKS[31] = new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentContainedFeature(genericity.language.gcomponent.variants.VariantsPackage.eINSTANCE.getSingleFeature(), FEATURES[4]);
		LINKS[32] = new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentContainedFeature(genericity.language.gcomponent.variants.VariantsPackage.eINSTANCE.getXorFeature(), FEATURES[4]);
		LINKS[33] = new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentContainedFeature(genericity.language.gcomponent.variants.VariantsPackage.eINSTANCE.getSingleFeature(), FEATURES[4]);
		LINKS[34] = new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentContainedFeature(genericity.language.gcomponent.variants.VariantsPackage.eINSTANCE.getXorFeature(), FEATURES[4]);
		LINKS[35] = new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentContainedFeature(genericity.language.gcomponent.flowcontrol.FlowcontrolPackage.eINSTANCE.getComposition(), FEATURES[7]);
		...
		LINKS[40] = new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentContainedFeature(genericity.language.gcomponent.flowcontrol.FlowcontrolPackage.eINSTANCE.getXor(), FEATURES[9]);
		LINKS[41] = new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentContainedFeature(genericity.language.gcomponent.flowcontrol.FlowcontrolPackage.eINSTANCE.getApply(), FEATURES[9]);
		LINKS[42] = new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentContainedFeature(genericity.language.gcomponent.flowcontrol.FlowcontrolPackage.eINSTANCE.getSeq(), FEATURES[9]);
		LINKS[43] = new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentContainedFeature(genericity.language.gcomponent.flowcontrol.FlowcontrolPackage.eINSTANCE.getFeatureRef(), FEATURES[10]);
		LINKS[44] = new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentContainedFeature(genericity.language.gcomponent.flowcontrol.FlowcontrolPackage.eINSTANCE.getXorCond(), FEATURES[11]);
		LINKS[45] = new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentContainedFeature(genericity.language.gcomponent.flowcontrol.FlowcontrolPackage.eINSTANCE.getXor(), FEATURES[15]);
		LINKS[46] = new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentContainedFeature(genericity.language.gcomponent.flowcontrol.FlowcontrolPackage.eINSTANCE.getApply(), FEATURES[15]);
		LINKS[47] = new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentContainedFeature(genericity.language.gcomponent.flowcontrol.FlowcontrolPackage.eINSTANCE.getSeq(), FEATURES[15]);
		LINKS[48] = new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentContainedFeature(genericity.language.gcomponent.flowcontrol.FlowcontrolPackage.eINSTANCE.getXor(), FEATURES[15]);
		LINKS[49] = new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentContainedFeature(genericity.language.gcomponent.flowcontrol.FlowcontrolPackage.eINSTANCE.getApply(), FEATURES[15]);
		LINKS[50] = new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentContainedFeature(genericity.language.gcomponent.flowcontrol.FlowcontrolPackage.eINSTANCE.getSeq(), FEATURES[15]);
		LINKS[51] = new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentContainedFeature(genericity.language.gcomponent.flowcontrol.FlowcontrolPackage.eINSTANCE.getXor(), FEATURES[12]);
		LINKS[52] = new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentContainedFeature(genericity.language.gcomponent.flowcontrol.FlowcontrolPackage.eINSTANCE.getApply(), FEATURES[12]);
		LINKS[53] = new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentContainedFeature(genericity.language.gcomponent.flowcontrol.FlowcontrolPackage.eINSTANCE.getSeq(), FEATURES[12]);
		LINKS[54] = new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentContainedFeature(genericity.language.gcomponent.flowcontrol.FlowcontrolPackage.eINSTANCE.getXor(), FEATURES[15]);
		LINKS[55] = new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentContainedFeature(genericity.language.gcomponent.flowcontrol.FlowcontrolPackage.eINSTANCE.getApply(), FEATURES[15]);
		LINKS[56] = new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentContainedFeature(genericity.language.gcomponent.flowcontrol.FlowcontrolPackage.eINSTANCE.getSeq(), FEATURES[15]);
		LINKS[57] = new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentContainedFeature(genericity.language.gcomponent.flowcontrol.FlowcontrolPackage.eINSTANCE.getApplyParameter(), FEATURES[13]);
		...
		LINKS[61] = new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentContainedFeature(genericity.language.gcomponent.flowcontrol.FlowcontrolPackage.eINSTANCE.getApplyParameter(), FEATURES[14]);
		...
		LINKS[65] = new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentContainedFeature(genericity.language.gcomponent.flowcontrol.FlowcontrolPackage.eINSTANCE.getXor(), FEATURES[15]);
		LINKS[66] = new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentContainedFeature(genericity.language.gcomponent.flowcontrol.FlowcontrolPackage.eINSTANCE.getApply(), FEATURES[15]);
		LINKS[67] = new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentContainedFeature(genericity.language.gcomponent.flowcontrol.FlowcontrolPackage.eINSTANCE.getSeq(), FEATURES[15]);
		LINKS[68] = new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentContainedFeature(genericity.language.gcomponent.flowcontrol.FlowcontrolPackage.eINSTANCE.getXor(), FEATURES[15]);
		LINKS[69] = new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentContainedFeature(genericity.language.gcomponent.flowcontrol.FlowcontrolPackage.eINSTANCE.getApply(), FEATURES[15]);
		LINKS[70] = new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentContainedFeature(genericity.language.gcomponent.flowcontrol.FlowcontrolPackage.eINSTANCE.getSeq(), FEATURES[15]);
		LINKS[71] = new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentContainedFeature(genericity.language.gcomponent.flowcontrol.FlowcontrolPackage.eINSTANCE.getXor(), FEATURES[15]);
		LINKS[72] = new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentContainedFeature(genericity.language.gcomponent.flowcontrol.FlowcontrolPackage.eINSTANCE.getApply(), FEATURES[15]);
		LINKS[73] = new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentContainedFeature(genericity.language.gcomponent.flowcontrol.FlowcontrolPackage.eINSTANCE.getSeq(), FEATURES[15]);
		LINKS[74] = new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentContainedFeature(genericity.language.gcomponent.flowcontrol.FlowcontrolPackage.eINSTANCE.getXor(), FEATURES[15]);
		LINKS[75] = new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentContainedFeature(genericity.language.gcomponent.flowcontrol.FlowcontrolPackage.eINSTANCE.getApply(), FEATURES[15]);
		LINKS[76] = new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentContainedFeature(genericity.language.gcomponent.flowcontrol.FlowcontrolPackage.eINSTANCE.getSeq(), FEATURES[15]);
		LINKS[77] = new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentContainedFeature(genericity.language.gcomponent.technologies.TechnologiesPackage.eINSTANCE.getAtlParameter(), FEATURES[16]);
	...
	public static void wire0() {
		...
		TERMINALS[42].addFollower(TERMINALS[9], new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentContainedFeature[] {new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentContainedFeature(genericity.language.gcomponent.core.CorePackage.eINSTANCE.getParameterModel(), FEATURES[2]), });
		...
		TERMINALS[55].addFollower(TERMINALS[57], new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentContainedFeature[] {new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentContainedFeature(genericity.language.gcomponent.flowcontrol.FlowcontrolPackage.eINSTANCE.getApplyParameter(), FEATURES[13]), });
		TERMINALS[58].addFollower(TERMINALS[56], new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentContainedFeature[] {new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentContainedFeature(genericity.language.gcomponent.flowcontrol.FlowcontrolPackage.eINSTANCE.getApplyParameter(), FEATURES[13]), });
		TERMINALS[58].addFollower(TERMINALS[57], new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentContainedFeature[] {new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentContainedFeature(genericity.language.gcomponent.flowcontrol.FlowcontrolPackage.eINSTANCE.getApplyParameter(), FEATURES[13]), });
		TERMINALS[59].addFollower(TERMINALS[60], EMPTY_LINK_ARRAY);
		TERMINALS[60].addFollower(TERMINALS[61], EMPTY_LINK_ARRAY);
		TERMINALS[61].addFollower(TERMINALS[56], new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentContainedFeature[] {new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentContainedFeature(genericity.language.gcomponent.flowcontrol.FlowcontrolPackage.eINSTANCE.getApplyParameter(), FEATURES[14]), });
		TERMINALS[61].addFollower(TERMINALS[57], new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentContainedFeature[] {new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentContainedFeature(genericity.language.gcomponent.flowcontrol.FlowcontrolPackage.eINSTANCE.getApplyParameter(), FEATURES[14]), });
		TERMINALS[61].addFollower(TERMINALS[62], EMPTY_LINK_ARRAY);
		TERMINALS[61].addFollower(TERMINALS[63], EMPTY_LINK_ARRAY);
		TERMINALS[62].addFollower(TERMINALS[56], new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentContainedFeature[] {new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentContainedFeature(genericity.language.gcomponent.flowcontrol.FlowcontrolPackage.eINSTANCE.getApplyParameter(), FEATURES[14]), });
		TERMINALS[62].addFollower(TERMINALS[57], new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentContainedFeature[] {new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentContainedFeature(genericity.language.gcomponent.flowcontrol.FlowcontrolPackage.eINSTANCE.getApplyParameter(), FEATURES[14]), });
		TERMINALS[63].addFollower(TERMINALS[44], EMPTY_LINK_ARRAY);
		TERMINALS[63].addFollower(TERMINALS[51], EMPTY_LINK_ARRAY);
		TERMINALS[63].addFollower(TERMINALS[48], new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentContainedFeature[] {new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentContainedFeature(genericity.language.gcomponent.flowcontrol.FlowcontrolPackage.eINSTANCE.getXor(), FEATURES[15]), });
		TERMINALS[63].addFollower(TERMINALS[49], new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentContainedFeature[] {new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentContainedFeature(genericity.language.gcomponent.flowcontrol.FlowcontrolPackage.eINSTANCE.getApply(), FEATURES[15]), });
		TERMINALS[63].addFollower(TERMINALS[50], new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentContainedFeature[] {new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentContainedFeature(genericity.language.gcomponent.flowcontrol.FlowcontrolPackage.eINSTANCE.getSeq(), FEATURES[15]), });
		TERMINALS[56].addFollower(TERMINALS[58], EMPTY_LINK_ARRAY);
		TERMINALS[56].addFollower(TERMINALS[59], EMPTY_LINK_ARRAY);
		TERMINALS[57].addFollower(TERMINALS[64], EMPTY_LINK_ARRAY);
		...
		TERMINALS[15].addFollower(TERMINALS[67], EMPTY_LINK_ARRAY);
