...
public class OclModelElementExpModelReferenceResolver implements org.emftext.language.gbind.resource.gbind.IGbindReferenceResolver<be.ac.vub.simpleocl.OclModelElementExp, be.ac.vub.simpleocl.OclModel> {
	...
	public void resolve(String identifier, be.ac.vub.simpleocl.OclModelElementExp container, org.eclipse.emf.ecore.EReference reference, int position, boolean resolveFuzzy, final org.emftext.language.gbind.resource.gbind.IGbindReferenceResolveResult<be.ac.vub.simpleocl.OclModel> result) {
