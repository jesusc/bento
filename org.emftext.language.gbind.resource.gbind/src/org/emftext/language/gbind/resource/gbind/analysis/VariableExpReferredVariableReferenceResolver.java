...
public class VariableExpReferredVariableReferenceResolver implements org.emftext.language.gbind.resource.gbind.IGbindReferenceResolver<be.ac.vub.simpleocl.VariableExp, be.ac.vub.simpleocl.VariableDeclaration> {
	...
	public void resolve(String identifier, be.ac.vub.simpleocl.VariableExp container, org.eclipse.emf.ecore.EReference reference, int position, boolean resolveFuzzy, final org.emftext.language.gbind.resource.gbind.IGbindReferenceResolveResult<be.ac.vub.simpleocl.VariableDeclaration> result) {
		delegate.resolve(identifier, container, reference, position, resolveFuzzy, new be.ac.vub.simpleocl.resource.simpleocl.ISimpleoclReferenceResolveResult<be.ac.vub.simpleocl.VariableDeclaration>() {
			...
			public void addQuickFix(final be.ac.vub.simpleocl.resource.simpleocl.ISimpleoclQuickFix quickFix) {
				result.addQuickFix(new org.emftext.language.gbind.resource.gbind.IGbindQuickFix() {
