...
public class GbindPrinter implements org.emftext.language.gbind.resource.gbind.IGbindTextPrinter {
	
	protected org.emftext.language.gbind.resource.gbind.IGbindTokenResolverFactory tokenResolverFactory = new org.emftext.language.gbind.resource.gbind.mopp.GbindTokenResolverFactory();
	...
	public GbindPrinter(java.io.OutputStream outputStream, org.emftext.language.gbind.resource.gbind.IGbindTextResource resource) {
		super();
	...
	protected void doPrint(org.eclipse.emf.ecore.EObject element, java.io.PrintWriter out, String globaltab) {
		...
		if (element instanceof org.emftext.language.gbind.BindingModel) {
			print_org_emftext_language_gbind_BindingModel((org.emftext.language.gbind.BindingModel) element, globaltab, out);
			return;
		}
		if (element instanceof org.emftext.language.gbind.ClassBinding) {
			print_org_emftext_language_gbind_ClassBinding((org.emftext.language.gbind.ClassBinding) element, globaltab, out);
			return;
		}
		if (element instanceof org.emftext.language.gbind.OclFeatureBinding) {
			print_org_emftext_language_gbind_OclFeatureBinding((org.emftext.language.gbind.OclFeatureBinding) element, globaltab, out);
			return;
		}
		if (element instanceof org.emftext.language.gbind.RenamingFeatureBinding) {
			print_org_emftext_language_gbind_RenamingFeatureBinding((org.emftext.language.gbind.RenamingFeatureBinding) element, globaltab, out);
			return;
		}
		if (element instanceof org.emftext.language.gbind.ConceptHelper) {
			print_org_emftext_language_gbind_ConceptHelper((org.emftext.language.gbind.ConceptHelper) element, globaltab, out);
			return;
		}
		if (element instanceof org.emftext.language.gbind.LocalHelper) {
			print_org_emftext_language_gbind_LocalHelper((org.emftext.language.gbind.LocalHelper) element, globaltab, out);
			return;
		}
	...
	public void print_org_emftext_language_gbind_BindingModel(org.emftext.language.gbind.BindingModel element, String outertab, java.io.PrintWriter out) {
		...
		Object temp;
		temp = element.eGet(element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.BINDING_MODEL__BINDINGS));
		printCountingMap.put("bindings", temp == null ? 0 : ((java.util.Collection<?>) temp).size());
		temp = element.eGet(element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.BINDING_MODEL__HELPERS));
		printCountingMap.put("helpers", temp == null ? 0 : ((java.util.Collection<?>) temp).size());
		temp = element.eGet(element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.BINDING_MODEL__CONCEPT_METACLASSES));
		printCountingMap.put("conceptMetaclasses", temp == null ? 0 : ((java.util.Collection<?>) temp).size());
		temp = element.eGet(element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.BINDING_MODEL__CONCRETE_METACLASSES));
		printCountingMap.put("concreteMetaclasses", temp == null ? 0 : ((java.util.Collection<?>) temp).size());
		temp = element.eGet(element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.BINDING_MODEL__METAMODEL));
		printCountingMap.put("metamodel", temp == null ? 0 : 1);
		temp = element.eGet(element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.BINDING_MODEL__METAMODEL_URI));
		printCountingMap.put("metamodelURI", temp == null ? 0 : 1);
		temp = element.eGet(element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.BINDING_MODEL__NAME));
		printCountingMap.put("name", temp == null ? 0 : 1);
		temp = element.eGet(element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.BINDING_MODEL__COMPONENT_URI));
		...
		if (count > 0) {
			Object o = element.eGet(element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.BINDING_MODEL__NAME));
			if (o != null) {
				org.emftext.language.gbind.resource.gbind.IGbindTokenResolver resolver = tokenResolverFactory.createTokenResolver("TEXT");
				resolver.setOptions(getOptions());
				out.print(resolver.deResolve((Object) o, element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.BINDING_MODEL__NAME), element));
				out.print(" ");
			}
		...
		print_org_emftext_language_gbind_BindingModel_0(element, localtab, out1, printCountingMap1);
		...
		if (count > 0) {
			Object o = element.eGet(element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.BINDING_MODEL__METAMODEL));
			if (o != null) {
				org.emftext.language.gbind.resource.gbind.IGbindTokenResolver resolver = tokenResolverFactory.createTokenResolver("TEXT");
				resolver.setOptions(getOptions());
				out.print(resolver.deResolve((Object) o, element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.BINDING_MODEL__METAMODEL), element));
				out.print(" ");
			}
		...
		out1 = new java.io.PrintWriter(sWriter);
		printCountingMap1 = new java.util.LinkedHashMap<String, Integer>(printCountingMap);
		print_org_emftext_language_gbind_BindingModel_1(element, localtab, out1, printCountingMap1);
		if (printCountingMap.equals(printCountingMap1)) {
			out1.close();
		} else {
			out1.flush();
		...
		if (count > 0) {
			java.util.List<?> list = (java.util.List<?>)element.eGet(element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.BINDING_MODEL__BINDINGS));
		...
		if (count > 0) {
			java.util.List<?> list = (java.util.List<?>)element.eGet(element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.BINDING_MODEL__HELPERS));
			int index  = list.size() - count;
			if (index < 0) {
				index = 0;
			}
	...
	public void print_org_emftext_language_gbind_BindingModel_0(org.emftext.language.gbind.BindingModel element, String outertab, java.io.PrintWriter out, java.util.Map<String, Integer> printCountingMap) {
		int count;
		// DEFINITION PART BEGINS (PlaceholderInQuotes)
		count = printCountingMap.get("metamodelURI");
		if (count > 0) {
			Object o = element.eGet(element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.BINDING_MODEL__METAMODEL_URI));
			if (o != null) {
				org.emftext.language.gbind.resource.gbind.IGbindTokenResolver resolver = tokenResolverFactory.createTokenResolver("QUOTED_91_93");
				resolver.setOptions(getOptions());
				out.print(resolver.deResolve((Object) o, element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.BINDING_MODEL__METAMODEL_URI), element));
				out.print(" ");
			}
	...
	public void print_org_emftext_language_gbind_BindingModel_1(org.emftext.language.gbind.BindingModel element, String outertab, java.io.PrintWriter out, java.util.Map<String, Integer> printCountingMap) {
		int count;
		// DEFINITION PART BEGINS (PlaceholderInQuotes)
		count = printCountingMap.get("componentURI");
		if (count > 0) {
			Object o = element.eGet(element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.BINDING_MODEL__COMPONENT_URI));
			if (o != null) {
				org.emftext.language.gbind.resource.gbind.IGbindTokenResolver resolver = tokenResolverFactory.createTokenResolver("QUOTED_91_93");
				resolver.setOptions(getOptions());
				out.print(resolver.deResolve((Object) o, element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.BINDING_MODEL__COMPONENT_URI), element));
				out.print(" ");
			}
	...
	public void print_org_emftext_language_gbind_ClassBinding(org.emftext.language.gbind.ClassBinding element, String outertab, java.io.PrintWriter out) {
		String localtab = outertab;
		// The printCountingMap contains a mapping from feature names to the number of
		// remaining elements that still need to be printed. The map is initialized with
		// the number of elements stored in each structural feature. For lists this is the
		...
		Object temp;
		temp = element.eGet(element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.CLASS_BINDING__DEBUG_NAME));
		printCountingMap.put("debugName", temp == null ? 0 : 1);
		temp = element.eGet(element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.CLASS_BINDING__MODEL_));
		printCountingMap.put("model_", temp == null ? 0 : 1);
		temp = element.eGet(element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.CLASS_BINDING__CONCEPT));
		printCountingMap.put("concept", temp == null ? 0 : 1);
		temp = element.eGet(element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.CLASS_BINDING__CONCRETE));
		printCountingMap.put("concrete", temp == null ? 0 : ((java.util.Collection<?>) temp).size());
		temp = element.eGet(element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.CLASS_BINDING__WHEN_CLAUSE));
		...
		if (count > 0) {
			Object o = element.eGet(element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.CLASS_BINDING__CONCEPT));
			if (o != null) {
				org.emftext.language.gbind.resource.gbind.IGbindTokenResolver resolver = tokenResolverFactory.createTokenResolver("TEXT");
				resolver.setOptions(getOptions());
				out.print(resolver.deResolve(getReferenceResolverSwitch() == null ? null : getReferenceResolverSwitch().getClassBindingConceptReferenceResolver().deResolve((org.emftext.language.gbind.ConceptMetaclass) o, element, (org.eclipse.emf.ecore.EReference) element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.CLASS_BINDING__CONCEPT)), element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.CLASS_BINDING__CONCEPT), element));
				out.print(" ");
			}
		...
		if (count > 0) {
			Object o = element.eGet(element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.CLASS_BINDING__CONCRETE));
			...
			if (o != null) {
				org.emftext.language.gbind.resource.gbind.IGbindTokenResolver resolver = tokenResolverFactory.createTokenResolver("TEXT");
				resolver.setOptions(getOptions());
				out.print(resolver.deResolve(getReferenceResolverSwitch() == null ? null : getReferenceResolverSwitch().getClassBindingConcreteReferenceResolver().deResolve((org.emftext.language.gbind.ConcreteMetaclass) o, element, (org.eclipse.emf.ecore.EReference) element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.CLASS_BINDING__CONCRETE)), element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.CLASS_BINDING__CONCRETE), element));
				out.print(" ");
			}
		...
		while (iterate) {
			...
			out1 = new java.io.PrintWriter(sWriter);
			printCountingMap1 = new java.util.LinkedHashMap<String, Integer>(printCountingMap);
			print_org_emftext_language_gbind_ClassBinding_0(element, localtab, out1, printCountingMap1);
			if (printCountingMap.equals(printCountingMap1)) {
				iterate = false;
				out1.close();
			} else {
	...
	public void print_org_emftext_language_gbind_ClassBinding_0(org.emftext.language.gbind.ClassBinding element, String outertab, java.io.PrintWriter out, java.util.Map<String, Integer> printCountingMap) {
		int count;
		// DEFINITION PART BEGINS (CsString)
		out.print(",");
		out.print(" ");
	...
	public void print_org_emftext_language_gbind_OclFeatureBinding(org.emftext.language.gbind.OclFeatureBinding element, String outertab, java.io.PrintWriter out) {
		String localtab = outertab;
		// The printCountingMap contains a mapping from feature names to the number of
		// remaining elements that still need to be printed. The map is initialized with
		// the number of elements stored in each structural feature. For lists this is the
		...
		Object temp;
		temp = element.eGet(element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.OCL_FEATURE_BINDING__DEBUG_NAME));
		printCountingMap.put("debugName", temp == null ? 0 : 1);
		temp = element.eGet(element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.OCL_FEATURE_BINDING__MODEL_));
		printCountingMap.put("model_", temp == null ? 0 : 1);
		temp = element.eGet(element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.OCL_FEATURE_BINDING__CONCEPT_FEATURE));
		printCountingMap.put("conceptFeature", temp == null ? 0 : 1);
		temp = element.eGet(element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.OCL_FEATURE_BINDING__CONCEPT_CLASS));
		printCountingMap.put("conceptClass", temp == null ? 0 : 1);
		temp = element.eGet(element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.OCL_FEATURE_BINDING__QUALIFIER));
		printCountingMap.put("qualifier", temp == null ? 0 : 1);
		temp = element.eGet(element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.OCL_FEATURE_BINDING__CONCRETE));
		...
		if (count > 0) {
			Object o = element.eGet(element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.OCL_FEATURE_BINDING__CONCEPT_CLASS));
			if (o != null) {
				org.emftext.language.gbind.resource.gbind.IGbindTokenResolver resolver = tokenResolverFactory.createTokenResolver("TEXT");
				resolver.setOptions(getOptions());
				out.print(resolver.deResolve(getReferenceResolverSwitch() == null ? null : getReferenceResolverSwitch().getBaseFeatureBindingConceptClassReferenceResolver().deResolve((org.emftext.language.gbind.ConceptMetaclass) o, element, (org.eclipse.emf.ecore.EReference) element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.OCL_FEATURE_BINDING__CONCEPT_CLASS)), element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.OCL_FEATURE_BINDING__CONCEPT_CLASS), element));
				out.print(" ");
			}
		...
		out1 = new java.io.PrintWriter(sWriter);
		printCountingMap1 = new java.util.LinkedHashMap<String, Integer>(printCountingMap);
		print_org_emftext_language_gbind_OclFeatureBinding_0(element, localtab, out1, printCountingMap1);
		if (printCountingMap.equals(printCountingMap1)) {
			out1.close();
		} else {
			out1.flush();
		...
		if (count > 0) {
			Object o = element.eGet(element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.OCL_FEATURE_BINDING__CONCEPT_FEATURE));
			if (o != null) {
				org.emftext.language.gbind.resource.gbind.IGbindTokenResolver resolver = tokenResolverFactory.createTokenResolver("TEXT");
				resolver.setOptions(getOptions());
				out.print(resolver.deResolve((Object) o, element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.OCL_FEATURE_BINDING__CONCEPT_FEATURE), element));
				out.print(" ");
			}
		...
		count = printCountingMap.get("concrete");
		if (count > 0) {
			Object o = element.eGet(element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.OCL_FEATURE_BINDING__CONCRETE));
			if (o != null) {
				doPrint((org.eclipse.emf.ecore.EObject) o, out, localtab);
			}
			printCountingMap.put("concrete", count - 1);
	...
	public void print_org_emftext_language_gbind_OclFeatureBinding_0(org.emftext.language.gbind.OclFeatureBinding element, String outertab, java.io.PrintWriter out, java.util.Map<String, Integer> printCountingMap) {
		int count;
		// DEFINITION PART BEGINS (PlaceholderInQuotes)
		count = printCountingMap.get("qualifier");
		if (count > 0) {
			Object o = element.eGet(element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.OCL_FEATURE_BINDING__QUALIFIER));
			if (o != null) {
				org.emftext.language.gbind.resource.gbind.IGbindTokenResolver resolver = tokenResolverFactory.createTokenResolver("QUOTED_91_93");
				resolver.setOptions(getOptions());
				out.print(resolver.deResolve(getReferenceResolverSwitch() == null ? null : getReferenceResolverSwitch().getBaseFeatureBindingQualifierReferenceResolver().deResolve((org.emftext.language.gbind.ConcreteMetaclass) o, element, (org.eclipse.emf.ecore.EReference) element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.OCL_FEATURE_BINDING__QUALIFIER)), element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.OCL_FEATURE_BINDING__QUALIFIER), element));
				out.print(" ");
			}
	...
	public void print_org_emftext_language_gbind_RenamingFeatureBinding(org.emftext.language.gbind.RenamingFeatureBinding element, String outertab, java.io.PrintWriter out) {
		String localtab = outertab;
		// The printCountingMap contains a mapping from feature names to the number of
		// remaining elements that still need to be printed. The map is initialized with
		// the number of elements stored in each structural feature. For lists this is the
		...
		java.util.Map<String, Integer> printCountingMap = new java.util.LinkedHashMap<String, Integer>(6);
		Object temp;
		temp = element.eGet(element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.RENAMING_FEATURE_BINDING__DEBUG_NAME));
		printCountingMap.put("debugName", temp == null ? 0 : 1);
		temp = element.eGet(element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.RENAMING_FEATURE_BINDING__MODEL_));
		printCountingMap.put("model_", temp == null ? 0 : 1);
		temp = element.eGet(element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.RENAMING_FEATURE_BINDING__CONCEPT_FEATURE));
		printCountingMap.put("conceptFeature", temp == null ? 0 : 1);
		temp = element.eGet(element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.RENAMING_FEATURE_BINDING__CONCEPT_CLASS));
		printCountingMap.put("conceptClass", temp == null ? 0 : 1);
		temp = element.eGet(element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.RENAMING_FEATURE_BINDING__QUALIFIER));
		printCountingMap.put("qualifier", temp == null ? 0 : 1);
		temp = element.eGet(element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.RENAMING_FEATURE_BINDING__CONCRETE_FEATURE));
		...
		count = printCountingMap.get("conceptClass");
		if (count > 0) {
			Object o = element.eGet(element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.RENAMING_FEATURE_BINDING__CONCEPT_CLASS));
			if (o != null) {
				org.emftext.language.gbind.resource.gbind.IGbindTokenResolver resolver = tokenResolverFactory.createTokenResolver("TEXT");
				resolver.setOptions(getOptions());
				out.print(resolver.deResolve(getReferenceResolverSwitch() == null ? null : getReferenceResolverSwitch().getBaseFeatureBindingConceptClassReferenceResolver().deResolve((org.emftext.language.gbind.ConceptMetaclass) o, element, (org.eclipse.emf.ecore.EReference) element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.RENAMING_FEATURE_BINDING__CONCEPT_CLASS)), element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.RENAMING_FEATURE_BINDING__CONCEPT_CLASS), element));
				out.print(" ");
			}
			printCountingMap.put("conceptClass", count - 1);
		}
		...
		out1 = new java.io.PrintWriter(sWriter);
		printCountingMap1 = new java.util.LinkedHashMap<String, Integer>(printCountingMap);
		print_org_emftext_language_gbind_RenamingFeatureBinding_0(element, localtab, out1, printCountingMap1);
		if (printCountingMap.equals(printCountingMap1)) {
			out1.close();
		} else {
			out1.flush();
		...
		count = printCountingMap.get("conceptFeature");
		if (count > 0) {
			Object o = element.eGet(element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.RENAMING_FEATURE_BINDING__CONCEPT_FEATURE));
			if (o != null) {
				org.emftext.language.gbind.resource.gbind.IGbindTokenResolver resolver = tokenResolverFactory.createTokenResolver("TEXT");
				resolver.setOptions(getOptions());
				out.print(resolver.deResolve((Object) o, element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.RENAMING_FEATURE_BINDING__CONCEPT_FEATURE), element));
				out.print(" ");
			}
			printCountingMap.put("conceptFeature", count - 1);
		}
		...
		if (count > 0) {
			Object o = element.eGet(element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.RENAMING_FEATURE_BINDING__CONCRETE_FEATURE));
			if (o != null) {
				org.emftext.language.gbind.resource.gbind.IGbindTokenResolver resolver = tokenResolverFactory.createTokenResolver("TEXT");
				resolver.setOptions(getOptions());
				out.print(resolver.deResolve((Object) o, element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.RENAMING_FEATURE_BINDING__CONCRETE_FEATURE), element));
				out.print(" ");
			}
	...
	public void print_org_emftext_language_gbind_RenamingFeatureBinding_0(org.emftext.language.gbind.RenamingFeatureBinding element, String outertab, java.io.PrintWriter out, java.util.Map<String, Integer> printCountingMap) {
		int count;
		// DEFINITION PART BEGINS (PlaceholderInQuotes)
		count = printCountingMap.get("qualifier");
		if (count > 0) {
			Object o = element.eGet(element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.RENAMING_FEATURE_BINDING__QUALIFIER));
			if (o != null) {
				org.emftext.language.gbind.resource.gbind.IGbindTokenResolver resolver = tokenResolverFactory.createTokenResolver("QUOTED_91_93");
				resolver.setOptions(getOptions());
				out.print(resolver.deResolve(getReferenceResolverSwitch() == null ? null : getReferenceResolverSwitch().getBaseFeatureBindingQualifierReferenceResolver().deResolve((org.emftext.language.gbind.ConcreteMetaclass) o, element, (org.eclipse.emf.ecore.EReference) element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.RENAMING_FEATURE_BINDING__QUALIFIER)), element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.RENAMING_FEATURE_BINDING__QUALIFIER), element));
				out.print(" ");
			}
			printCountingMap.put("qualifier", count - 1);
		}
	...
	public void print_org_emftext_language_gbind_ConceptHelper(org.emftext.language.gbind.ConceptHelper element, String outertab, java.io.PrintWriter out) {
		String localtab = outertab;
		// The printCountingMap contains a mapping from feature names to the number of
		// remaining elements that still need to be printed. The map is initialized with
		// the number of elements stored in each structural feature. For lists this is the
		...
		java.util.Map<String, Integer> printCountingMap = new java.util.LinkedHashMap<String, Integer>(6);
		Object temp;
		temp = element.eGet(element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.CONCEPT_HELPER__FEATURE));
		printCountingMap.put("feature", temp == null ? 0 : 1);
		temp = element.eGet(element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.CONCEPT_HELPER__BODY));
		printCountingMap.put("body", temp == null ? 0 : 1);
		temp = element.eGet(element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.CONCEPT_HELPER__TYPE));
		printCountingMap.put("type", temp == null ? 0 : 1);
		temp = element.eGet(element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.CONCEPT_HELPER__MODEL_));
		printCountingMap.put("model_", temp == null ? 0 : 1);
		temp = element.eGet(element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.CONCEPT_HELPER__QUALIFIER));
		printCountingMap.put("qualifier", temp == null ? 0 : 1);
		temp = element.eGet(element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.CONCEPT_HELPER__CONTEXT_CLASS));
		...
		if (count > 0) {
			Object o = element.eGet(element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.CONCEPT_HELPER__CONTEXT_CLASS));
			if (o != null) {
				org.emftext.language.gbind.resource.gbind.IGbindTokenResolver resolver = tokenResolverFactory.createTokenResolver("TEXT");
				resolver.setOptions(getOptions());
				out.print(resolver.deResolve(getReferenceResolverSwitch() == null ? null : getReferenceResolverSwitch().getConceptHelperContextClassReferenceResolver().deResolve((org.emftext.language.gbind.ConceptMetaclass) o, element, (org.eclipse.emf.ecore.EReference) element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.CONCEPT_HELPER__CONTEXT_CLASS)), element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.CONCEPT_HELPER__CONTEXT_CLASS), element));
				out.print(" ");
			}
		...
		out1 = new java.io.PrintWriter(sWriter);
		printCountingMap1 = new java.util.LinkedHashMap<String, Integer>(printCountingMap);
		print_org_emftext_language_gbind_ConceptHelper_0(element, localtab, out1, printCountingMap1);
		if (printCountingMap.equals(printCountingMap1)) {
			out1.close();
		} else {
			out1.flush();
		...
		if (count > 0) {
			Object o = element.eGet(element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.CONCEPT_HELPER__FEATURE));
			if (o != null) {
				org.emftext.language.gbind.resource.gbind.IGbindTokenResolver resolver = tokenResolverFactory.createTokenResolver("TEXT");
				resolver.setOptions(getOptions());
				out.print(resolver.deResolve((Object) o, element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.CONCEPT_HELPER__FEATURE), element));
				out.print(" ");
			}
		...
		if (count > 0) {
			Object o = element.eGet(element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.CONCEPT_HELPER__TYPE));
			if (o != null) {
				doPrint((org.eclipse.emf.ecore.EObject) o, out, localtab);
			}
		...
		if (count > 0) {
			Object o = element.eGet(element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.CONCEPT_HELPER__BODY));
			if (o != null) {
				doPrint((org.eclipse.emf.ecore.EObject) o, out, localtab);
			}
	...
	public void print_org_emftext_language_gbind_ConceptHelper_0(org.emftext.language.gbind.ConceptHelper element, String outertab, java.io.PrintWriter out, java.util.Map<String, Integer> printCountingMap) {
		int count;
		// DEFINITION PART BEGINS (PlaceholderInQuotes)
		count = printCountingMap.get("qualifier");
		if (count > 0) {
			Object o = element.eGet(element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.CONCEPT_HELPER__QUALIFIER));
			if (o != null) {
				org.emftext.language.gbind.resource.gbind.IGbindTokenResolver resolver = tokenResolverFactory.createTokenResolver("QUOTED_91_93");
				resolver.setOptions(getOptions());
				out.print(resolver.deResolve(getReferenceResolverSwitch() == null ? null : getReferenceResolverSwitch().getConceptHelperQualifierReferenceResolver().deResolve((org.emftext.language.gbind.ConcreteMetaclass) o, element, (org.eclipse.emf.ecore.EReference) element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.CONCEPT_HELPER__QUALIFIER)), element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.CONCEPT_HELPER__QUALIFIER), element));
				out.print(" ");
			}
			printCountingMap.put("qualifier", count - 1);
		}
	...
	public void print_org_emftext_language_gbind_LocalHelper(org.emftext.language.gbind.LocalHelper element, String outertab, java.io.PrintWriter out) {
		String localtab = outertab;
		// The printCountingMap contains a mapping from feature names to the number of
		// remaining elements that still need to be printed. The map is initialized with
		// the number of elements stored in each structural feature. For lists this is the
		...
		java.util.Map<String, Integer> printCountingMap = new java.util.LinkedHashMap<String, Integer>(5);
		Object temp;
		temp = element.eGet(element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.LOCAL_HELPER__FEATURE));
		printCountingMap.put("feature", temp == null ? 0 : 1);
		temp = element.eGet(element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.LOCAL_HELPER__BODY));
		printCountingMap.put("body", temp == null ? 0 : 1);
		temp = element.eGet(element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.LOCAL_HELPER__TYPE));
		printCountingMap.put("type", temp == null ? 0 : 1);
		temp = element.eGet(element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.LOCAL_HELPER__MODEL_));
		printCountingMap.put("model_", temp == null ? 0 : 1);
		temp = element.eGet(element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.LOCAL_HELPER__CONTEXT));
		...
		if (count > 0) {
			Object o = element.eGet(element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.LOCAL_HELPER__CONTEXT));
			if (o != null) {
				org.emftext.language.gbind.resource.gbind.IGbindTokenResolver resolver = tokenResolverFactory.createTokenResolver("TEXT");
				resolver.setOptions(getOptions());
				out.print(resolver.deResolve(getReferenceResolverSwitch() == null ? null : getReferenceResolverSwitch().getLocalHelperContextReferenceResolver().deResolve((org.emftext.language.gbind.ConcreteMetaclass) o, element, (org.eclipse.emf.ecore.EReference) element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.LOCAL_HELPER__CONTEXT)), element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.LOCAL_HELPER__CONTEXT), element));
				out.print(" ");
			}
		...
		count = printCountingMap.get("feature");
		if (count > 0) {
			Object o = element.eGet(element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.LOCAL_HELPER__FEATURE));
			if (o != null) {
				org.emftext.language.gbind.resource.gbind.IGbindTokenResolver resolver = tokenResolverFactory.createTokenResolver("TEXT");
				resolver.setOptions(getOptions());
				out.print(resolver.deResolve((Object) o, element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.LOCAL_HELPER__FEATURE), element));
				out.print(" ");
			}
			printCountingMap.put("feature", count - 1);
		}
		...
		count = printCountingMap.get("type");
		if (count > 0) {
			Object o = element.eGet(element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.LOCAL_HELPER__TYPE));
			if (o != null) {
				doPrint((org.eclipse.emf.ecore.EObject) o, out, localtab);
			}
			printCountingMap.put("type", count - 1);
		...
		count = printCountingMap.get("body");
		if (count > 0) {
			Object o = element.eGet(element.eClass().getEStructuralFeature(org.emftext.language.gbind.GbindPackage.LOCAL_HELPER__BODY));
			if (o != null) {
				doPrint((org.eclipse.emf.ecore.EObject) o, out, localtab);
			}
			printCountingMap.put("body", count - 1);
		...
		switch(alt) {
			case 1:			{
				...
				if (count > 0) {
					...
					if (o != null) {
						org.emftext.language.gbind.resource.gbind.IGbindTokenResolver resolver = tokenResolverFactory.createTokenResolver("QUOTED_34_34_92");
						resolver.setOptions(getOptions());
	...
	public void print_be_ac_vub_simpleocl_OclMetamodel_1(be.ac.vub.simpleocl.OclMetamodel element, String outertab, java.io.PrintWriter out, java.util.Map<String, Integer> printCountingMap) {
		...
		if (count > 0) {
			...
			if (o != null) {
				org.emftext.language.gbind.resource.gbind.IGbindTokenResolver resolver = tokenResolverFactory.createTokenResolver("QUOTED_39_39_92");
				resolver.setOptions(getOptions());
	...
	public void print_be_ac_vub_simpleocl_LocalVariable(be.ac.vub.simpleocl.LocalVariable element, String outertab, java.io.PrintWriter out) {
		...
		if (count > 0) {
			...
			if (o != null) {
				org.emftext.language.gbind.resource.gbind.IGbindTokenResolver resolver = tokenResolverFactory.createTokenResolver("EQ");
				resolver.setOptions(getOptions());
	...
	public void print_be_ac_vub_simpleocl_RealExp(be.ac.vub.simpleocl.RealExp element, String outertab, java.io.PrintWriter out) {
		...
		if (count > 0) {
			...
			if (o != null) {
				org.emftext.language.gbind.resource.gbind.IGbindTokenResolver resolver = tokenResolverFactory.createTokenResolver("FLOAT");
				resolver.setOptions(getOptions());
	...
	public void print_be_ac_vub_simpleocl_IntegerExp(be.ac.vub.simpleocl.IntegerExp element, String outertab, java.io.PrintWriter out) {
		...
		if (count > 0) {
			...
			if (o != null) {
				org.emftext.language.gbind.resource.gbind.IGbindTokenResolver resolver = tokenResolverFactory.createTokenResolver("INTEGER");
				resolver.setOptions(getOptions());
	...
	public void print_be_ac_vub_simpleocl_OperatorCallExp(be.ac.vub.simpleocl.OperatorCallExp element, String outertab, java.io.PrintWriter out) {
		...
		if (count > 0) {
			...
			if (o != null) {
				org.emftext.language.gbind.resource.gbind.IGbindTokenResolver resolver = tokenResolverFactory.createTokenResolver("BOOLOP");
				resolver.setOptions(getOptions());
		...
		switch(alt) {
			case 1:			{
				...
				if (count > 0) {
					...
					if (o != null) {
						org.emftext.language.gbind.resource.gbind.IGbindTokenResolver resolver = tokenResolverFactory.createTokenResolver("NEQ");
						resolver.setOptions(getOptions());
	...
	public void print_be_ac_vub_simpleocl_RelOpCallExp(be.ac.vub.simpleocl.RelOpCallExp element, String outertab, java.io.PrintWriter out) {
		...
		if (count > 0) {
			...
			if (o != null) {
				org.emftext.language.gbind.resource.gbind.IGbindTokenResolver resolver = tokenResolverFactory.createTokenResolver("RELOP");
				resolver.setOptions(getOptions());
	...
	public void print_be_ac_vub_simpleocl_AddOpCallExp(be.ac.vub.simpleocl.AddOpCallExp element, String outertab, java.io.PrintWriter out) {
		...
		if (count > 0) {
			...
			if (o != null) {
				org.emftext.language.gbind.resource.gbind.IGbindTokenResolver resolver = tokenResolverFactory.createTokenResolver("ADDOP");
				resolver.setOptions(getOptions());
	...
	public void print_be_ac_vub_simpleocl_IntOpCallExp(be.ac.vub.simpleocl.IntOpCallExp element, String outertab, java.io.PrintWriter out) {
		...
		if (count > 0) {
			...
			if (o != null) {
				org.emftext.language.gbind.resource.gbind.IGbindTokenResolver resolver = tokenResolverFactory.createTokenResolver("INTOP");
				resolver.setOptions(getOptions());
	...
	public void print_be_ac_vub_simpleocl_MulOpCallExp(be.ac.vub.simpleocl.MulOpCallExp element, String outertab, java.io.PrintWriter out) {
		...
		if (count > 0) {
			...
			if (o != null) {
				org.emftext.language.gbind.resource.gbind.IGbindTokenResolver resolver = tokenResolverFactory.createTokenResolver("MULOP");
				resolver.setOptions(getOptions());
	...
	public void print_be_ac_vub_simpleocl_NotOpCallExp(be.ac.vub.simpleocl.NotOpCallExp element, String outertab, java.io.PrintWriter out) {
		...
		if (count > 0) {
			...
			if (o != null) {
				org.emftext.language.gbind.resource.gbind.IGbindTokenResolver resolver = tokenResolverFactory.createTokenResolver("NOTOP");
				resolver.setOptions(getOptions());
	...
	public void print_be_ac_vub_simpleocl_CollectionType(be.ac.vub.simpleocl.CollectionType element, String outertab, java.io.PrintWriter out) {
		...
		if (count > 0) {
			...
			if (o != null) {
				org.emftext.language.gbind.resource.gbind.IGbindTokenResolver resolver = tokenResolverFactory.createTokenResolver("COLLECTIONTYPE");
				resolver.setOptions(getOptions());
	...
	public void print_be_ac_vub_simpleocl_StringType(be.ac.vub.simpleocl.StringType element, String outertab, java.io.PrintWriter out) {
		...
		if (count > 0) {
			...
			if (o != null) {
				org.emftext.language.gbind.resource.gbind.IGbindTokenResolver resolver = tokenResolverFactory.createTokenResolver("STRINGTYPE");
				resolver.setOptions(getOptions());
	...
	public void print_be_ac_vub_simpleocl_BooleanType(be.ac.vub.simpleocl.BooleanType element, String outertab, java.io.PrintWriter out) {
		...
		if (count > 0) {
			...
			if (o != null) {
				org.emftext.language.gbind.resource.gbind.IGbindTokenResolver resolver = tokenResolverFactory.createTokenResolver("BOOLEANTYPE");
				resolver.setOptions(getOptions());
	...
	public void print_be_ac_vub_simpleocl_IntegerType(be.ac.vub.simpleocl.IntegerType element, String outertab, java.io.PrintWriter out) {
		...
		if (count > 0) {
			...
			if (o != null) {
				org.emftext.language.gbind.resource.gbind.IGbindTokenResolver resolver = tokenResolverFactory.createTokenResolver("INTEGERTYPE");
				resolver.setOptions(getOptions());
	...
	public void print_be_ac_vub_simpleocl_RealType(be.ac.vub.simpleocl.RealType element, String outertab, java.io.PrintWriter out) {
		...
		if (count > 0) {
			...
			if (o != null) {
				org.emftext.language.gbind.resource.gbind.IGbindTokenResolver resolver = tokenResolverFactory.createTokenResolver("REALTYPE");
				resolver.setOptions(getOptions());
	...
	public void print_be_ac_vub_simpleocl_BagType(be.ac.vub.simpleocl.BagType element, String outertab, java.io.PrintWriter out) {
		...
		if (count > 0) {
			...
			if (o != null) {
				org.emftext.language.gbind.resource.gbind.IGbindTokenResolver resolver = tokenResolverFactory.createTokenResolver("BAGTYPE");
				resolver.setOptions(getOptions());
	...
	public void print_be_ac_vub_simpleocl_OrderedSetType(be.ac.vub.simpleocl.OrderedSetType element, String outertab, java.io.PrintWriter out) {
		...
		if (count > 0) {
			...
			if (o != null) {
				org.emftext.language.gbind.resource.gbind.IGbindTokenResolver resolver = tokenResolverFactory.createTokenResolver("ORDEREDSETTYPE");
				resolver.setOptions(getOptions());
	...
	public void print_be_ac_vub_simpleocl_SequenceType(be.ac.vub.simpleocl.SequenceType element, String outertab, java.io.PrintWriter out) {
		...
		if (count > 0) {
			...
			if (o != null) {
				org.emftext.language.gbind.resource.gbind.IGbindTokenResolver resolver = tokenResolverFactory.createTokenResolver("SEQUENCETYPE");
				resolver.setOptions(getOptions());
	...
	public void print_be_ac_vub_simpleocl_SetType(be.ac.vub.simpleocl.SetType element, String outertab, java.io.PrintWriter out) {
		...
		if (count > 0) {
			...
			if (o != null) {
				org.emftext.language.gbind.resource.gbind.IGbindTokenResolver resolver = tokenResolverFactory.createTokenResolver("SETTYPE");
				resolver.setOptions(getOptions());
	...
	public void print_be_ac_vub_simpleocl_OclAnyType(be.ac.vub.simpleocl.OclAnyType element, String outertab, java.io.PrintWriter out) {
		...
		if (count > 0) {
			...
			if (o != null) {
				org.emftext.language.gbind.resource.gbind.IGbindTokenResolver resolver = tokenResolverFactory.createTokenResolver("OCLANYTYPE");
				resolver.setOptions(getOptions());
	...
	public void print_be_ac_vub_simpleocl_OclType(be.ac.vub.simpleocl.OclType element, String outertab, java.io.PrintWriter out) {
		...
		if (count > 0) {
			...
			if (o != null) {
				org.emftext.language.gbind.resource.gbind.IGbindTokenResolver resolver = tokenResolverFactory.createTokenResolver("OCLTYPE");
				resolver.setOptions(getOptions());
		...
		switch(alt) {
			case 1:			{
				...
				if (count > 0) {
					...
					if (o != null) {
						org.emftext.language.gbind.resource.gbind.IGbindTokenResolver resolver = tokenResolverFactory.createTokenResolver("TUPLE");
						resolver.setOptions(getOptions());
			...
			if (count > 0) {
				Object o = element.eGet(element.eClass().getEStructuralFeature(be.ac.vub.simpleocl.SimpleoclPackage.TUPLE_TYPE__NAME));
				if (o != null) {
					org.emftext.language.gbind.resource.gbind.IGbindTokenResolver resolver = tokenResolverFactory.createTokenResolver("TUPLETYPE");
					resolver.setOptions(getOptions());
					out.print(resolver.deResolve((Object) o, element.eClass().getEStructuralFeature(be.ac.vub.simpleocl.SimpleoclPackage.TUPLE_TYPE__NAME), element));
					out.print(" ");
				}
	...
	public void print_be_ac_vub_simpleocl_MapType(be.ac.vub.simpleocl.MapType element, String outertab, java.io.PrintWriter out) {
		...
		if (count > 0) {
			...
			if (o != null) {
				org.emftext.language.gbind.resource.gbind.IGbindTokenResolver resolver = tokenResolverFactory.createTokenResolver("MAPTYPE");
				resolver.setOptions(getOptions());
	...
	public void print_be_ac_vub_simpleocl_LambdaType(be.ac.vub.simpleocl.LambdaType element, String outertab, java.io.PrintWriter out) {
		...
		if (count > 0) {
			...
			if (o != null) {
				org.emftext.language.gbind.resource.gbind.IGbindTokenResolver resolver = tokenResolverFactory.createTokenResolver("LAMBDATYPE");
				resolver.setOptions(getOptions());
	...
	public void print_be_ac_vub_simpleocl_EnvType(be.ac.vub.simpleocl.EnvType element, String outertab, java.io.PrintWriter out) {
		...
		if (count > 0) {
			...
			if (o != null) {
				org.emftext.language.gbind.resource.gbind.IGbindTokenResolver resolver = tokenResolverFactory.createTokenResolver("ENVTYPE");
				resolver.setOptions(getOptions());
