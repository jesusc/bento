...
public class GbindDebugValue extends org.emftext.language.gbind.resource.gbind.debug.GbindDebugElement implements org.eclipse.debug.core.model.IValue {
	...
	public GbindDebugValue(org.emftext.language.gbind.resource.gbind.debug.GbindDebugTarget target, String id, String valueString, String referenceTypeName, java.util.Map<String, Long> children) {
		super(target);
