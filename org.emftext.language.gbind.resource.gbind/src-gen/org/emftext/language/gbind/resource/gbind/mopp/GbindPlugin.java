 ...
 */
public class GbindPlugin extends org.eclipse.core.runtime.Plugin {
	
	public static final String PLUGIN_ID = "org.emftext.language.gbind.resource.gbind";
	/**
	...
	private static GbindPlugin plugin;
	...
	public static GbindPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, GbindPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, GbindPlugin.PLUGIN_ID, message);
		}
		final GbindPlugin pluginInstance = GbindPlugin.getDefault();
