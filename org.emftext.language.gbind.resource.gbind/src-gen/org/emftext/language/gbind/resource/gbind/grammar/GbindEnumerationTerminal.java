 ...
 */
public class GbindEnumerationTerminal extends org.emftext.language.gbind.resource.gbind.grammar.GbindTerminal {
	
	private java.util.Map<String, String> mapping = new java.util.LinkedHashMap<String, String>();
	
	public GbindEnumerationTerminal(org.eclipse.emf.ecore.EStructuralFeature attribute, String[] literalMappings, org.emftext.language.gbind.resource.gbind.grammar.GbindCardinality cardinality, int mandatoryOccurrencesAfter) {
