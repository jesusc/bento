...
public class GbindResourceUtil {
	...
	public static org.emftext.language.gbind.resource.gbind.mopp.GbindResource getResource(org.eclipse.core.resources.IFile file) {
		...
		return (org.emftext.language.gbind.resource.gbind.mopp.GbindResource) csResource;
	}
	
	public static org.emftext.language.gbind.resource.gbind.mopp.GbindResource getResource(java.io.File file) {
	...
	public static org.emftext.language.gbind.resource.gbind.mopp.GbindResource getResource(org.eclipse.emf.common.util.URI uri, java.util.Map<?,?> options) {
		new org.emftext.language.gbind.resource.gbind.mopp.GbindMetaInformation().registerResourceFactory();
		org.eclipse.emf.ecore.resource.ResourceSet rs = new org.eclipse.emf.ecore.resource.impl.ResourceSetImpl();
		if (options != null) {
			rs.getLoadOptions().putAll(options);
		}
		org.eclipse.emf.ecore.resource.Resource resource = rs.getResource(uri, true);
		return (org.emftext.language.gbind.resource.gbind.mopp.GbindResource) resource;
	}
	
	/**
	 * Returns the root element of the resource with the given URI.
	 */
	public static org.emftext.language.gbind.BindingModel getResourceContent(org.eclipse.emf.common.util.URI uri) {
	 ...
	 * Returns the root element of the resource with the given URI.
	 */
	public static org.emftext.language.gbind.BindingModel getResourceContent(org.eclipse.emf.common.util.URI uri, java.util.Map<?,?> options) {
		...
		return (org.emftext.language.gbind.BindingModel) root;
	}
