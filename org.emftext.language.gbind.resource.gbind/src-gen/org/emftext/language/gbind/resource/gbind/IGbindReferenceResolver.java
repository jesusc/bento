 ...
 * resolver
 */
public interface IGbindReferenceResolver<ContainerType extends org.eclipse.emf.ecore.EObject, ReferenceType extends org.eclipse.emf.ecore.EObject> extends org.emftext.language.gbind.resource.gbind.IGbindConfigurable {
	 ...
	 * operation.
	 */
	public void resolve(String identifier, ContainerType container, org.eclipse.emf.ecore.EReference reference, int position, boolean resolveFuzzy, org.emftext.language.gbind.resource.gbind.IGbindReferenceResolveResult<ReferenceType> result);
