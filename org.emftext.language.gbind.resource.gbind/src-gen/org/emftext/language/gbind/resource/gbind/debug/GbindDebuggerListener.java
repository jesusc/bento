 ...
 * code).
 */
public class GbindDebuggerListener<ResultType, ContextType> implements Runnable {
	...
	private org.emftext.language.gbind.resource.gbind.debug.AbstractGbindDebuggable debuggable;
	/**
	 ...
	 */
	private java.util.Map<Long, org.emftext.language.gbind.resource.gbind.util.GbindPair<String, Object>> objectMap = new java.util.LinkedHashMap<Long, org.emftext.language.gbind.resource.gbind.util.GbindPair<String, Object>>();
	...
	public GbindDebuggerListener(int requestPort) {
		super();
	...
	private void runDebugger() throws java.io.IOException {
		...
		org.emftext.language.gbind.resource.gbind.debug.GbindDebugMessage command;
		while (!stop) {
			command = communicationHelper.receive(reader);
			if (command == null) {
				break;
			}
			if (command.hasType(org.emftext.language.gbind.resource.gbind.debug.EGbindDebugMessageTypes.EXIT)) {
				debuggable.terminate();
				stop = true;
			} else if (command.hasType(org.emftext.language.gbind.resource.gbind.debug.EGbindDebugMessageTypes.RESUME)) {
				debuggable.resume();
			} else if (command.hasType(org.emftext.language.gbind.resource.gbind.debug.EGbindDebugMessageTypes.STEP_OVER)) {
				debuggable.stepOver();
			} else if (command.hasType(org.emftext.language.gbind.resource.gbind.debug.EGbindDebugMessageTypes.STEP_INTO)) {
				debuggable.stepInto();
			} else if (command.hasType(org.emftext.language.gbind.resource.gbind.debug.EGbindDebugMessageTypes.STEP_RETURN)) {
				debuggable.stepReturn();
			} else if (command.hasType(org.emftext.language.gbind.resource.gbind.debug.EGbindDebugMessageTypes.ADD_LINE_BREAKPOINT)) {
			...
			} else if (command.hasType(org.emftext.language.gbind.resource.gbind.debug.EGbindDebugMessageTypes.REMOVE_LINE_BREAKPOINT)) {
				String location = command.getArgument(0);
				int line = Integer.parseInt(command.getArgument(1));
				debuggable.removeLineBreakpoint(location, line);
			} else if (command.hasType(org.emftext.language.gbind.resource.gbind.debug.EGbindDebugMessageTypes.GET_STACK)) {
				final String[] stack = debuggable.getStack();
				String controlStack = org.emftext.language.gbind.resource.gbind.util.GbindStringUtil.encode('#', stack);
				org.emftext.language.gbind.resource.gbind.debug.GbindDebugMessage message = new org.emftext.language.gbind.resource.gbind.debug.GbindDebugMessage(org.emftext.language.gbind.resource.gbind.debug.EGbindDebugMessageTypes.GET_STACK_RESPONSE, new String[] {controlStack});
				communicationHelper.sendEvent(message, output);
			} else if (command.hasType(org.emftext.language.gbind.resource.gbind.debug.EGbindDebugMessageTypes.GET_FRAME_VARIABLES)) {
				...
				org.emftext.language.gbind.resource.gbind.debug.GbindDebugMessage message = new org.emftext.language.gbind.resource.gbind.debug.GbindDebugMessage(org.emftext.language.gbind.resource.gbind.debug.EGbindDebugMessageTypes.GET_FRAME_VARIABLES_RESPONSE, topVariableIDs);
				communicationHelper.sendEvent(message, output);
			} else if (command.hasType(org.emftext.language.gbind.resource.gbind.debug.EGbindDebugMessageTypes.GET_VARIABLES)) {
				...
				org.emftext.language.gbind.resource.gbind.debug.GbindDebugMessage message = new org.emftext.language.gbind.resource.gbind.debug.GbindDebugMessage(org.emftext.language.gbind.resource.gbind.debug.EGbindDebugMessageTypes.GET_VARIABLES_RESPONSE, varStrings);
				communicationHelper.sendEvent(message, output);
			} else {
	...
	private String convertToString(long id, Object object) {
		...
		return org.emftext.language.gbind.resource.gbind.util.GbindStringUtil.convertToString(properties);
	}
	...
	private long getObjectID(String name, Object value) {
		org.emftext.language.gbind.resource.gbind.util.GbindPair<String, Object> pair = new org.emftext.language.gbind.resource.gbind.util.GbindPair<String, Object>(name, value);
	...
	public org.emftext.language.gbind.resource.gbind.debug.AbstractGbindDebuggable getDebuggable() {
		return debuggable;
	}
	
	public void setDebuggable(org.emftext.language.gbind.resource.gbind.debug.AbstractGbindDebuggable debuggable) {
