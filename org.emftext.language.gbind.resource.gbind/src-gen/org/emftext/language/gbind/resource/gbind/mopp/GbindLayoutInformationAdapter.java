...
/**
 * A GbindLayoutInformationAdapter is used to store layout information that is
 ...
 * GbindLayoutInformationAdapters are attached to EObjects and aggregate multiple
 ...
 */
public class GbindLayoutInformationAdapter implements org.eclipse.emf.common.notify.Adapter {
	 ...
	 * reference.
	 */
	private java.util.List<org.emftext.language.gbind.resource.gbind.mopp.GbindLayoutInformation> layoutInformations = new java.util.ArrayList<org.emftext.language.gbind.resource.gbind.mopp.GbindLayoutInformation>();
	...
	public java.util.List<org.emftext.language.gbind.resource.gbind.mopp.GbindLayoutInformation> getLayoutInformations() {
		return layoutInformations;
	}
	
	public void addLayoutInformation(org.emftext.language.gbind.resource.gbind.mopp.GbindLayoutInformation layoutInformation) {
