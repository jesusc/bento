...
public class GbindStackFrame extends org.emftext.language.gbind.resource.gbind.debug.GbindDebugElement implements org.eclipse.debug.core.model.IStackFrame {
	
	private org.emftext.language.gbind.resource.gbind.debug.GbindDebugTarget target;
	private String name;
	private int id;
	...
	public GbindStackFrame(org.emftext.language.gbind.resource.gbind.debug.GbindDebugTarget target, String data) {
		super(target);
		this.target = target;
		
		java.util.List<String> dataParts = org.emftext.language.gbind.resource.gbind.util.GbindStringUtil.decode(data, ',');
	...
	private org.emftext.language.gbind.resource.gbind.debug.GbindDebugTarget getTarget() {
		return target;
	}
	...
	public boolean equals(Object obj) {
		...
		org.emftext.language.gbind.resource.gbind.debug.GbindStackFrame other = (org.emftext.language.gbind.resource.gbind.debug.GbindStackFrame) obj;
		if (name == null) {
