...
/**
 * A GbindLayoutInformation is used to store layout information that is found
 ...
 * GbindLayoutInformations are aggregated in LayoutInformationAdapters. One
 * GbindLayoutInformation contains the layout that was found before a keyword,
 * attribute or reference.
 */
public class GbindLayoutInformation {
	
	private final org.emftext.language.gbind.resource.gbind.grammar.GbindSyntaxElement syntaxElement;
	...
	public GbindLayoutInformation(org.emftext.language.gbind.resource.gbind.grammar.GbindSyntaxElement syntaxElement, Object object, int startOffset, String hiddenTokenText, String visibleTokenText) {
		super();
	...
	public org.emftext.language.gbind.resource.gbind.grammar.GbindSyntaxElement getSyntaxElement() {
