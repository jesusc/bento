 ...
 * delegates.
 */
public class GbindLaunchConfigurationHelper {
	
	public static class SystemOutInterpreter extends org.emftext.language.gbind.resource.gbind.util.AbstractGbindInterpreter<Void,Void> {
	...
	public <ResultType, ContextType> void launchInterpreter(org.eclipse.debug.core.ILaunchConfiguration configuration, String mode, org.eclipse.debug.core.ILaunch launch, org.eclipse.core.runtime.IProgressMonitor monitor, org.emftext.language.gbind.resource.gbind.util.AbstractGbindInterpreter<ResultType, ContextType> delegate, final ContextType context) throws org.eclipse.core.runtime.CoreException {
		...
		final org.emftext.language.gbind.resource.gbind.debug.GbindDebuggableInterpreter<ResultType, ContextType> interpreter = new org.emftext.language.gbind.resource.gbind.debug.GbindDebuggableInterpreter<ResultType, ContextType>(delegate, eventPort);
		...
		// running process
		org.emftext.language.gbind.resource.gbind.debug.GbindDebuggerListener<ResultType, ContextType> debugListener = new org.emftext.language.gbind.resource.gbind.debug.GbindDebuggerListener<ResultType, ContextType>(requestPort);
		debugListener.setDebuggable(interpreter);
		new Thread(debugListener).start();
		
		// step 4: start debugger
		org.emftext.language.gbind.resource.gbind.debug.GbindDebugProcess process = new org.emftext.language.gbind.resource.gbind.debug.GbindDebugProcess(launch);
		launch.addDebugTarget(new org.emftext.language.gbind.resource.gbind.debug.GbindDebugTarget(process, launch, requestPort, eventPort));
	}
	...
	public org.eclipse.emf.common.util.URI getURI(org.eclipse.debug.core.ILaunchConfiguration configuration) throws org.eclipse.core.runtime.CoreException {
		return org.eclipse.emf.common.util.URI.createURI(configuration.getAttribute(org.emftext.language.gbind.resource.gbind.launch.GbindLaunchConfigurationDelegate.ATTR_RESOURCE_URI, (String) null));
	}
	...
	public org.eclipse.emf.ecore.EObject getModelRoot(org.eclipse.debug.core.ILaunchConfiguration configuration) throws org.eclipse.core.runtime.CoreException {
		return org.emftext.language.gbind.resource.gbind.util.GbindResourceUtil.getResourceContent(getURI(configuration));
	}
	...
	protected void abort(String message, Throwable e) throws org.eclipse.core.runtime.CoreException {
		throw new org.eclipse.core.runtime.CoreException(new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, org.emftext.language.gbind.resource.gbind.mopp.GbindPlugin.DEBUG_MODEL_ID, 0, message, e));
	}
}
