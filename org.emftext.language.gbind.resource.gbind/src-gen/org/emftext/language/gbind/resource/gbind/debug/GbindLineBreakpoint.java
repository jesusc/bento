...
public class GbindLineBreakpoint extends org.eclipse.debug.core.model.LineBreakpoint {
	...
	private static final String LINE_BREAKPOINT_MARKER_ID = "org.emftext.language.gbind.resource.gbind.debug.lineBreakpoint.marker";
	...
	public String getModelIdentifier() {
		return org.emftext.language.gbind.resource.gbind.mopp.GbindPlugin.DEBUG_MODEL_ID;
	}
	
	public void install(org.emftext.language.gbind.resource.gbind.debug.GbindDebugTarget target) {
		try {
	...
	public void remove(org.emftext.language.gbind.resource.gbind.debug.GbindDebugTarget target) {
		try {
			String location = (String) getMarker().getAttribute(org.eclipse.core.resources.IMarker.LOCATION);
