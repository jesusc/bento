 ...
 * contains
 * <code>org.emftext.language.gbind.resource.gbind.IGbindTextDiagnostic</code>s it
...
public class GbindMarkerHelper {
	 ...
	 */
	public static final String MARKER_TYPE = org.emftext.language.gbind.resource.gbind.mopp.GbindPlugin.PLUGIN_ID + ".problem";
	...
	private static class MarkerCommandQueue {
		...
		private java.util.List<org.emftext.language.gbind.resource.gbind.IGbindCommand<Object>> commands = new java.util.ArrayList<org.emftext.language.gbind.resource.gbind.IGbindCommand<Object>>();
		private final Object jobLock = new Object();
		
		public void addCommand(org.emftext.language.gbind.resource.gbind.IGbindCommand<Object> command) {
			...
			new org.eclipse.core.runtime.jobs.Job("updating markers") {
				...
				protected org.eclipse.core.runtime.IStatus run(org.eclipse.core.runtime.IProgressMonitor monitor) {
					synchronized(jobLock) {
						java.util.List<org.emftext.language.gbind.resource.gbind.IGbindCommand<Object>> commandsToProcess = new java.util.ArrayList<org.emftext.language.gbind.resource.gbind.IGbindCommand<Object>>();
						synchronized(commands) {
							commandsToProcess.addAll(commands);
							commands.clear();
						}
						for (org.emftext.language.gbind.resource.gbind.IGbindCommand<Object> command : commandsToProcess) {
	 ...
	 */
	public static void mark(org.eclipse.emf.ecore.resource.Resource resource, final org.emftext.language.gbind.resource.gbind.IGbindTextDiagnostic diagnostic) {
	...
	private static void createMarkerFromDiagnostic(final org.eclipse.core.resources.IFile file, final org.emftext.language.gbind.resource.gbind.IGbindTextDiagnostic diagnostic) {
		final org.emftext.language.gbind.resource.gbind.IGbindProblem problem = diagnostic.getProblem();
		org.emftext.language.gbind.resource.gbind.GbindEProblemType problemType = problem.getType();
		final String markerID = getMarkerID(problemType);
		COMMAND_QUEUE.addCommand(new org.emftext.language.gbind.resource.gbind.IGbindCommand<Object>() {
			public boolean execute(Object context) {
				try {
					...
					if (problem.getSeverity() == org.emftext.language.gbind.resource.gbind.GbindEProblemSeverity.ERROR) {
					...
					org.emftext.language.gbind.resource.gbind.IGbindTextDiagnostic textDiagnostic = (org.emftext.language.gbind.resource.gbind.IGbindTextDiagnostic) diagnostic;
					...
					if (diagnostic instanceof org.emftext.language.gbind.resource.gbind.mopp.GbindResource.ElementBasedTextDiagnostic) {
						org.eclipse.emf.ecore.EObject element = ((org.emftext.language.gbind.resource.gbind.mopp.GbindResource.ElementBasedTextDiagnostic) diagnostic).getElement();
					...
					java.util.Collection<org.emftext.language.gbind.resource.gbind.IGbindQuickFix> quickFixes = textDiagnostic.getProblem().getQuickFixes();
					...
					if (!sourceIDs.isEmpty()) {
						marker.setAttribute(org.eclipse.core.resources.IMarker.SOURCE_ID, org.emftext.language.gbind.resource.gbind.util.GbindStringUtil.explode(sourceIDs, "|"));
					}
	...
	public static void unmark(org.eclipse.emf.ecore.resource.Resource resource) {
		for (org.emftext.language.gbind.resource.gbind.GbindEProblemType nextType : org.emftext.language.gbind.resource.gbind.GbindEProblemType.values()) {
	 ...
	 */
	public static void unmark(org.eclipse.emf.ecore.resource.Resource resource, org.emftext.language.gbind.resource.gbind.GbindEProblemType problemType) {
		final org.eclipse.core.resources.IFile file = getFile(resource);
		if (file == null) {
			return;
		}
	...
	public static void unmark(org.eclipse.emf.ecore.resource.Resource resource, final org.eclipse.emf.ecore.EObject causingObject) {
		...
		final String markerID = getMarkerID(org.emftext.language.gbind.resource.gbind.GbindEProblemType.UNKNOWN);
	 ...
	 * given type.
	 */
	private static String getMarkerID(org.emftext.language.gbind.resource.gbind.GbindEProblemType problemType) {
	...
	private static void handleException(org.eclipse.core.runtime.CoreException ce) {
		if (ce.getMessage().matches("Marker.*not found.")) {
			...
			org.emftext.language.gbind.resource.gbind.mopp.GbindPlugin.logError("Error while removing markers from resource:", ce);
		}
	}
}
