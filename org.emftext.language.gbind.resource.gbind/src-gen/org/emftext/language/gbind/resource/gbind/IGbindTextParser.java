 ...
 */
public interface IGbindTextParser extends org.emftext.language.gbind.resource.gbind.IGbindConfigurable {
	 ...
	 */
	public org.emftext.language.gbind.resource.gbind.IGbindParseResult parse();
	 ...
	 * will not be needed.
	 */
	public java.util.List<org.emftext.language.gbind.resource.gbind.mopp.GbindExpectedTerminal> parseToExpectedElements(org.eclipse.emf.ecore.EClass type, org.emftext.language.gbind.resource.gbind.IGbindTextResource dummyResource, int cursorOffset);
