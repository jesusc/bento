 ...
 */
public class GbindDefaultTokenResolver implements org.emftext.language.gbind.resource.gbind.IGbindTokenResolver {
	 ...
	 */
	public GbindDefaultTokenResolver() {
		this(false);
	}
	 ...
	 */
	public GbindDefaultTokenResolver(boolean escapeKeywords) {
		super();
		this.escapeKeywords = escapeKeywords;
	}
	
	public void resolve(String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, org.emftext.language.gbind.resource.gbind.IGbindTokenResolveResult result) {
		resolve(lexem, feature, result, null, null, null);
	}
	
	public void resolve(String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, org.emftext.language.gbind.resource.gbind.IGbindTokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
		// Step 1: unescape keywords if required
		if (escapeKeywords && lexem.startsWith("_")) {
			for (String keyword : org.emftext.language.gbind.resource.gbind.grammar.GbindGrammarInformationProvider.INSTANCE.getKeywords()) {
