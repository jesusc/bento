...
public class ReportImpl extends EObjectImpl implements Report {
	 ...
	 * @ordered
	 */
	protected EList<Problem> errors;
	 ...
	 * @generated
	 */
	public EList<Problem> getErrors() {
		if (errors == null) {
			errors = new EObjectContainmentEList<Problem>(Problem.class, this, ReportPackage.REPORT__ERRORS);
		}
		return errors;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case ReportPackage.REPORT__ERRORS:
				getErrors().clear();
				getErrors().addAll((Collection<? extends Problem>)newValue);
				return;
		}
