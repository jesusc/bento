grammar genericity_dsl_ANTLR3;options {
    backtrack = true;
...
//	}
    ...
    genericity_dsl_ANTLR3Lexer lex = new 
    genericity_dsl_ANTLR3Lexer(input);
						CommonTokenStream tokens = new CommonTokenStream(lex);
						tokens.discardTokenType(WS);
						tokens.discardTokenType(COMMENT);
						tokens.discardTokenType(NL);
						
    genericity_dsl_ANTLR3Parser parser = new 
    genericity_dsl_ANTLR3Parser(tokens);
						parser.main();
					}
}

main returns[Object ret2] @init {}
	:	((ret=bindingModel) EOF)
        {
            ret2=ret;
        }
...
bindingModel returns[Object ret2] @init {Object ret=(backtracking==0) ? ei.create("BindingModel", true, false) : null;org.antlr.runtime.Token firstToken=input.LT(1);}
	:	('binding' temp=identifier {ei.set(ret, "name", temp);} 'for' temp=identifier {ei.set(ret, "metamodel", temp);} LCURLY ((((temp=conceptBinding {ei.set(ret, "bindings", temp);} ((temp=conceptBinding {ei.set(ret, "bindings", temp);}))*))?)) ((((temp=bHelper {ei.set(ret, "helpers", temp);} ((temp=bHelper {ei.set(ret, "helpers", temp);}))*))?)) RCURLY)
        {
...
conceptBinding returns[Object ret2] @init {}
	:	((ret=classBinding| ret=baseFeatureBinding))
        {
...
classBinding returns[Object ret2] @init {Object ret=(backtracking==0) ? ei.create("ClassBinding", false, false) : null;org.antlr.runtime.Token firstToken=input.LT(1);}
	:	('class' temp=identifier {ei.setRef(ret, "concept", "ConceptMetaclass", "name", temp, "#all", "ifmissing", null, false, null);} 'to' ((temp=identifier {ei.setRef(ret, "concrete", "ConcreteMetaclass", "name", temp, "#all", "ifmissing", null, false, null);} (((COMA) temp=identifier {ei.setRef(ret, "concrete", "ConcreteMetaclass", "name", temp, "#all", "ifmissing", null, false, null);}))*)) (('when' temp=oclExpression {ei.set(ret, "whenClause", temp);}) {}| () {}))
        {
...
metaclass returns[Object ret2] @init {}
	:	((ret=conceptMetaclass| ret=concreteMetaclass))
        {
            ei.addToContext(ret, false);
            ret2=ret;
        }
...
concreteMetaclass returns[Object ret2] @init {Object ret=(backtracking==0) ? ei.create("ConcreteMetaclass", false, false) : null;org.antlr.runtime.Token firstToken=input.LT(1);}
	:	(temp=identifier {ei.set(ret, "name", temp);})
        {
            ei.leaveContext(false);
            if(input.LT(-1) != null) ei.setLocation(ret, firstToken.getLine() + ":" + (firstToken.getCharPositionInLine() + 1) + "-" + ((org.eclipse.gmt.tcs.injector.wrappers.antlr3.ANTLR3LocationToken)input.LT(-1)).getEndLine() + ":" + (((org.eclipse.gmt.tcs.injector.wrappers.antlr3.ANTLR3LocationToken)input.LT(-1)).getEndColumn() + 1));ei.setCommentsBefore(ret, new Object[] {input, firstToken});
...
baseFeatureBinding returns[Object ret2] @init {}
	:	((ret=oclFeatureBinding| ret=renamingFeatureBinding))
        {
            ei.addToContext(ret, false);
            ret2=ret;
        }
...
oclFeatureBinding returns[Object ret2] @init {Object ret=(backtracking==0) ? ei.create("OclFeatureBinding", false, false) : null;org.antlr.runtime.Token firstToken=input.LT(1);}
	:	('feature' temp=identifier {ei.setRef(ret, "conceptClass", "ConceptMetaclass", "name", temp, "#all", "never", null, false, null);} ((LSQUARE temp=identifier {ei.setRef(ret, "qualifier", "ConcreteMetaclass", "name", temp, "#all", "never", null, false, null);} RSQUARE) {}| () {}) POINT temp=identifier {ei.set(ret, "conceptFeature", temp);} EQ temp=oclExpression {ei.set(ret, "concrete", temp);})
        {
            ei.leaveContext(false);
            if(input.LT(-1) != null) ei.setLocation(ret, firstToken.getLine() + ":" + (firstToken.getCharPositionInLine() + 1) + "-" + ((org.eclipse.gmt.tcs.injector.wrappers.antlr3.ANTLR3LocationToken)input.LT(-1)).getEndLine() + ":" + (((org.eclipse.gmt.tcs.injector.wrappers.antlr3.ANTLR3LocationToken)input.LT(-1)).getEndColumn() + 1));ei.setCommentsBefore(ret, new Object[] {input, firstToken});
	   ei.setCommentsAfter(ret, new Object[] {input, input.LT(-1)});
...
renamingFeatureBinding returns[Object ret2] @init {Object ret=(backtracking==0) ? ei.create("RenamingFeatureBinding", false, false) : null;org.antlr.runtime.Token firstToken=input.LT(1);}
	:	('feature' temp=identifier {ei.setRef(ret, "conceptClass", "ConceptMetaclass", "name", temp, "#all", "never", null, false, null);} ((LSQUARE temp=identifier {ei.setRef(ret, "qualifier", "ConcreteMetaclass", "name", temp, "#all", "never", null, false, null);} RSQUARE) {}| () {}) POINT temp=identifier {ei.set(ret, "conceptFeature", temp);} 'is' temp=identifier {ei.set(ret, "concreteFeature", temp);})
        {
            ei.leaveContext(false);
            if(input.LT(-1) != null) ei.setLocation(ret, firstToken.getLine() + ":" + (firstToken.getCharPositionInLine() + 1) + "-" + ((org.eclipse.gmt.tcs.injector.wrappers.antlr3.ANTLR3LocationToken)input.LT(-1)).getEndLine() + ":" + (((org.eclipse.gmt.tcs.injector.wrappers.antlr3.ANTLR3LocationToken)input.LT(-1)).getEndColumn() + 1));ei.setCommentsBefore(ret, new Object[] {input, firstToken});
	   ei.setCommentsAfter(ret, new Object[] {input, input.LT(-1)});
...
bHelper returns[Object ret2] @init {Object ret=(backtracking==0) ? ei.create("BHelper", false, false) : null;org.antlr.runtime.Token firstToken=input.LT(1);}
	:	('helper' temp=identifier {ei.setRef(ret, "contextClass", "ConceptMetaclass", "name", temp, "#all", "ifmissing", null, false, null);} POINT temp=identifier {ei.set(ret, "feature", temp);} COLON temp=oclType {ei.set(ret, "type", temp);} EQ temp=oclExpression {ei.set(ret, "body", temp);})
        {
            ei.leaveContext(false);
            if(input.LT(-1) != null) ei.setLocation(ret, firstToken.getLine() + ":" + (firstToken.getCharPositionInLine() + 1) + "-" + ((org.eclipse.gmt.tcs.injector.wrappers.antlr3.ANTLR3LocationToken)input.LT(-1)).getEndLine() + ":" + (((org.eclipse.gmt.tcs.injector.wrappers.antlr3.ANTLR3LocationToken)input.LT(-1)).getEndColumn() + 1));ei.setCommentsBefore(ret, new Object[] {input, firstToken});
	   ei.setCommentsAfter(ret, new Object[] {input, input.LT(-1)});
