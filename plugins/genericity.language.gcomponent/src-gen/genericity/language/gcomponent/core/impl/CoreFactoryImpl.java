...
public class CoreFactoryImpl extends EFactoryImpl implements CoreFactory {
	...
	public static CoreFactory init() {
		try {
			CoreFactory theCoreFactory = (CoreFactory)EPackage.Registry.INSTANCE.getEFactory("http://genericity/language/gcomponent/core"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case CorePackage.CONCEPT: return createConcept();
			case CorePackage.DOCUMENTATION: return createDocumentation();
			default:
