...
public class GbindBuilderAdapter extends org.eclipse.core.resources.IncrementalProjectBuilder implements org.eclipse.core.resources.IResourceDeltaVisitor, org.eclipse.core.resources.IResourceVisitor {
	
	/**
	 * The ID of the default, generated builder.
	 */
	public final static String BUILDER_ID = "genericity.language.gbind.resource.builder";
	
	private genericity.language.gbind.IGbindBuilder defaultBuilder = new genericity.language.gbind.mopp.GbindBuilder();
	...
	public void build(org.eclipse.core.resources.IFile resource, org.eclipse.emf.ecore.resource.ResourceSet resourceSet, org.eclipse.core.runtime.IProgressMonitor monitor) {
		...
		genericity.language.gbind.IGbindBuilder builder = getBuilder();
		if (builder.isBuildingNeeded(uri)) {
			genericity.language.gbind.mopp.GbindResource customResource = (genericity.language.gbind.mopp.GbindResource) resourceSet.getResource(uri, true);
			new genericity.language.gbind.mopp.GbindMarkerHelper().removeAllMarkers(resource, getBuilderMarkerId());
	 ...
	 */
	public genericity.language.gbind.IGbindBuilder getBuilder() {
	...
	public String getBuilderMarkerId() {
		return new genericity.language.gbind.mopp.GbindMarkerHelper().getMarkerID(genericity.language.gbind.GbindEProblemType.BUILDER_ERROR);
	}
	...
	public void runTaskItemBuilder(org.eclipse.core.resources.IFile resource, org.eclipse.emf.ecore.resource.ResourceSet resourceSet, org.eclipse.core.runtime.IProgressMonitor monitor) {
		genericity.language.gbind.mopp.GbindTaskItemBuilder taskItemBuilder = new genericity.language.gbind.mopp.GbindTaskItemBuilder();
		new genericity.language.gbind.mopp.GbindMarkerHelper().removeAllMarkers(resource, taskItemBuilder.getBuilderMarkerId());
	...
	protected boolean doVisit(org.eclipse.core.resources.IResource resource, boolean removed) throws org.eclipse.core.runtime.CoreException {
		...
		if (resource instanceof org.eclipse.core.resources.IFile && resource.getName().endsWith("." + new genericity.language.gbind.mopp.GbindMetaInformation().getSyntaxName())) {
