 ...
 */
public class GbindDefaultTokenResolver implements genericity.language.gbind.IGbindTokenResolver {
	...
	public void resolve(String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, genericity.language.gbind.IGbindTokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
		// Step 1: unescape keywords if required
		if (escapeKeywords && lexem.startsWith("_")) {
			for (String keyword : genericity.language.gbind.grammar.GbindGrammarInformationProvider.INSTANCE.getKeywords()) {
