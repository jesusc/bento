 ...
 * resolver
 */
public interface IGbindReferenceResolver<ContainerType extends org.eclipse.emf.ecore.EObject, ReferenceType extends org.eclipse.emf.ecore.EObject> extends genericity.language.gbind.IGbindConfigurable {
	 ...
	 * operation.
	 */
	public void resolve(String identifier, ContainerType container, org.eclipse.emf.ecore.EReference reference, int position, boolean resolveFuzzy, genericity.language.gbind.IGbindReferenceResolveResult<ReferenceType> result);
