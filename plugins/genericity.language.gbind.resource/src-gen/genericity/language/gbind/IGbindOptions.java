...
public interface IGbindOptions {
	 ...
	 */
	public String INPUT_STREAM_PREPROCESSOR_PROVIDER = new genericity.language.gbind.mopp.GbindMetaInformation().getInputStreamPreprocessorProviderOptionKey();
	
	/**
	 * The key for the option to provide a resource post-processor.
	 */
	public String RESOURCE_POSTPROCESSOR_PROVIDER = new genericity.language.gbind.mopp.GbindMetaInformation().getResourcePostProcessorProviderOptionKey();
