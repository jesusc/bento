...
public class GbindStringUtil {
	 ...
	 */
	public static <T> String explode(java.util.Collection<T> parts, String glue, genericity.language.gbind.IGbindFunction1<String, T> toStringFunction) {
	 ...
	 * is used to convert the parts to strings.
	 */
	public static <T> String explode(T[] parts, String glue, genericity.language.gbind.IGbindFunction1<String, T> toStringFunction) {
