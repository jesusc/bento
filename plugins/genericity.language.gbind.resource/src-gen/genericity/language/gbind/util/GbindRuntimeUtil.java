...
public class GbindRuntimeUtil {
	...
	public void logError(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			genericity.language.gbind.mopp.GbindPlugin.logError(message, exception);
			return;
		}
	...
	public void logWarning(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			genericity.language.gbind.mopp.GbindPlugin.logWarning(message, exception);
			return;
		}
		System.err.println(message);
		if (exception != null) {
