 ...
 */
public class GbindEnumerationTerminal extends genericity.language.gbind.grammar.GbindTerminal {
	
	private java.util.Map<String, String> mapping = new java.util.LinkedHashMap<String, String>();
	
	public GbindEnumerationTerminal(org.eclipse.emf.ecore.EStructuralFeature attribute, String[] literalMappings, genericity.language.gbind.grammar.GbindCardinality cardinality, int mandatoryOccurrencesAfter) {
