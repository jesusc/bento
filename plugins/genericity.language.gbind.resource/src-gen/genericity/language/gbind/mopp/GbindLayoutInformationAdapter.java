...
public class GbindLayoutInformationAdapter implements org.eclipse.emf.common.notify.Adapter {
	 ...
	 * reference.
	 */
	private java.util.List<genericity.language.gbind.mopp.GbindLayoutInformation> layoutInformations = new java.util.ArrayList<genericity.language.gbind.mopp.GbindLayoutInformation>();
	...
	public java.util.List<genericity.language.gbind.mopp.GbindLayoutInformation> getLayoutInformations() {
		return layoutInformations;
	}
	
	public void addLayoutInformation(genericity.language.gbind.mopp.GbindLayoutInformation layoutInformation) {
