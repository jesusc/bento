...
public abstract class GbindANTLRParserBase extends org.antlr.runtime3_4_0.Parser implements genericity.language.gbind.IGbindTextParser {
	 ...
	 * result object.
	 */
	protected java.util.Collection<genericity.language.gbind.IGbindCommand<genericity.language.gbind.IGbindTextResource>> postParseCommands;
	 ...
	 */
	private genericity.language.gbind.mopp.GbindTokenResolveResult tokenResolveResult = new genericity.language.gbind.mopp.GbindTokenResolveResult();
	...
	public GbindANTLRParserBase(org.antlr.runtime3_4_0.TokenStream input) {
		super(input);
	}
	
	public GbindANTLRParserBase(org.antlr.runtime3_4_0.TokenStream input, org.antlr.runtime3_4_0.RecognizerSharedState state) {
		super(input, state);
	}
	
	protected void retrieveLayoutInformation(org.eclipse.emf.ecore.EObject element, genericity.language.gbind.grammar.GbindSyntaxElement syntaxElement, Object object, boolean ignoreTokensAfterLastVisibleToken) {
		...
		isElementToStore |= syntaxElement instanceof genericity.language.gbind.grammar.GbindPlaceholder;
		isElementToStore |= syntaxElement instanceof genericity.language.gbind.grammar.GbindKeyword;
		isElementToStore |= syntaxElement instanceof genericity.language.gbind.grammar.GbindEnumerationTerminal;
		isElementToStore |= syntaxElement instanceof genericity.language.gbind.grammar.GbindBooleanTerminal;
		if (!isElementToStore) {
			return;
		}
		genericity.language.gbind.mopp.GbindLayoutInformationAdapter layoutInformationAdapter = getLayoutInformationAdapter(element);
		...
		layoutInformationAdapter.addLayoutInformation(new genericity.language.gbind.mopp.GbindLayoutInformation(syntaxElement, object, offset, hiddenTokenText.toString(), visibleTokenText.toString()));
	...
	protected <ContainerType extends org.eclipse.emf.ecore.EObject, ReferenceType extends org.eclipse.emf.ecore.EObject> void registerContextDependentProxy(final genericity.language.gbind.mopp.GbindContextDependentURIFragmentFactory<ContainerType, ReferenceType> factory, final ContainerType container, final org.eclipse.emf.ecore.EReference reference, final String id, final org.eclipse.emf.ecore.EObject proxy) {
		final int position;
		if (reference.isMany()) {
	...
	protected String formatTokenName(int tokenType)  {
		...
		if (tokenType < 0) {
			...
			tokenName = genericity.language.gbind.util.GbindStringUtil.formatTokenName(tokenName);
		}
		return tokenName;
	}
	...
	public void setOptions(java.util.Map<?,?> options) {
		...
		if (this.options.containsKey(genericity.language.gbind.IGbindOptions.DISABLE_LOCATION_MAP)) {
			this.disableLocationMap = true;
		}
		if (this.options.containsKey(genericity.language.gbind.IGbindOptions.DISABLE_LAYOUT_INFORMATION_RECORDING)) {
	...
	protected void addMapEntry(org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, genericity.language.gbind.mopp.GbindDummyEObject dummy) {
		Object value = element.eGet(structuralFeature);
		Object mapKey = dummy.getValueByName("key");
		Object mapValue = dummy.getValueByName("value");
		if (value instanceof org.eclipse.emf.common.util.EMap<?, ?>) {
			org.eclipse.emf.common.util.EMap<Object, Object> valueMap = genericity.language.gbind.util.GbindMapUtil.castToEMap(value);
	...
	protected org.eclipse.emf.ecore.EObject apply(org.eclipse.emf.ecore.EObject target, java.util.List<org.eclipse.emf.ecore.EObject> dummyEObjects) {
		...
		for (org.eclipse.emf.ecore.EObject object : dummyEObjects) {
			assert(object instanceof genericity.language.gbind.mopp.GbindDummyEObject);
			genericity.language.gbind.mopp.GbindDummyEObject dummy = (genericity.language.gbind.mopp.GbindDummyEObject) object;
	...
	protected genericity.language.gbind.mopp.GbindTokenResolveResult getFreshTokenResolveResult() {
		tokenResolveResult.clear();
		return tokenResolveResult;
	}
	
	protected genericity.language.gbind.mopp.GbindReferenceResolverSwitch getReferenceResolverSwitch() {
		genericity.language.gbind.mopp.GbindReferenceResolverSwitch resolverSwitch = (genericity.language.gbind.mopp.GbindReferenceResolverSwitch) metaInformation.getReferenceResolverSwitch();
