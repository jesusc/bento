 ...
 * genericity.language.gbind.IGbindOptions.DISABLE_LOCATION_MAP option is set.
 */
public class GbindDevNullLocationMap implements genericity.language.gbind.IGbindLocationMap {
