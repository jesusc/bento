...
public abstract class GbindQuickFix implements genericity.language.gbind.IGbindQuickFix {
	...
	public String apply(String currentText) {
		...
		try {
			...
			new genericity.language.gbind.util.GbindRuntimeUtil().logError("Exception while applying quick fix", e);
		}
		return null;
	}
