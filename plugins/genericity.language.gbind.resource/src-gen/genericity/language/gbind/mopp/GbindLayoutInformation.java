...
/**
 * GbindLayoutInformation objects are used to store layout information that is
...
public class GbindLayoutInformation {
	 ...
	 */
	private final genericity.language.gbind.grammar.GbindSyntaxElement syntaxElement;
	...
	public GbindLayoutInformation(genericity.language.gbind.grammar.GbindSyntaxElement syntaxElement, Object object, int startOffset, String hiddenTokenText, String visibleTokenText) {
		super();
	...
	public genericity.language.gbind.grammar.GbindSyntaxElement getSyntaxElement() {
