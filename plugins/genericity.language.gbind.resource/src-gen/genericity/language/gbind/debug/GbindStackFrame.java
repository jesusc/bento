...
public class GbindStackFrame extends genericity.language.gbind.debug.GbindDebugElement implements org.eclipse.debug.core.model.IStackFrame {
	
	private genericity.language.gbind.debug.GbindDebugTarget target;
	private String name;
	private int id;
	...
	public GbindStackFrame(genericity.language.gbind.debug.GbindDebugTarget target, String data) {
		super(target);
		this.target = target;
		
		java.util.List<String> dataParts = genericity.language.gbind.util.GbindStringUtil.decode(data, ',');
	...
	private genericity.language.gbind.debug.GbindDebugTarget getTarget() {
		return target;
	}
	...
	public boolean equals(Object obj) {
		...
		genericity.language.gbind.debug.GbindStackFrame other = (genericity.language.gbind.debug.GbindStackFrame) obj;
		if (name == null) {
