...
public class GbindDebugValue extends genericity.language.gbind.debug.GbindDebugElement implements org.eclipse.debug.core.model.IValue {
	...
	public GbindDebugValue(genericity.language.gbind.debug.GbindDebugTarget target, String id, String valueString, String referenceTypeName, java.util.Map<String, Long> children) {
		super(target);
