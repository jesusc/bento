/**
 */
package bento.language.bentocomp.util;
 ...
 * @generated
 */
public class BentocompSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static BentocompPackage modelPackage;
	 ...
	 * @generated
	 */
	public BentocompSwitch() {
		if (modelPackage == null) {
			modelPackage = BentocompPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case BentocompPackage.DUMMY_CLASS: {
