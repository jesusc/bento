...
import bento.language.bentocomp.flowcontrol.Expression;
import bento.language.bentocomp.flowcontrol.FeatureRef;
import bento.language.bentocomp.flowcontrol.FlowcontrolFactory;
import bento.language.bentocomp.flowcontrol.FlowcontrolPackage;
import bento.language.bentocomp.flowcontrol.Par;
import bento.language.bentocomp.flowcontrol.Seq;
import bento.language.bentocomp.flowcontrol.Value;
import bento.language.bentocomp.flowcontrol.Xor;
import bento.language.bentocomp.flowcontrol.XorCond;
...
public class FlowcontrolPackageImpl extends EPackageImpl implements FlowcontrolPackage {
	 ...
	 * @see bento.language.bentocomp.flowcontrol.FlowcontrolPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EReference getApplyParameter_Binding() {
		return (EReference)applyParameterEClass.getEStructuralFeatures().get(3);
	}
	...
	public void createPackageContents() {
		...
		createEReference(applyParameterEClass, APPLY_PARAMETER__BINDING);
	...
	public void initializePackageContents() {
		...
		initEReference(getApplyParameter_Binding(), theCorePackage.getBindingDeclaration(), null, "binding", null, 0, 1, ApplyParameter.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
