	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case CorePackage.COMPONENT: {
				...
				if (result == null) result = caseTagged(component);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case CorePackage.COMPOSITE_COMPONENT: {
				...
				if (result == null) result = caseTagged(compositeComponent);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case CorePackage.DOCUMENTATION: {
