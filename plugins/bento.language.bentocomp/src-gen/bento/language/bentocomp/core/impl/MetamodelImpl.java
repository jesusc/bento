...
public class MetamodelImpl extends NamedElementImpl implements Metamodel {
	...
	public void setUri(String newUri) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.METAMODEL__URI, oldUri, uri));
	}
	...
	public void setResource(Resource newResource) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.METAMODEL__RESOURCE, oldResource, resource));
	}
	...
	public EList<Constraint> getConstraints() {
		if (constraints == null) {
			constraints = new EObjectContainmentEList<Constraint>(Constraint.class, this, CorePackage.METAMODEL__CONSTRAINTS);
		}
		return constraints;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CorePackage.METAMODEL__CONSTRAINTS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CorePackage.METAMODEL__URI:
				return getUri();
			case CorePackage.METAMODEL__RESOURCE:
				return getResource();
			case CorePackage.METAMODEL__CONSTRAINTS:
