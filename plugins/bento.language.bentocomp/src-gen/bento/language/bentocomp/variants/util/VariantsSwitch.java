/**
 */
package bento.language.bentocomp.variants.util;

import bento.language.bentocomp.core.NamedElement;

import bento.language.bentocomp.variants.*;
 ...
 * <!-- end-user-doc -->
 * @see bento.language.bentocomp.variants.VariantsPackage
 * @generated
 */
public class VariantsSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case VariantsPackage.PARAMETER: {
			...
			case VariantsPackage.FEATURE: {
				Feature feature = (Feature)theEObject;
				T result = caseFeature(feature);
				if (result == null) result = caseParameter(feature);
				if (result == null) result = caseNamedElement(feature);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case VariantsPackage.SINGLE_FEATURE: {
				SingleFeature singleFeature = (SingleFeature)theEObject;
				T result = caseSingleFeature(singleFeature);
				if (result == null) result = caseFeature(singleFeature);
				if (result == null) result = caseParameter(singleFeature);
				if (result == null) result = caseNamedElement(singleFeature);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case VariantsPackage.COMPOSITE_FEATURE: {
				CompositeFeature compositeFeature = (CompositeFeature)theEObject;
				T result = caseCompositeFeature(compositeFeature);
				if (result == null) result = caseFeature(compositeFeature);
				if (result == null) result = caseParameter(compositeFeature);
				if (result == null) result = caseNamedElement(compositeFeature);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case VariantsPackage.XOR_FEATURE: {
				XorFeature xorFeature = (XorFeature)theEObject;
				T result = caseXorFeature(xorFeature);
				if (result == null) result = caseCompositeFeature(xorFeature);
				if (result == null) result = caseFeature(xorFeature);
				if (result == null) result = caseParameter(xorFeature);
				if (result == null) result = caseNamedElement(xorFeature);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
