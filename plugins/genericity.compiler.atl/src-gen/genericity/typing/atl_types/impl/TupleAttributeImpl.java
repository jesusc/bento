 ...
 * <ul>
 *   <li>{@link genericity.typing.atl_types.impl.TupleAttributeImpl#getName <em>Name</em>}</li>
 *   <li>{@link genericity.typing.atl_types.impl.TupleAttributeImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class TupleAttributeImpl extends EObjectImpl implements TupleAttribute {
	/**
	...
	protected EClass eStaticClass() {
		return AtlTypingPackage.Literals.TUPLE_ATTRIBUTE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AtlTypingPackage.TUPLE_ATTRIBUTE__NAME, oldName, name));
	}
