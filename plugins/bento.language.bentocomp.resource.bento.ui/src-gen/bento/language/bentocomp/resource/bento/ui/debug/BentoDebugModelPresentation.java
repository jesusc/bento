...
public class BentoDebugModelPresentation implements org.eclipse.debug.ui.IDebugModelPresentation {
	
	public BentoDebugModelPresentation() {
		super();
	}
	...
	public String getEditorId(org.eclipse.ui.IEditorInput input, Object element) {
		if (element instanceof org.eclipse.core.resources.IFile || element instanceof org.eclipse.debug.core.model.ILineBreakpoint) {
			return bento.language.bentocomp.resource.bento.ui.BentoUIPlugin.EDITOR_ID;
		}
		return null;
	}
