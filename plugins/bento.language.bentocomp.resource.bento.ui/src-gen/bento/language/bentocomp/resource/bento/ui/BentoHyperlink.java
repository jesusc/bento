 ...
 */
public class BentoHyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	 ...
	 */
	public BentoHyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				bento.language.bentocomp.resource.bento.mopp.BentoPlugin.logError("Exception while opening hyperlink target.", e);
			}
		}
	}
