 ...
 */
public class BentoTextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2 {
	...
	private bento.language.bentocomp.resource.bento.IBentoHoverTextProvider hoverTextProvider;
	/**
	 * The style sheet (css).
	 */
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final bento.language.bentocomp.resource.bento.ui.BentoBrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(bento.language.bentocomp.resource.bento.ui.BentoBrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			bento.language.bentocomp.resource.bento.ui.BentoDocBrowserInformationControlInput infoInput = (bento.language.bentocomp.resource.bento.ui.BentoDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					bento.language.bentocomp.resource.bento.ui.BentoHyperlink hyperlink = new bento.language.bentocomp.resource.bento.ui.BentoHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (bento.language.bentocomp.resource.bento.ui.BentoBrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				bento.language.bentocomp.resource.bento.ui.BentoBrowserInformationControl iControl = new bento.language.bentocomp.resource.bento.ui.BentoBrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(Object newInput) {
						...
						} else if (newInput instanceof bento.language.bentocomp.resource.bento.ui.BentoDocBrowserInformationControlInput) {
							bento.language.bentocomp.resource.bento.ui.BentoDocBrowserInformationControlInput input = (bento.language.bentocomp.resource.bento.ui.BentoDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (bento.language.bentocomp.resource.bento.ui.BentoBrowserInformationControl.isAvailable(parent)) {
				bento.language.bentocomp.resource.bento.ui.BentoBrowserInformationControl iControl = new bento.language.bentocomp.resource.bento.ui.BentoBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	 ...
	 */
	public BentoTextHover(bento.language.bentocomp.resource.bento.IBentoResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
		this.hoverTextProvider = new bento.language.bentocomp.resource.bento.ui.BentoUIMetaInformation().getHoverTextProvider();
	}
	...
	public String getHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		...
		return ((bento.language.bentocomp.resource.bento.ui.BentoDocBrowserInformationControlInput) hoverInfo).getHtml();
	}
	...
	private bento.language.bentocomp.resource.bento.ui.BentoDocBrowserInformationControlInput internalGetHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		bento.language.bentocomp.resource.bento.IBentoTextResource textResource = resourceProvider.getResource();
	 ...
	 */
	private bento.language.bentocomp.resource.bento.ui.BentoDocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, bento.language.bentocomp.resource.bento.ui.BentoDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				bento.language.bentocomp.resource.bento.ui.BentoHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(containerObject, declarationObject));
			}
		} else {
			bento.language.bentocomp.resource.bento.ui.BentoHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			bento.language.bentocomp.resource.bento.ui.BentoHTMLPrinter.insertPageProlog(buffer, 0, bento.language.bentocomp.resource.bento.ui.BentoTextHover.getStyleSheet());
			bento.language.bentocomp.resource.bento.ui.BentoHTMLPrinter.addPageEpilog(buffer);
			return new bento.language.bentocomp.resource.bento.ui.BentoDocBrowserInformationControlInput(previousInput, declarationObject, resourceProvider.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		css = bento.language.bentocomp.resource.bento.ui.BentoHTMLPrinter.convertTopLevelFont(css, fontData);
	...
	private static String loadStyleSheet() {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(bento.language.bentocomp.resource.bento.ui.BentoUIPlugin.PLUGIN_ID);
		java.net.URL styleSheetURL = bundle.getEntry("/css/hover_style.css");
		if (styleSheetURL != null) {
			try {
				return bento.language.bentocomp.resource.bento.util.BentoStreamUtil.getContent(styleSheetURL.openStream());
