 ...
 */
public class BentoNewProjectWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard, org.eclipse.core.runtime.IExecutableExtension {
	 ...
	 */
	private String pageName = "New " + new bento.language.bentocomp.resource.bento.mopp.BentoMetaInformation().getSyntaxName() + " Project";
				...
				public void execute(org.eclipse.core.runtime.IProgressMonitor monitor) throws InterruptedException {
					try {
						...
						if (!project.exists()) {
							...
							org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle("bento.language.bentocomp.resource.bento.ui");
							...
							String natureID = bento.language.bentocomp.resource.bento.mopp.BentoNature.NATURE_ID;
							...
							for (String builderID : bento.language.bentocomp.resource.bento.mopp.BentoNature.BUILDER_IDS) {
							...
							if (defaultNewFile.exists()) {
								bento.language.bentocomp.resource.bento.mopp.BentoMetaInformation info = new bento.language.bentocomp.resource.bento.mopp.BentoMetaInformation();
	...
	public void init(org.eclipse.ui.IWorkbench workbench, org.eclipse.jface.viewers.IStructuredSelection selection) {
		...
		org.osgi.framework.Bundle bundle = bento.language.bentocomp.resource.bento.ui.BentoUIPlugin.getDefault().getBundle();
