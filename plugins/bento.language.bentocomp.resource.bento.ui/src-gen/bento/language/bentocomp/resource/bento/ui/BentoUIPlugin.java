 ...
 */
public class BentoUIPlugin extends org.eclipse.ui.plugin.AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "bento.language.bentocomp.resource.bento.ui";
	public static final String EDITOR_ID = "bento.language.bentocomp.resource.bento.ui.BentoEditor";
	...
	private static BentoUIPlugin plugin;
	
	public BentoUIPlugin() {
		super();
	}
	...
	public static BentoUIPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, BentoUIPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, BentoUIPlugin.PLUGIN_ID, message);
		}
		final BentoUIPlugin pluginInstance = BentoUIPlugin.getDefault();
