 ...
 * 
 */
package bento.language.bentocomp.resource.bento.ui.debug;

@SuppressWarnings("restriction")
public class BentoAdapterFactory implements org.eclipse.core.runtime.IAdapterFactory {
	...
	public Object getAdapter(Object adaptableObject, Class adapterType) {
		if (adaptableObject instanceof org.eclipse.ui.texteditor.ITextEditor) {
			...
			if (resource != null) {
				...
				if (extension != null && extension.equals(new bento.language.bentocomp.resource.bento.mopp.BentoMetaInformation().getSyntaxName())) {
					return new bento.language.bentocomp.resource.bento.ui.debug.BentoLineBreakpointAdapter();
				}
			}
		}
		if (adapterType == org.eclipse.debug.internal.ui.viewers.model.provisional.IElementLabelProvider.class && adaptableObject instanceof bento.language.bentocomp.resource.bento.debug.BentoDebugVariable) {
			final bento.language.bentocomp.resource.bento.debug.BentoDebugVariable variable = (bento.language.bentocomp.resource.bento.debug.BentoDebugVariable) adaptableObject;
		...
		if (adapterType == org.eclipse.debug.internal.ui.viewers.model.provisional.IElementContentProvider.class && adaptableObject instanceof bento.language.bentocomp.resource.bento.debug.BentoDebugVariable) {
			final bento.language.bentocomp.resource.bento.debug.BentoDebugVariable variable = (bento.language.bentocomp.resource.bento.debug.BentoDebugVariable) adaptableObject;
				...
				public void update(org.eclipse.debug.internal.ui.viewers.model.provisional.IChildrenCountUpdate[] updates) {
					try {
						for (org.eclipse.debug.internal.ui.viewers.model.provisional.IChildrenCountUpdate update : updates) {
							...
							bento.language.bentocomp.resource.bento.debug.BentoDebugValue castedValue = (bento.language.bentocomp.resource.bento.debug.BentoDebugValue) value;
