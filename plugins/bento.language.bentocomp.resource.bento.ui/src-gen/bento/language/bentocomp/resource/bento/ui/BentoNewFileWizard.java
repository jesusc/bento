...
public class BentoNewFileWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard {
	
	private String categoryId = null;
	private bento.language.bentocomp.resource.bento.ui.BentoNewFileWizardPage page;
	private org.eclipse.jface.viewers.ISelection selection;
	private String newName = null;
	
	public BentoNewFileWizard() {
		super();
	...
	public void addPages() {
		page = new bento.language.bentocomp.resource.bento.ui.BentoNewFileWizardPage(selection, getFileExtension());
		addPage(page);
	}
	...
	public boolean performFinish() {
		...
		try {
			...
			bento.language.bentocomp.resource.bento.ui.BentoUIPlugin.logError("Exception while initializing new file", e1);
			return false;
		}
		...
		try {
			...
			bento.language.bentocomp.resource.bento.ui.BentoUIPlugin.logError("Exception while initializing new file", e);
			return false;
		}
		return true;
	}
	...
	private java.io.InputStream openContentStream() {
		return new java.io.ByteArrayInputStream(new bento.language.bentocomp.resource.bento.mopp.BentoMetaInformation().getNewFileContentProvider().getNewFileContent(newName).getBytes());
	}
	...
	public String getFileExtension() {
		return new bento.language.bentocomp.resource.bento.mopp.BentoMetaInformation().getSyntaxName();
	}
