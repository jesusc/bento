 ...
 * olInput</code>.
 */
public class BentoDocBrowserInformationControlInput {
	
	private final BentoDocBrowserInformationControlInput fPrevious;
	private BentoDocBrowserInformationControlInput fNext;
	 ...
	 */
	public BentoDocBrowserInformationControlInput(BentoDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public BentoDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public BentoDocBrowserInformationControlInput getNext() {
		return fNext;
	}
