 ...
 * hovers, is a proxy.
 */
public class BentoHyperlinkDetector implements org.eclipse.jface.text.hyperlink.IHyperlinkDetector {
	 ...
	 */
	public BentoHyperlinkDetector(org.eclipse.emf.ecore.resource.Resource resource) {
		textResource = (bento.language.bentocomp.resource.bento.IBentoTextResource) resource;
	}
		...
		for (org.eclipse.emf.ecore.EObject eObject : elementsAtOffset) {
			if (eObject.eIsProxy()) {
				...
				if (resolvedEObject.eResource() != null) {
					org.eclipse.jface.text.hyperlink.IHyperlink hyperlink = new bento.language.bentocomp.resource.bento.ui.BentoHyperlink(new org.eclipse.jface.text.Region(offset, length), resolvedEObject, text);
