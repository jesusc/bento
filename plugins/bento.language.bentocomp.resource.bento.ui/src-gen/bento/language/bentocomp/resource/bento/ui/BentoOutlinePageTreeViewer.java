 ...
 * a specified depth.
 */
public class BentoOutlinePageTreeViewer extends org.eclipse.jface.viewers.TreeViewer {
	...
	public BentoOutlinePageTreeViewer(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		...
		setComparer(new org.eclipse.jface.viewers.IElementComparer() {
			...
			private String getURI(org.eclipse.emf.ecore.EObject eObject) {
				...
				String uriFragment = bento.language.bentocomp.resource.bento.util.BentoStringUtil.explode(uriFragmentPath, "/");
				return uriFragment;
			}
	...
	public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		...
		if (selection instanceof bento.language.bentocomp.resource.bento.ui.BentoEObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			bento.language.bentocomp.resource.bento.mopp.BentoPlugin.logError("Exception while refreshing outline view", e);
		}
	}
