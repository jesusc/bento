...
public class BentoLineBreakpointAdapter implements org.eclipse.debug.ui.actions.IToggleBreakpointsTarget {
	...
	public void toggleLineBreakpoints(org.eclipse.ui.IWorkbenchPart part, org.eclipse.jface.viewers.ISelection selection) throws org.eclipse.core.runtime.CoreException {
		...
		if (textEditor != null) {
			...
			org.eclipse.debug.core.model.IBreakpoint[] breakpoints = org.eclipse.debug.core.DebugPlugin.getDefault().getBreakpointManager().getBreakpoints(bento.language.bentocomp.resource.bento.mopp.BentoPlugin.DEBUG_MODEL_ID);
			...
			bento.language.bentocomp.resource.bento.debug.BentoLineBreakpoint lineBreakpoint = new bento.language.bentocomp.resource.bento.debug.BentoLineBreakpoint(resource, lineNumber + 1);
