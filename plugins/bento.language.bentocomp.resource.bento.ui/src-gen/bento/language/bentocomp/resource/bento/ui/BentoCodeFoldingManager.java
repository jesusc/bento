 ...
 */
public class BentoCodeFoldingManager {
	
	private class FoldingUpdateListener implements bento.language.bentocomp.resource.bento.IBentoBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(bento.language.bentocomp.resource.bento.ui.BentoEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof bento.language.bentocomp.resource.bento.ui.BentoEditor) {
				bento.language.bentocomp.resource.bento.ui.BentoEditor editor = (bento.language.bentocomp.resource.bento.ui.BentoEditor) workbenchPart;
	...
	protected bento.language.bentocomp.resource.bento.ui.BentoEditor editor;
	 ...
	 */
	public BentoCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,bento.language.bentocomp.resource.bento.ui.BentoEditor textEditor) {
	...
	private void addCloseListener(final bento.language.bentocomp.resource.bento.ui.BentoEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			bento.language.bentocomp.resource.bento.ui.BentoUIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
			return "";
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		bento.language.bentocomp.resource.bento.IBentoTextResource textResource = (bento.language.bentocomp.resource.bento.IBentoTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
