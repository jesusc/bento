 ...
 */
public class BentoSyntaxColoringPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	public BentoSyntaxColoringPreferencePage() {
		super();
		
		bento.language.bentocomp.resource.bento.mopp.BentoMetaInformation metaInformation = new bento.language.bentocomp.resource.bento.mopp.BentoMetaInformation();
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = bento.language.bentocomp.resource.bento.ui.BentoSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, bento.language.bentocomp.resource.bento.ui.BentoSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = bento.language.bentocomp.resource.bento.ui.BentoSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, bento.language.bentocomp.resource.bento.ui.BentoSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = bento.language.bentocomp.resource.bento.ui.BentoSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, bento.language.bentocomp.resource.bento.ui.BentoSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = bento.language.bentocomp.resource.bento.ui.BentoSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, bento.language.bentocomp.resource.bento.ui.BentoSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = bento.language.bentocomp.resource.bento.ui.BentoSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, bento.language.bentocomp.resource.bento.ui.BentoSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = bento.language.bentocomp.resource.bento.ui.BentoSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, bento.language.bentocomp.resource.bento.ui.BentoSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(org.eclipse.swt.widgets.Composite composite, int horizontalSpan) {
		bento.language.bentocomp.resource.bento.ui.BentoPixelConverter pixelConverter = new bento.language.bentocomp.resource.bento.ui.BentoPixelConverter(composite);
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof bento.language.bentocomp.resource.bento.ui.BentoEditor) {
			bento.language.bentocomp.resource.bento.ui.BentoEditor emfTextEditor = (bento.language.bentocomp.resource.bento.ui.BentoEditor) editor;
