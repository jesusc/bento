 ...
 * @since 3.2
 */
public class BentoBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private bento.language.bentocomp.resource.bento.ui.BentoDocBrowserInformationControlInput fInput;
	 ...
	 */
	public BentoBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, boolean resizable) {
	 ...
	 */
	public BentoBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, String statusFieldText) {
	 ...
	 * @since 3.4
	 */
	public BentoBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, org.eclipse.jface.action.ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof bento.language.bentocomp.resource.bento.ui.BentoDocBrowserInformationControlInput);
		...
		fInput= (bento.language.bentocomp.resource.bento.ui.BentoDocBrowserInformationControlInput) input;
		...
		bento.language.bentocomp.resource.bento.ui.BentoHTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = bento.language.bentocomp.resource.bento.ui.BentoHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	 ...
	 */
	public bento.language.bentocomp.resource.bento.ui.BentoDocBrowserInformationControlInput getInput() {
		return fInput;
	}
