 ...
 */
public class BentoIgnoredWordsFilter {
	...
	public boolean ignoreWord(String word) {
		...
		return bento.language.bentocomp.resource.bento.grammar.BentoGrammarInformationProvider.INSTANCE.getKeywords().contains(word);
	}
