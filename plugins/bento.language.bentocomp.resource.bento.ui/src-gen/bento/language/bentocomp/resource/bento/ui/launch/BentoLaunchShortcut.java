 ...
 */
public class BentoLaunchShortcut implements org.eclipse.debug.ui.ILaunchShortcut2 {
	...
	private void launch(org.eclipse.core.resources.IFile file, String mode) {
		try {
			...
			org.eclipse.debug.core.ILaunchConfigurationType type = lm.getLaunchConfigurationType(new bento.language.bentocomp.resource.bento.mopp.BentoMetaInformation().getLaunchConfigurationType());
			...
			workingCopy.setAttribute(bento.language.bentocomp.resource.bento.launch.BentoLaunchConfigurationDelegate.ATTR_RESOURCE_URI, uri.toString());
			...
			bento.language.bentocomp.resource.bento.mopp.BentoPlugin.logError("Exception while launching selection", e);
		}
	}
