...
public class BentoAnnotationModelFactory implements org.eclipse.core.filebuffers.IAnnotationModelFactory {
	...
	public org.eclipse.jface.text.source.IAnnotationModel createAnnotationModel(org.eclipse.core.runtime.IPath location) {
		...
		return new bento.language.bentocomp.resource.bento.ui.BentoAnnotationModel(resource);
	}
