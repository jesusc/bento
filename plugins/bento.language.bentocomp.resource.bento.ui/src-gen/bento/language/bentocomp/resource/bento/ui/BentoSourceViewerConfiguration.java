 ...
 */
public class BentoSourceViewerConfiguration extends org.eclipse.ui.editors.text.TextSourceViewerConfiguration {
	...
	private bento.language.bentocomp.resource.bento.ui.BentoQuickAssistAssistant quickAssistAssistant;
	 ...
	 */
	public BentoSourceViewerConfiguration(bento.language.bentocomp.resource.bento.IBentoResourceProvider resourceProvider, bento.language.bentocomp.resource.bento.ui.IBentoAnnotationModelProvider annotationModelProvider, bento.language.bentocomp.resource.bento.ui.IBentoBracketHandlerProvider bracketHandlerProvider, bento.language.bentocomp.resource.bento.ui.BentoColorManager colorManager) {
		super(bento.language.bentocomp.resource.bento.ui.BentoUIPlugin.getDefault().getPreferenceStore());
	...
	public org.eclipse.jface.text.contentassist.IContentAssistant getContentAssistant(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		...
		assistant.setContentAssistProcessor(new bento.language.bentocomp.resource.bento.ui.BentoCompletionProcessor(resourceProvider, bracketHandlerProvider), org.eclipse.jface.text.IDocument.DEFAULT_CONTENT_TYPE);
	...
	protected org.eclipse.jface.text.rules.ITokenScanner getScanner() {
		return new bento.language.bentocomp.resource.bento.ui.BentoTokenScanner(resourceProvider.getResource(), colorManager);
	}
	...
	public org.eclipse.jface.text.ITextHover getTextHover(org.eclipse.jface.text.source.ISourceViewer sourceViewer, String contentType) {
		return new bento.language.bentocomp.resource.bento.ui.BentoTextHover(resourceProvider);
	}
	...
	public org.eclipse.jface.text.hyperlink.IHyperlinkDetector[] getHyperlinkDetectors(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		...
		return new org.eclipse.jface.text.hyperlink.IHyperlinkDetector[] { new bento.language.bentocomp.resource.bento.ui.BentoHyperlinkDetector(resourceProvider.getResource()) };
	}
	...
	public org.eclipse.jface.text.quickassist.IQuickAssistAssistant getQuickAssistAssistant(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		if (quickAssistAssistant == null) {
			quickAssistAssistant = new bento.language.bentocomp.resource.bento.ui.BentoQuickAssistAssistant(resourceProvider, annotationModelProvider);
		}
			...
			protected org.eclipse.ui.texteditor.spelling.ISpellingProblemCollector createSpellingProblemCollector() {
				...
				return new org.eclipse.ui.texteditor.spelling.ISpellingProblemCollector() {
					...
					public void accept(org.eclipse.ui.texteditor.spelling.SpellingProblem problem) {
						...
						if (new bento.language.bentocomp.resource.bento.ui.BentoIgnoredWordsFilter().ignoreWord(text)) {
							return;
						}
