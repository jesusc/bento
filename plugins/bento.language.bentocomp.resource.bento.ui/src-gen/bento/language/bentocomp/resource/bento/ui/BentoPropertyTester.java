...
public class BentoPropertyTester extends org.eclipse.core.expressions.PropertyTester {
	...
	private boolean hasMatchingURI(org.eclipse.core.resources.IResource resource) {
		...
		return path.endsWith("." + new bento.language.bentocomp.resource.bento.mopp.BentoMetaInformation().getSyntaxName());
	}
