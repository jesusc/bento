 ...
 */
public class BentoBackgroundParsingStrategy {
	 ...
	 */
	public void parse(org.eclipse.jface.text.DocumentEvent event, final bento.language.bentocomp.resource.bento.IBentoTextResource resource, final bento.language.bentocomp.resource.bento.ui.BentoEditor editor) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(org.eclipse.jface.text.IDocument document, final bento.language.bentocomp.resource.bento.IBentoTextResource resource, final bento.language.bentocomp.resource.bento.ui.BentoEditor editor, long delay) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(final String contents, final bento.language.bentocomp.resource.bento.IBentoTextResource resource, final bento.language.bentocomp.resource.bento.ui.BentoEditor editor, long delay) {
		if (resource == null) {
			return;
		}
		if (contents == null) {
			...
			while (newContents != null ) {
				while (newContents != null) {
					try {
						...
						if (resource instanceof bento.language.bentocomp.resource.bento.mopp.BentoResource) {
							bento.language.bentocomp.resource.bento.mopp.BentoResource concreteResource = (bento.language.bentocomp.resource.bento.mopp.BentoResource) resource;
