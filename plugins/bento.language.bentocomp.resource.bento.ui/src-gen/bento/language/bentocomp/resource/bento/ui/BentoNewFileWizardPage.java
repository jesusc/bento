 ...
 */
public class BentoNewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	 ...
	 */
	public BentoNewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");
		setTitle("Create new bento file");
