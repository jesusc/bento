 ...
 */
public class BentoCompletionProposal implements java.lang.Comparable<BentoCompletionProposal> {
	 ...
	 */
	private bento.language.bentocomp.resource.bento.mopp.BentoExpectedTerminal expectedTerminal;
	...
	public BentoCompletionProposal(bento.language.bentocomp.resource.bento.mopp.BentoExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container) {
		super();
	...
	public BentoCompletionProposal(bento.language.bentocomp.resource.bento.mopp.BentoExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.swt.graphics.Image image) {
	...
	public bento.language.bentocomp.resource.bento.mopp.BentoExpectedTerminal getExpectedTerminal() {
		return expectedTerminal;
	}
	
	public boolean equals(Object object) {
		if (object instanceof BentoCompletionProposal) {
			BentoCompletionProposal other = (BentoCompletionProposal) object;
	...
	public int compareTo(BentoCompletionProposal object) {
		if (object instanceof BentoCompletionProposal) {
			BentoCompletionProposal other = (BentoCompletionProposal) object;
