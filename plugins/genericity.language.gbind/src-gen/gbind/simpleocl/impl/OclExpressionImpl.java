 ...
 *   <li>{@link gbind.simpleocl.impl.OclExpressionImpl#getAppliedProperty <em>Applied Property</em>}</li>
 *   <li>{@link gbind.simpleocl.impl.OclExpressionImpl#getCollection <em>Collection</em>}</li>
 *   <li>{@link gbind.simpleocl.impl.OclExpressionImpl#getLetExp <em>Let Exp</em>}</li>
 *   <li>{@link gbind.simpleocl.impl.OclExpressionImpl#getLoopExp <em>Loop Exp</em>}</li>
 *   <li>{@link gbind.simpleocl.impl.OclExpressionImpl#getParentOperation <em>Parent Operation</em>}</li>
 *   <li>{@link gbind.simpleocl.impl.OclExpressionImpl#getInitializedVariable <em>Initialized Variable</em>}</li>
 *   <li>{@link gbind.simpleocl.impl.OclExpressionImpl#getIfExp2 <em>If Exp2</em>}</li>
 *   <li>{@link gbind.simpleocl.impl.OclExpressionImpl#getOwningOperation <em>Owning Operation</em>}</li>
 *   <li>{@link gbind.simpleocl.impl.OclExpressionImpl#getIfExp1 <em>If Exp1</em>}</li>
