 ...
 * <ul>
 *   <li>{@link gbind.simpleocl.IntegerExp#getIntegerSymbol <em>Integer Symbol</em>}</li>
 * </ul>
 * </p>
 *
 * @see gbind.simpleocl.SimpleoclPackage#getIntegerExp()
 * @model
 * @generated
 */
public interface IntegerExp extends NumericExp {
	 ...
	 * @see gbind.simpleocl.SimpleoclPackage#getIntegerExp_IntegerSymbol()
	 * @model unique="false" dataType="gbind.simpleocl.Integer" required="true" ordered="false"
	 * @generated
	 */
	int getIntegerSymbol();

	/**
	 * Sets the value of the '{@link gbind.simpleocl.IntegerExp#getIntegerSymbol <em>Integer Symbol</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
