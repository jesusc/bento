...
public class GbindQuickAssistProcessor implements org.eclipse.jface.text.quickassist.IQuickAssistProcessor {
	...
	public GbindQuickAssistProcessor(genericity.language.gbind.IGbindResourceProvider resourceProvider, gbind.resource.gbind.ui.IGbindAnnotationModelProvider annotationModelProvider) {
		super();
	...
	private java.util.Collection<genericity.language.gbind.IGbindQuickFix> getQuickFixes(org.eclipse.jface.text.source.Annotation annotation) {
		...
		if (annotation instanceof gbind.resource.gbind.ui.GbindMarkerAnnotation) {
			gbind.resource.gbind.ui.GbindMarkerAnnotation markerAnnotation = (gbind.resource.gbind.ui.GbindMarkerAnnotation) annotation;
			org.eclipse.core.resources.IMarker marker = markerAnnotation.getMarker();
			foundQuickFixes.addAll(new gbind.resource.gbind.ui.GbindMarkerResolutionGenerator().getQuickFixes(resourceProvider.getResource(), marker));
		}
		return foundQuickFixes;
	}
