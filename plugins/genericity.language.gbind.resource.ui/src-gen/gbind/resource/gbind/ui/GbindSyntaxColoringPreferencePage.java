...
public class GbindSyntaxColoringPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = gbind.resource.gbind.ui.GbindSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, gbind.resource.gbind.ui.GbindSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = gbind.resource.gbind.ui.GbindSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, gbind.resource.gbind.ui.GbindSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = gbind.resource.gbind.ui.GbindSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, gbind.resource.gbind.ui.GbindSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = gbind.resource.gbind.ui.GbindSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, gbind.resource.gbind.ui.GbindSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = gbind.resource.gbind.ui.GbindSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, gbind.resource.gbind.ui.GbindSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = gbind.resource.gbind.ui.GbindSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, gbind.resource.gbind.ui.GbindSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(org.eclipse.swt.widgets.Composite composite, int horizontalSpan) {
		gbind.resource.gbind.ui.GbindPixelConverter pixelConverter = new gbind.resource.gbind.ui.GbindPixelConverter(composite);
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof gbind.resource.gbind.ui.GbindEditor) {
			gbind.resource.gbind.ui.GbindEditor emfTextEditor = (gbind.resource.gbind.ui.GbindEditor) editor;
