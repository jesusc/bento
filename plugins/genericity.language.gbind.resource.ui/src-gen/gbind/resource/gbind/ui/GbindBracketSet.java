...
public class GbindBracketSet {
	 ...
	 */
	private class ClosingListener implements gbind.resource.gbind.ui.IGbindBracketHandler, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.ModifyListener, org.eclipse.swt.custom.VerifyKeyListener {
	 ...
	 */
	public GbindBracketSet(gbind.resource.gbind.ui.GbindEditor editor, org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
	...
	public boolean resetBrackets() {
		String bracketPairs = preferenceStore.getString(languageID + gbind.resource.gbind.ui.GbindPreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	...
	public void matchingBrackets() {
		...
		if (position != -1 && position != document.getLength()) {
			positionHelper.addPosition(document, gbind.resource.gbind.ui.GbindPositionCategory.BRACKET.toString(), position, 1);
			positionHelper.addPosition(document, gbind.resource.gbind.ui.GbindPositionCategory.BRACKET.toString(), caretOffset - 1, 1);
		}
	}
