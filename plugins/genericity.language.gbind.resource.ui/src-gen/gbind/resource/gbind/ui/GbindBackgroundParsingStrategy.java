...
public class GbindBackgroundParsingStrategy {
	 ...
	 */
	public void parse(org.eclipse.jface.text.DocumentEvent event, final genericity.language.gbind.IGbindTextResource resource, final gbind.resource.gbind.ui.GbindEditor editor) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(org.eclipse.jface.text.IDocument document, final genericity.language.gbind.IGbindTextResource resource, final gbind.resource.gbind.ui.GbindEditor editor, long delay) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(final String contents, final genericity.language.gbind.IGbindTextResource resource, final gbind.resource.gbind.ui.GbindEditor editor, long delay) {
		if (resource == null) {
			return;
		}
		if (contents == null) {
