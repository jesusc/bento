...
public class GbindTextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2 {
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final gbind.resource.gbind.ui.GbindBrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(gbind.resource.gbind.ui.GbindBrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			gbind.resource.gbind.ui.GbindDocBrowserInformationControlInput infoInput = (gbind.resource.gbind.ui.GbindDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					gbind.resource.gbind.ui.GbindHyperlink hyperlink = new gbind.resource.gbind.ui.GbindHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (gbind.resource.gbind.ui.GbindBrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				gbind.resource.gbind.ui.GbindBrowserInformationControl iControl = new gbind.resource.gbind.ui.GbindBrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(Object newInput) {
						...
						} else if (newInput instanceof gbind.resource.gbind.ui.GbindDocBrowserInformationControlInput) {
							gbind.resource.gbind.ui.GbindDocBrowserInformationControlInput input = (gbind.resource.gbind.ui.GbindDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (gbind.resource.gbind.ui.GbindBrowserInformationControl.isAvailable(parent)) {
				gbind.resource.gbind.ui.GbindBrowserInformationControl iControl = new gbind.resource.gbind.ui.GbindBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	...
	public GbindTextHover(genericity.language.gbind.IGbindResourceProvider resourceProvider) {
		...
		this.hoverTextProvider = new gbind.resource.gbind.ui.GbindUIMetaInformation().getHoverTextProvider();
	}
	...
	public String getHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		...
		return ((gbind.resource.gbind.ui.GbindDocBrowserInformationControlInput) hoverInfo).getHtml();
	}
	...
	private gbind.resource.gbind.ui.GbindDocBrowserInformationControlInput internalGetHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
	 ...
	 */
	private gbind.resource.gbind.ui.GbindDocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, gbind.resource.gbind.ui.GbindDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				gbind.resource.gbind.ui.GbindHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(containerObject, declarationObject));
			}
		} else {
			gbind.resource.gbind.ui.GbindHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			gbind.resource.gbind.ui.GbindHTMLPrinter.insertPageProlog(buffer, 0, gbind.resource.gbind.ui.GbindTextHover.getStyleSheet());
			gbind.resource.gbind.ui.GbindHTMLPrinter.addPageEpilog(buffer);
			return new gbind.resource.gbind.ui.GbindDocBrowserInformationControlInput(previousInput, declarationObject, resourceProvider.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		css = gbind.resource.gbind.ui.GbindHTMLPrinter.convertTopLevelFont(css, fontData);
	...
	private static String loadStyleSheet() {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(gbind.resource.gbind.ui.GbindUIPlugin.PLUGIN_ID);
