...
public class GbindCodeCompletionHelper {
	 ...
	 * @return
	 */
	public gbind.resource.gbind.ui.GbindCompletionProposal[] computeCompletionProposals(genericity.language.gbind.IGbindTextResource originalResource, String content, int cursorOffset) {
		...
		if (expectedElements == null) {
			return new gbind.resource.gbind.ui.GbindCompletionProposal[0];
		}
		...
		java.util.Collection<gbind.resource.gbind.ui.GbindCompletionProposal> allProposals = new java.util.LinkedHashSet<gbind.resource.gbind.ui.GbindCompletionProposal>();
		java.util.Collection<gbind.resource.gbind.ui.GbindCompletionProposal> rightProposals = deriveProposals(expectedAfterCursor, content, resource, cursorOffset);
		java.util.Collection<gbind.resource.gbind.ui.GbindCompletionProposal> leftProposals = deriveProposals(expectedBeforeCursor, content, resource, cursorOffset - 1);
		...
		for (gbind.resource.gbind.ui.GbindCompletionProposal leftProposal : leftProposals) {
		...
		final java.util.List<gbind.resource.gbind.ui.GbindCompletionProposal> sortedProposals = new java.util.ArrayList<gbind.resource.gbind.ui.GbindCompletionProposal>(allProposals);
		java.util.Collections.sort(sortedProposals);
		org.eclipse.emf.ecore.EObject root = null;
		if (!resource.getContents().isEmpty()) {
			root = resource.getContents().get(0);
		}
		for (gbind.resource.gbind.ui.GbindCompletionProposal proposal : sortedProposals) {
			proposal.setRoot(root);
		}
		return sortedProposals.toArray(new gbind.resource.gbind.ui.GbindCompletionProposal[sortedProposals.size()]);
	}
	 ...
	 */
	protected void removeKeywordsEndingBeforeIndex(java.util.Collection<gbind.resource.gbind.ui.GbindCompletionProposal> proposals, int index) {
		java.util.List<gbind.resource.gbind.ui.GbindCompletionProposal> toRemove = new java.util.ArrayList<gbind.resource.gbind.ui.GbindCompletionProposal>();
		for (gbind.resource.gbind.ui.GbindCompletionProposal proposal : proposals) {
	...
	protected java.util.Collection<gbind.resource.gbind.ui.GbindCompletionProposal> deriveProposals(java.util.List<genericity.language.gbind.mopp.GbindExpectedTerminal> expectedElements, String content, genericity.language.gbind.IGbindTextResource resource, int cursorOffset) {
		java.util.Collection<gbind.resource.gbind.ui.GbindCompletionProposal> resultSet = new java.util.LinkedHashSet<gbind.resource.gbind.ui.GbindCompletionProposal>();
		for (genericity.language.gbind.mopp.GbindExpectedTerminal expectedElement : expectedElements) {
	...
	protected java.util.Collection<gbind.resource.gbind.ui.GbindCompletionProposal> deriveProposals(final genericity.language.gbind.mopp.GbindExpectedTerminal expectedTerminal, String content, genericity.language.gbind.IGbindTextResource resource, int cursorOffset) {
		...
		if (expectedElement instanceof genericity.language.gbind.mopp.GbindExpectedCsString) {
			...
			// completed.
			final java.util.Collection<gbind.resource.gbind.ui.GbindCompletionProposal> proposals = new java.util.ArrayList<gbind.resource.gbind.ui.GbindCompletionProposal>();
	...
	protected java.util.Collection<gbind.resource.gbind.ui.GbindCompletionProposal> handleEnumAttribute(genericity.language.gbind.mopp.GbindExpectedTerminal expectedTerminal, genericity.language.gbind.mopp.GbindExpectedStructuralFeature expectedFeature, org.eclipse.emf.ecore.EEnum enumType, String prefix, org.eclipse.emf.ecore.EObject container) {
		...
		for (org.eclipse.emf.ecore.EEnumLiteral literal : enumLiterals) {
			...
			result.add(new gbind.resource.gbind.ui.GbindCompletionProposal(expectedTerminal, resolvedLiteral, prefix, matchesPrefix, expectedFeature.getFeature(), container));
		}
		return result;
	}
	
	protected java.util.Collection<gbind.resource.gbind.ui.GbindCompletionProposal> handleNCReference(genericity.language.gbind.mopp.GbindExpectedTerminal expectedTerminal, org.eclipse.emf.ecore.EObject container, org.eclipse.emf.ecore.EReference reference, String prefix, String tokenName) {
		...
		if (mappings != null) {
			...
			for (genericity.language.gbind.IGbindReferenceMapping<org.eclipse.emf.ecore.EObject> mapping : mappings) {
				...
				if (mapping instanceof genericity.language.gbind.mopp.GbindElementMapping<?>) {
					...
					resultSet.add(new gbind.resource.gbind.ui.GbindCompletionProposal(expectedTerminal, identifier, prefix, matchesPrefix, reference, container, image));
				}
			}
			return resultSet;
		}
	...
	protected java.util.Collection<gbind.resource.gbind.ui.GbindCompletionProposal> handleAttribute(genericity.language.gbind.mopp.GbindExpectedTerminal expectedTerminal, genericity.language.gbind.mopp.GbindExpectedStructuralFeature expectedFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.emf.ecore.EAttribute attribute, String prefix) {
		java.util.Collection<gbind.resource.gbind.ui.GbindCompletionProposal> resultSet = new java.util.LinkedHashSet<gbind.resource.gbind.ui.GbindCompletionProposal>();
				...
				if (defaultValue != null) {
					...
					if (tokenName != null) {
						...
						if (tokenResolver != null) {
							...
							resultSet.add(new gbind.resource.gbind.ui.GbindCompletionProposal(expectedTerminal, defaultValueAsString, prefix, matchesPrefix, expectedFeature.getFeature(), container));
						}
					}
				}
			}
	 ...
	 */
	protected java.util.Collection<gbind.resource.gbind.ui.GbindCompletionProposal> handleKeyword(genericity.language.gbind.mopp.GbindExpectedTerminal expectedTerminal, genericity.language.gbind.mopp.GbindExpectedCsString csString, String prefix) {
		String proposal = csString.getValue();
		boolean matchesPrefix = matches(proposal, prefix);
		return java.util.Collections.singleton(new gbind.resource.gbind.ui.GbindCompletionProposal(expectedTerminal, proposal, prefix, matchesPrefix, null, null));
	}
	
	/**
	 * Creates a set of (two) completion proposals from the given boolean terminal.
	 */
	protected java.util.Collection<gbind.resource.gbind.ui.GbindCompletionProposal> handleBooleanTerminal(genericity.language.gbind.mopp.GbindExpectedTerminal expectedTerminal, genericity.language.gbind.mopp.GbindExpectedBooleanTerminal expectedBooleanTerminal, String prefix) {
		java.util.Collection<gbind.resource.gbind.ui.GbindCompletionProposal> result = new java.util.LinkedHashSet<gbind.resource.gbind.ui.GbindCompletionProposal>(2);
	 ...
	 */
	protected java.util.Collection<gbind.resource.gbind.ui.GbindCompletionProposal> handleEnumerationTerminal(genericity.language.gbind.mopp.GbindExpectedTerminal expectedTerminal, genericity.language.gbind.mopp.GbindExpectedEnumerationTerminal expectedEnumerationTerminal, String prefix) {
		java.util.Collection<gbind.resource.gbind.ui.GbindCompletionProposal> result = new java.util.LinkedHashSet<gbind.resource.gbind.ui.GbindCompletionProposal>(2);
	...
	protected java.util.Collection<gbind.resource.gbind.ui.GbindCompletionProposal> handleLiteral(genericity.language.gbind.mopp.GbindExpectedTerminal expectedTerminal, org.eclipse.emf.ecore.EAttribute attribute, String prefix, String literal) {
		if ("".equals(literal)) {
			return java.util.Collections.emptySet();
		}
		boolean matchesPrefix = matches(literal, prefix);
		return java.util.Collections.singleton(new gbind.resource.gbind.ui.GbindCompletionProposal(expectedTerminal, literal, prefix, matchesPrefix, null, null));
	}
