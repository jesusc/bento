		...
		for (org.eclipse.emf.ecore.EObject eObject : elementsAtOffset) {
			if (eObject.eIsProxy()) {
				...
				if (resolvedEObject.eResource() != null) {
					org.eclipse.jface.text.hyperlink.IHyperlink hyperlink = new gbind.resource.gbind.ui.GbindHyperlink(new org.eclipse.jface.text.Region(offset, length), resolvedEObject, text);
