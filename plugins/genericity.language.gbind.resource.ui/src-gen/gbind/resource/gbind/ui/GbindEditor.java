 ...
 * <p>
 * This editor has id <code>gbind.resource.gbind.ui.GbindEditor</code>
 ...
 * </p>
 */
public class GbindEditor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider, org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener, org.eclipse.emf.common.ui.viewer.IViewerProvider, genericity.language.gbind.IGbindResourceProvider, gbind.resource.gbind.ui.IGbindBracketHandlerProvider, gbind.resource.gbind.ui.IGbindAnnotationModelProvider {
	
	private gbind.resource.gbind.ui.GbindHighlighting highlighting;
	private org.eclipse.jface.text.source.projection.ProjectionSupport projectionSupport;
	private gbind.resource.gbind.ui.GbindCodeFoldingManager codeFoldingManager;
	private gbind.resource.gbind.ui.GbindBackgroundParsingStrategy bgParsingStrategy = new gbind.resource.gbind.ui.GbindBackgroundParsingStrategy();
	...
	private gbind.resource.gbind.ui.GbindColorManager colorManager = new gbind.resource.gbind.ui.GbindColorManager();
	private gbind.resource.gbind.ui.GbindOutlinePage outlinePage;
	...
	private gbind.resource.gbind.ui.GbindPropertySheetPage propertySheetPage;
	...
	private gbind.resource.gbind.ui.IGbindBracketHandler bracketHandler;
	...
	public GbindEditor() {
		super();
		setSourceViewerConfiguration(new gbind.resource.gbind.ui.GbindSourceViewerConfiguration(this, this, this, colorManager));
	...
	private class ModelResourceChangeListener implements org.eclipse.core.resources.IResourceChangeListener {
		public void resourceChanged(org.eclipse.core.resources.IResourceChangeEvent event) {
			...
			try {
				...
				gbind.resource.gbind.ui.GbindUIPlugin.logError("Unexpected Error: ", exception);
			}
		}
	}
	...
	public void createPartControl(org.eclipse.swt.widgets.Composite parent) {
		...
		highlighting = new gbind.resource.gbind.ui.GbindHighlighting(getResource(), viewer, colorManager, this);
		...
		codeFoldingManager = new gbind.resource.gbind.ui.GbindCodeFoldingManager(viewer, this);
	}
		...
		if (loadedResource == null) {
			try {
				...
				if (demandLoadedResource instanceof genericity.language.gbind.IGbindTextResource) {
					...
					gbind.resource.gbind.ui.GbindUIPlugin.showErrorDialog("No EMFText resource.", "The file '" + uri.lastSegment() + "' of type '" + uri.fileExtension() + "' can not be handled by the GbindEditor.");
					// close this editor because it can not present the resource
					close(false);
				}
			} catch (Exception e) {
				gbind.resource.gbind.ui.GbindUIPlugin.logError("Exception while loading resource in " + this.getClass().getSimpleName() + ".", e);
			}
		} else {
	...
	private Object getOutlinePage() {
		if (outlinePage == null) {
			outlinePage = new gbind.resource.gbind.ui.GbindOutlinePage(this);
	...
	public org.eclipse.ui.views.properties.IPropertySheetPage getPropertySheetPage() {
		if (propertySheetPage == null) {
			propertySheetPage = new gbind.resource.gbind.ui.GbindPropertySheetPage();
	...
	public void setCaret(org.eclipse.emf.ecore.EObject element, String text) {
		try {
			...
			gbind.resource.gbind.ui.GbindUIPlugin.logError("Exception in setCaret()", e);
		}
	}
	...
	public gbind.resource.gbind.ui.IGbindBracketHandler getBracketHandler() {
		return bracketHandler;
	}
	
	public void setBracketHandler(gbind.resource.gbind.ui.IGbindBracketHandler bracketHandler) {
