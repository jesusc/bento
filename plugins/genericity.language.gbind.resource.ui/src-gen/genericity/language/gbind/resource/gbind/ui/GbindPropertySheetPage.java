...
public class GbindPropertySheetPage extends org.eclipse.ui.views.properties.PropertySheetPage implements org.eclipse.jface.viewers.ISelectionChangedListener {
	...
	public void selectionChanged(org.eclipse.ui.IWorkbenchPart part, org.eclipse.jface.viewers.ISelection iSelection) {
		...
		if (iSelection instanceof genericity.language.gbind.resource.gbind.ui.GbindEObjectSelection) {
			final genericity.language.gbind.resource.gbind.ui.GbindEObjectSelection selection = (genericity.language.gbind.resource.gbind.ui.GbindEObjectSelection) iSelection;
