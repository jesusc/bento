...
public class GbindNewFileWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard {
	...
	private genericity.language.gbind.resource.gbind.ui.GbindNewFileWizardPage page;
	...
	public void addPages() {
		page = new genericity.language.gbind.resource.gbind.ui.GbindNewFileWizardPage(selection, getFileExtension());
		addPage(page);
	}
	...
	public boolean performFinish() {
		...
		try {
			...
			genericity.language.gbind.resource.gbind.ui.GbindUIPlugin.logError("Exception while initializing new file", e1);
			return false;
		}
		...
		try {
			...
			genericity.language.gbind.resource.gbind.ui.GbindUIPlugin.logError("Exception while initializing new file", e);
			return false;
		}
		return true;
	}
	...
	private java.io.InputStream openContentStream() {
		return new java.io.ByteArrayInputStream(new genericity.language.gbind.mopp.GbindMetaInformation().getNewFileContentProvider().getNewFileContent(newName).getBytes());
	}
	...
	public String getFileExtension() {
		return new genericity.language.gbind.mopp.GbindMetaInformation().getSyntaxName();
	}
