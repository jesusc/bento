 ...
 * olInput</code>.
 */
public class GbindDocBrowserInformationControlInput {
	
	private final GbindDocBrowserInformationControlInput fPrevious;
	private GbindDocBrowserInformationControlInput fNext;
	 ...
	 */
	public GbindDocBrowserInformationControlInput(GbindDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public GbindDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public GbindDocBrowserInformationControlInput getNext() {
		return fNext;
	}
