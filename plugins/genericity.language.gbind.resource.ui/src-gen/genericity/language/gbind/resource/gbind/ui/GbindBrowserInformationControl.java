...
public class GbindBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private genericity.language.gbind.resource.gbind.ui.GbindDocBrowserInformationControlInput fInput;
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof genericity.language.gbind.resource.gbind.ui.GbindDocBrowserInformationControlInput);
		...
		fInput= (genericity.language.gbind.resource.gbind.ui.GbindDocBrowserInformationControlInput) input;
		...
		genericity.language.gbind.resource.gbind.ui.GbindHTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = genericity.language.gbind.resource.gbind.ui.GbindHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	 ...
	 */
	public genericity.language.gbind.resource.gbind.ui.GbindDocBrowserInformationControlInput getInput() {
		return fInput;
	}
