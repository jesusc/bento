...
public class GbindSyntaxColoringPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	public GbindSyntaxColoringPreferencePage() {
		...
		genericity.language.gbind.mopp.GbindMetaInformation metaInformation = new genericity.language.gbind.mopp.GbindMetaInformation();
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = genericity.language.gbind.resource.gbind.ui.GbindSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, genericity.language.gbind.resource.gbind.ui.GbindSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = genericity.language.gbind.resource.gbind.ui.GbindSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, genericity.language.gbind.resource.gbind.ui.GbindSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = genericity.language.gbind.resource.gbind.ui.GbindSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, genericity.language.gbind.resource.gbind.ui.GbindSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = genericity.language.gbind.resource.gbind.ui.GbindSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, genericity.language.gbind.resource.gbind.ui.GbindSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = genericity.language.gbind.resource.gbind.ui.GbindSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, genericity.language.gbind.resource.gbind.ui.GbindSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = genericity.language.gbind.resource.gbind.ui.GbindSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, genericity.language.gbind.resource.gbind.ui.GbindSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(org.eclipse.swt.widgets.Composite composite, int horizontalSpan) {
		genericity.language.gbind.resource.gbind.ui.GbindPixelConverter pixelConverter = new genericity.language.gbind.resource.gbind.ui.GbindPixelConverter(composite);
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof genericity.language.gbind.resource.gbind.ui.GbindEditor) {
			genericity.language.gbind.resource.gbind.ui.GbindEditor emfTextEditor = (genericity.language.gbind.resource.gbind.ui.GbindEditor) editor;
