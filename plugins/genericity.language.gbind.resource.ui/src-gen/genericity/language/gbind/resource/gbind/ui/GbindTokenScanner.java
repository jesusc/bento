...
public class GbindTokenScanner implements org.eclipse.jface.text.rules.ITokenScanner {
	 ...
	 */
	public GbindTokenScanner(genericity.language.gbind.IGbindTextResource resource, genericity.language.gbind.resource.gbind.ui.GbindColorManager colorManager) {
		...
		genericity.language.gbind.resource.gbind.ui.GbindUIPlugin plugin = genericity.language.gbind.resource.gbind.ui.GbindUIPlugin.getDefault();
		if (plugin != null) {
	...
	public genericity.language.gbind.IGbindTokenStyle getStaticTokenStyle() {
		...
		String tokenName = currentToken.getName();
		String enableKey = genericity.language.gbind.resource.gbind.ui.GbindSyntaxColoringHelper.getPreferenceKey(languageId, tokenName, genericity.language.gbind.resource.gbind.ui.GbindSyntaxColoringHelper.StyleProperty.ENABLE);
		boolean enabled = store.getBoolean(enableKey);
		if (enabled) {
			String colorKey = genericity.language.gbind.resource.gbind.ui.GbindSyntaxColoringHelper.getPreferenceKey(languageId, tokenName, genericity.language.gbind.resource.gbind.ui.GbindSyntaxColoringHelper.StyleProperty.COLOR);
			org.eclipse.swt.graphics.RGB foregroundRGB = org.eclipse.jface.preference.PreferenceConverter.getColor(store, colorKey);
			org.eclipse.swt.graphics.RGB backgroundRGB = null;
			boolean bold = store.getBoolean(genericity.language.gbind.resource.gbind.ui.GbindSyntaxColoringHelper.getPreferenceKey(languageId, tokenName, genericity.language.gbind.resource.gbind.ui.GbindSyntaxColoringHelper.StyleProperty.BOLD));
			boolean italic = store.getBoolean(genericity.language.gbind.resource.gbind.ui.GbindSyntaxColoringHelper.getPreferenceKey(languageId, tokenName, genericity.language.gbind.resource.gbind.ui.GbindSyntaxColoringHelper.StyleProperty.ITALIC));
			boolean strikethrough = store.getBoolean(genericity.language.gbind.resource.gbind.ui.GbindSyntaxColoringHelper.getPreferenceKey(languageId, tokenName, genericity.language.gbind.resource.gbind.ui.GbindSyntaxColoringHelper.StyleProperty.STRIKETHROUGH));
			boolean underline = store.getBoolean(genericity.language.gbind.resource.gbind.ui.GbindSyntaxColoringHelper.getPreferenceKey(languageId, tokenName, genericity.language.gbind.resource.gbind.ui.GbindSyntaxColoringHelper.StyleProperty.UNDERLINE));
