 ...
 * 
 */
package genericity.language.gbind.resource.gbind.ui.debug;
	...
	public Object getAdapter(Object adaptableObject, Class adapterType) {
		if (adaptableObject instanceof org.eclipse.ui.texteditor.ITextEditor) {
			...
			if (resource != null) {
				...
				if (extension != null && extension.equals(new genericity.language.gbind.mopp.GbindMetaInformation().getSyntaxName())) {
					return new genericity.language.gbind.resource.gbind.ui.debug.GbindLineBreakpointAdapter();
				}
			}
		}
		if (adapterType == org.eclipse.debug.internal.ui.viewers.model.provisional.IElementLabelProvider.class && adaptableObject instanceof genericity.language.gbind.debug.GbindDebugVariable) {
			final genericity.language.gbind.debug.GbindDebugVariable variable = (genericity.language.gbind.debug.GbindDebugVariable) adaptableObject;
		...
		if (adapterType == org.eclipse.debug.internal.ui.viewers.model.provisional.IElementContentProvider.class && adaptableObject instanceof genericity.language.gbind.debug.GbindDebugVariable) {
			final genericity.language.gbind.debug.GbindDebugVariable variable = (genericity.language.gbind.debug.GbindDebugVariable) adaptableObject;
				...
				public void update(org.eclipse.debug.internal.ui.viewers.model.provisional.IChildrenCountUpdate[] updates) {
					try {
						for (org.eclipse.debug.internal.ui.viewers.model.provisional.IChildrenCountUpdate update : updates) {
							...
							genericity.language.gbind.debug.GbindDebugValue castedValue = (genericity.language.gbind.debug.GbindDebugValue) value;
