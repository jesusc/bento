 ...
 */
public class GbindNewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	 ...
	 */
	public GbindNewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");
		setTitle("Create new gbind file");
