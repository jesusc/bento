...
public class GbindLineBreakpointAdapter implements org.eclipse.debug.ui.actions.IToggleBreakpointsTarget {
	...
	public void toggleLineBreakpoints(org.eclipse.ui.IWorkbenchPart part, org.eclipse.jface.viewers.ISelection selection) throws org.eclipse.core.runtime.CoreException {
		...
		if (textEditor != null) {
			...
			org.eclipse.debug.core.model.IBreakpoint[] breakpoints = org.eclipse.debug.core.DebugPlugin.getDefault().getBreakpointManager().getBreakpoints(genericity.language.gbind.mopp.GbindPlugin.DEBUG_MODEL_ID);
			...
			genericity.language.gbind.debug.GbindLineBreakpoint lineBreakpoint = new genericity.language.gbind.debug.GbindLineBreakpoint(resource, lineNumber + 1);
