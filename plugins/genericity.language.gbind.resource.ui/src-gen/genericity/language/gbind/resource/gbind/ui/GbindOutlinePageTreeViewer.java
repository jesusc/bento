 ...
 * a specified depth.
 */
public class GbindOutlinePageTreeViewer extends org.eclipse.jface.viewers.TreeViewer {
	...
	public GbindOutlinePageTreeViewer(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		...
		setComparer(new org.eclipse.jface.viewers.IElementComparer() {
			...
			private String getURI(org.eclipse.emf.ecore.EObject eObject) {
				...
				String uriFragment = genericity.language.gbind.util.GbindStringUtil.explode(uriFragmentPath, "/");
				return uriFragment;
			}
	...
	public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		...
		if (selection instanceof genericity.language.gbind.resource.gbind.ui.GbindEObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			genericity.language.gbind.mopp.GbindPlugin.logError("Exception while refreshing outline view", e);
		}
	}
