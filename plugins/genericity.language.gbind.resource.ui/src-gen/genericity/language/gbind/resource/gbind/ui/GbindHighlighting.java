 ...
 */
public class GbindHighlighting implements org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener {
	
	private final static genericity.language.gbind.resource.gbind.ui.GbindPositionHelper positionHelper = new genericity.language.gbind.resource.gbind.ui.GbindPositionHelper();
	...
	private genericity.language.gbind.resource.gbind.ui.GbindTokenScanner scanner;
	private genericity.language.gbind.resource.gbind.ui.GbindColorManager colorManager;
	...
	private genericity.language.gbind.resource.gbind.ui.GbindEditor editor;
	private org.eclipse.jface.text.source.projection.ProjectionViewer projectionViewer;
	private genericity.language.gbind.resource.gbind.ui.GbindOccurrence occurrence;
	private genericity.language.gbind.resource.gbind.ui.GbindBracketSet bracketSet;
	 ...
	 */
	private final class UpdateHighlightingListener implements org.eclipse.swt.events.KeyListener, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.MouseListener, genericity.language.gbind.IGbindBackgroundParsingListener {
	 ...
	 * @param editor
	 */
	public GbindHighlighting(genericity.language.gbind.IGbindTextResource textResource, org.eclipse.jface.text.source.projection.ProjectionViewer sourceviewer, genericity.language.gbind.resource.gbind.ui.GbindColorManager colorManager, genericity.language.gbind.resource.gbind.ui.GbindEditor editor) {
		this.display = org.eclipse.swt.widgets.Display.getCurrent();
		sourceviewer.getSelectionProvider();
		preferenceStore = genericity.language.gbind.resource.gbind.ui.GbindUIPlugin.getDefault().getPreferenceStore();
		this.editor = editor;
		textWidget = sourceviewer.getTextWidget();
		projectionViewer = sourceviewer;
		scanner = new genericity.language.gbind.resource.gbind.ui.GbindTokenScanner(textResource, colorManager);
		occurrence = new genericity.language.gbind.resource.gbind.ui.GbindOccurrence(textResource, sourceviewer, scanner);
		bracketSet = new genericity.language.gbind.resource.gbind.ui.GbindBracketSet(editor, sourceviewer);
		this.colorManager = colorManager;
		isHighlightBrackets = preferenceStore.getBoolean(genericity.language.gbind.resource.gbind.ui.GbindPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		bracketColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, genericity.language.gbind.resource.gbind.ui.GbindPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));
		black = colorManager.getColor(new org.eclipse.swt.graphics.RGB(0, 0, 0));
		
		addListeners(editor);
	}
	
	private void addListeners(genericity.language.gbind.resource.gbind.ui.GbindEditor editor) {
	...
	private void setBracketHighlighting(org.eclipse.jface.text.IDocument document) {
		...
		org.eclipse.jface.text.Position[] positions = positionHelper.getPositions(document, genericity.language.gbind.resource.gbind.ui.GbindPositionCategory.BRACKET.toString());
	...
	private void removeHighlighting() {
		...
		removeHighlightingCategory(document, genericity.language.gbind.resource.gbind.ui.GbindPositionCategory.BRACKET.toString());
	}
	...
	private void removeHighlightingCategory(org.eclipse.jface.text.IDocument document, String category) {
		...
		if (category.equals(genericity.language.gbind.resource.gbind.ui.GbindPositionCategory.BRACKET.toString())) {
		...
		display.asyncExec(new Runnable() {
			public void run() {
				...
				if (selectedEObject != null) {
					setSelection(new genericity.language.gbind.resource.gbind.ui.GbindEObjectSelection(selectedEObject, false));
				}
			}
		});
	}
