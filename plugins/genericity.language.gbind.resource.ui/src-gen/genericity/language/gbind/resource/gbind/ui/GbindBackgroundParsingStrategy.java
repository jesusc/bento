 ...
 */
public class GbindBackgroundParsingStrategy {
	 ...
	 */
	public void parse(org.eclipse.jface.text.DocumentEvent event, final genericity.language.gbind.IGbindTextResource resource, final genericity.language.gbind.resource.gbind.ui.GbindEditor editor) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(org.eclipse.jface.text.IDocument document, final genericity.language.gbind.IGbindTextResource resource, final genericity.language.gbind.resource.gbind.ui.GbindEditor editor, long delay) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(final String contents, final genericity.language.gbind.IGbindTextResource resource, final genericity.language.gbind.resource.gbind.ui.GbindEditor editor, long delay) {
		if (resource == null) {
			return;
		}
		if (contents == null) {
			...
			while (newContents != null ) {
				while (newContents != null) {
					try {
						...
						if (resource instanceof genericity.language.gbind.mopp.GbindResource) {
							genericity.language.gbind.mopp.GbindResource concreteResource = (genericity.language.gbind.mopp.GbindResource) resource;
