...
public class GbindCodeFoldingManager {
	...
	private class FoldingUpdateListener implements genericity.language.gbind.IGbindBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(genericity.language.gbind.resource.gbind.ui.GbindEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof genericity.language.gbind.resource.gbind.ui.GbindEditor) {
				genericity.language.gbind.resource.gbind.ui.GbindEditor editor = (genericity.language.gbind.resource.gbind.ui.GbindEditor) workbenchPart;
	...
	protected genericity.language.gbind.resource.gbind.ui.GbindEditor editor;
	 ...
	 */
	public GbindCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,genericity.language.gbind.resource.gbind.ui.GbindEditor textEditor) {
	...
	private void addCloseListener(final genericity.language.gbind.resource.gbind.ui.GbindEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			genericity.language.gbind.resource.gbind.ui.GbindUIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
			return "";
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		genericity.language.gbind.IGbindTextResource textResource = (genericity.language.gbind.IGbindTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
