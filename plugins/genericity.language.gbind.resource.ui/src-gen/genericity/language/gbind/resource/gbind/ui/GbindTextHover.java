...
public class GbindTextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2 {
	...
	private genericity.language.gbind.IGbindHoverTextProvider hoverTextProvider;
	/**
	 * The style sheet (css).
	 */
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final genericity.language.gbind.resource.gbind.ui.GbindBrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(genericity.language.gbind.resource.gbind.ui.GbindBrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			genericity.language.gbind.resource.gbind.ui.GbindDocBrowserInformationControlInput infoInput = (genericity.language.gbind.resource.gbind.ui.GbindDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					genericity.language.gbind.resource.gbind.ui.GbindHyperlink hyperlink = new genericity.language.gbind.resource.gbind.ui.GbindHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (genericity.language.gbind.resource.gbind.ui.GbindBrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				genericity.language.gbind.resource.gbind.ui.GbindBrowserInformationControl iControl = new genericity.language.gbind.resource.gbind.ui.GbindBrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(Object newInput) {
						...
						} else if (newInput instanceof genericity.language.gbind.resource.gbind.ui.GbindDocBrowserInformationControlInput) {
							genericity.language.gbind.resource.gbind.ui.GbindDocBrowserInformationControlInput input = (genericity.language.gbind.resource.gbind.ui.GbindDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (genericity.language.gbind.resource.gbind.ui.GbindBrowserInformationControl.isAvailable(parent)) {
				genericity.language.gbind.resource.gbind.ui.GbindBrowserInformationControl iControl = new genericity.language.gbind.resource.gbind.ui.GbindBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	 ...
	 */
	public GbindTextHover(genericity.language.gbind.IGbindResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
		this.hoverTextProvider = new genericity.language.gbind.resource.gbind.ui.GbindUIMetaInformation().getHoverTextProvider();
	}
	...
	public String getHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		...
		return ((genericity.language.gbind.resource.gbind.ui.GbindDocBrowserInformationControlInput) hoverInfo).getHtml();
	}
	...
	private genericity.language.gbind.resource.gbind.ui.GbindDocBrowserInformationControlInput internalGetHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
	 ...
	 */
	private genericity.language.gbind.resource.gbind.ui.GbindDocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, genericity.language.gbind.resource.gbind.ui.GbindDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				genericity.language.gbind.resource.gbind.ui.GbindHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(containerObject, declarationObject));
			}
		} else {
			genericity.language.gbind.resource.gbind.ui.GbindHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			genericity.language.gbind.resource.gbind.ui.GbindHTMLPrinter.insertPageProlog(buffer, 0, genericity.language.gbind.resource.gbind.ui.GbindTextHover.getStyleSheet());
			genericity.language.gbind.resource.gbind.ui.GbindHTMLPrinter.addPageEpilog(buffer);
			return new genericity.language.gbind.resource.gbind.ui.GbindDocBrowserInformationControlInput(previousInput, declarationObject, resourceProvider.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		css = genericity.language.gbind.resource.gbind.ui.GbindHTMLPrinter.convertTopLevelFont(css, fontData);
	...
	private static String loadStyleSheet() {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(genericity.language.gbind.resource.gbind.ui.GbindUIPlugin.PLUGIN_ID);
		java.net.URL styleSheetURL = bundle.getEntry("/css/hover_style.css");
		if (styleSheetURL != null) {
			try {
				return genericity.language.gbind.util.GbindStreamUtil.getContent(styleSheetURL.openStream());
