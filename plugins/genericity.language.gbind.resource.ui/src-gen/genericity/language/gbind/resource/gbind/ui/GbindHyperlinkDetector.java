...
public class GbindHyperlinkDetector implements org.eclipse.jface.text.hyperlink.IHyperlinkDetector {
	...
	public GbindHyperlinkDetector(org.eclipse.emf.ecore.resource.Resource resource) {
		textResource = (genericity.language.gbind.IGbindTextResource) resource;
	}
		...
		for (org.eclipse.emf.ecore.EObject eObject : elementsAtOffset) {
			if (eObject.eIsProxy()) {
				...
				if (resolvedEObject.eResource() != null) {
					org.eclipse.jface.text.hyperlink.IHyperlink hyperlink = new genericity.language.gbind.resource.gbind.ui.GbindHyperlink(new org.eclipse.jface.text.Region(offset, length), resolvedEObject, text);
