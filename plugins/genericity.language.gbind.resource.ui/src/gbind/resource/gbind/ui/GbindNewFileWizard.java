...
public class GbindNewFileWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard {
	...
	private gbind.resource.gbind.ui.GbindNewFileWizardPage page;
	...
	public void addPages() {
		page = new gbind.resource.gbind.ui.GbindNewFileWizardPage(selection, getFileExtension());
		addPage(page);
	}
	...
	public boolean performFinish() {
		...
		try {
			...
			gbind.resource.gbind.ui.GbindUIPlugin.logError("Exception while initializing new file", e1);
			return false;
		}
		...
		try {
			...
			gbind.resource.gbind.ui.GbindUIPlugin.logError("Exception while initializing new file", e);
			return false;
		}
		return true;
	}
