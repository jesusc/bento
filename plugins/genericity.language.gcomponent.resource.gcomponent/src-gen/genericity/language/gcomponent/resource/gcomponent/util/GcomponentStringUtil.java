 ...
 */
public class GcomponentStringUtil {
	 ...
	 */
	public static <T> String explode(java.util.Collection<T> parts, String glue, genericity.language.gcomponent.resource.gcomponent.IGcomponentFunction1<String, T> toStringFunction) {
	 ...
	 * is used to convert the parts to strings.
	 */
	public static <T> String explode(T[] parts, String glue, genericity.language.gcomponent.resource.gcomponent.IGcomponentFunction1<String, T> toStringFunction) {
