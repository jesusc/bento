...
public class GcomponentBuilderAdapter extends org.eclipse.core.resources.IncrementalProjectBuilder implements org.eclipse.core.resources.IResourceDeltaVisitor, org.eclipse.core.resources.IResourceVisitor {
	
	/**
	 * The ID of the default, generated builder.
	 */
	public final static String BUILDER_ID = "genericity.language.gcomponent.resource.gcomponent.builder";
	
	private genericity.language.gcomponent.resource.gcomponent.IGcomponentBuilder defaultBuilder = new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentBuilder();
	...
	public void build(org.eclipse.core.resources.IFile resource, org.eclipse.emf.ecore.resource.ResourceSet resourceSet, org.eclipse.core.runtime.IProgressMonitor monitor) {
		...
		genericity.language.gcomponent.resource.gcomponent.IGcomponentBuilder builder = getBuilder();
		if (builder.isBuildingNeeded(uri)) {
			genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentResource customResource = (genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentResource) resourceSet.getResource(uri, true);
			new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentMarkerHelper().removeAllMarkers(resource, getBuilderMarkerId());
	 ...
	 */
	public genericity.language.gcomponent.resource.gcomponent.IGcomponentBuilder getBuilder() {
	...
	public String getBuilderMarkerId() {
		return new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentMarkerHelper().getMarkerID(genericity.language.gcomponent.resource.gcomponent.GcomponentEProblemType.BUILDER_ERROR);
	}
	...
	public void runTaskItemBuilder(org.eclipse.core.resources.IFile resource, org.eclipse.emf.ecore.resource.ResourceSet resourceSet, org.eclipse.core.runtime.IProgressMonitor monitor) {
		genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentTaskItemBuilder taskItemBuilder = new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentTaskItemBuilder();
		new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentMarkerHelper().removeAllMarkers(resource, taskItemBuilder.getBuilderMarkerId());
	...
	protected boolean doVisit(org.eclipse.core.resources.IResource resource, boolean removed) throws org.eclipse.core.runtime.CoreException {
		...
		if (resource instanceof org.eclipse.core.resources.IFile && resource.getName().endsWith("." + new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentMetaInformation().getSyntaxName())) {
