 ...
 */
public class GcomponentRuntimeUtil {
	...
	public void logError(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentPlugin.logError(message, exception);
			return;
		}
	...
	public void logWarning(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentPlugin.logWarning(message, exception);
			return;
		}
		System.err.println(message);
		if (exception != null) {
