 ...
 * instance of GcomponentDefaultTokenResolver which performs a standard conversion
 * based on the EMF type conversion. This includes conversion of registered
 * EDataTypes.
 * 
 * @see
 * genericity.language.gcomponent.resource.gcomponent.analysis.GcomponentDefaultTok
 * enResolver
 */
public interface IGcomponentTokenResolver extends genericity.language.gcomponent.resource.gcomponent.IGcomponentConfigurable {
