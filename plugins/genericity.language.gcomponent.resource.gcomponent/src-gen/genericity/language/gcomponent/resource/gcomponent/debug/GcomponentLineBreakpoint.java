...
public class GcomponentLineBreakpoint extends org.eclipse.debug.core.model.LineBreakpoint {
	
	private static final String LINE_BREAKPOINT_MARKER_ID = "genericity.language.gcomponent.resource.gcomponent.debug.lineBreakpoint.marker";
	
	public GcomponentLineBreakpoint() {
		super();
	}
	
	public GcomponentLineBreakpoint(final org.eclipse.core.resources.IResource resource, final int lineNumber) throws org.eclipse.debug.core.DebugException {
	...
	public void install(genericity.language.gcomponent.resource.gcomponent.debug.GcomponentDebugTarget target) {
		try {
	...
	public void remove(genericity.language.gcomponent.resource.gcomponent.debug.GcomponentDebugTarget target) {
		try {
			String location = (String) getMarker().getAttribute(org.eclipse.core.resources.IMarker.LOCATION);
