...
public class GcomponentAntlrScanner implements genericity.language.gcomponent.resource.gcomponent.IGcomponentTextScanner {
	...
	public GcomponentAntlrScanner(org.antlr.runtime3_4_0.Lexer antlrLexer) {
	...
	public genericity.language.gcomponent.resource.gcomponent.IGcomponentTextToken getNextToken() {
		...
		genericity.language.gcomponent.resource.gcomponent.IGcomponentTextToken result = new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentANTLRTextToken(current);
		return result;
	}
