...
public class GcomponentNature implements org.eclipse.core.resources.IProjectNature {
	
	public static final String NATURE_ID = "genericity.language.gcomponent.resource.gcomponent.nature";
	 ...
	 */
	public final static String[] BUILDER_IDS = {genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentBuilderAdapter.BUILDER_ID};
	...
	public void configure() throws org.eclipse.core.runtime.CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentBuilderAdapter.BUILDER_ID)) {
				return;
			}
		}
