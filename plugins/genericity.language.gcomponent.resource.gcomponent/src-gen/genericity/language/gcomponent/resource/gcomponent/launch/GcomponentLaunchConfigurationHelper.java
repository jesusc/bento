 ...
 * delegates.
 */
public class GcomponentLaunchConfigurationHelper {
	
	public static class SystemOutInterpreter extends genericity.language.gcomponent.resource.gcomponent.util.AbstractGcomponentInterpreter<Void,Void> {
	...
	public <ResultType, ContextType> void launchInterpreter(org.eclipse.debug.core.ILaunchConfiguration configuration, String mode, org.eclipse.debug.core.ILaunch launch, org.eclipse.core.runtime.IProgressMonitor monitor, genericity.language.gcomponent.resource.gcomponent.util.AbstractGcomponentInterpreter<ResultType, ContextType> delegate, final ContextType context) throws org.eclipse.core.runtime.CoreException {
		...
		final genericity.language.gcomponent.resource.gcomponent.debug.GcomponentDebuggableInterpreter<ResultType, ContextType> interpreter = new genericity.language.gcomponent.resource.gcomponent.debug.GcomponentDebuggableInterpreter<ResultType, ContextType>(delegate, eventPort);
		...
		// running process
		genericity.language.gcomponent.resource.gcomponent.debug.GcomponentDebuggerListener<ResultType, ContextType> debugListener = new genericity.language.gcomponent.resource.gcomponent.debug.GcomponentDebuggerListener<ResultType, ContextType>(requestPort);
		debugListener.setDebuggable(interpreter);
		new Thread(debugListener).start();
		
		// step 4: start debugger
		genericity.language.gcomponent.resource.gcomponent.debug.GcomponentDebugProcess process = new genericity.language.gcomponent.resource.gcomponent.debug.GcomponentDebugProcess(launch);
		launch.addDebugTarget(new genericity.language.gcomponent.resource.gcomponent.debug.GcomponentDebugTarget(process, launch, requestPort, eventPort));
	}
	...
	public org.eclipse.emf.common.util.URI getURI(org.eclipse.debug.core.ILaunchConfiguration configuration) throws org.eclipse.core.runtime.CoreException {
		return org.eclipse.emf.common.util.URI.createURI(configuration.getAttribute(genericity.language.gcomponent.resource.gcomponent.launch.GcomponentLaunchConfigurationDelegate.ATTR_RESOURCE_URI, (String) null));
	}
	...
	public org.eclipse.emf.ecore.EObject getModelRoot(org.eclipse.debug.core.ILaunchConfiguration configuration) throws org.eclipse.core.runtime.CoreException {
		return genericity.language.gcomponent.resource.gcomponent.util.GcomponentResourceUtil.getResourceContent(getURI(configuration));
	}
	...
	protected void abort(String message, Throwable e) throws org.eclipse.core.runtime.CoreException {
		throw new org.eclipse.core.runtime.CoreException(new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentPlugin.DEBUG_MODEL_ID, 0, message, e));
	}
}
