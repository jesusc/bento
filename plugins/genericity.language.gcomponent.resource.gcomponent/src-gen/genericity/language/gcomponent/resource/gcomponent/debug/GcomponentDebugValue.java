...
public class GcomponentDebugValue extends genericity.language.gcomponent.resource.gcomponent.debug.GcomponentDebugElement implements org.eclipse.debug.core.model.IValue {
	...
	public GcomponentDebugValue(genericity.language.gcomponent.resource.gcomponent.debug.GcomponentDebugTarget target, String id, String valueString, String referenceTypeName, java.util.Map<String, Long> children) {
		super(target);
