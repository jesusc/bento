...
public class BentoStackFrame extends bento.language.bentocomp.resource.bento.debug.BentoDebugElement implements org.eclipse.debug.core.model.IStackFrame {
	
	private bento.language.bentocomp.resource.bento.debug.BentoDebugTarget target;
	private String name;
	private int id;
	...
	public BentoStackFrame(bento.language.bentocomp.resource.bento.debug.BentoDebugTarget target, String data) {
		super(target);
		this.target = target;
		
		java.util.List<String> dataParts = bento.language.bentocomp.resource.bento.util.BentoStringUtil.decode(data, ',');
	...
	private bento.language.bentocomp.resource.bento.debug.BentoDebugTarget getTarget() {
		return target;
	}
	...
	public boolean equals(Object obj) {
		...
		bento.language.bentocomp.resource.bento.debug.BentoStackFrame other = (bento.language.bentocomp.resource.bento.debug.BentoStackFrame) obj;
		if (name == null) {
