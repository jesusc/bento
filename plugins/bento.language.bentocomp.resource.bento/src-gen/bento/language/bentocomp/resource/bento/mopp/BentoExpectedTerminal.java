 ...
 */
public class BentoExpectedTerminal {
	...
	private bento.language.bentocomp.resource.bento.IBentoExpectedElement terminal;
	private int startIncludingHiddenTokens;
	private int startExcludingHiddenTokens;
	private String prefix;
	private bento.language.bentocomp.resource.bento.grammar.BentoContainmentTrace containmentTrace;
	
	public BentoExpectedTerminal(org.eclipse.emf.ecore.EObject container, bento.language.bentocomp.resource.bento.IBentoExpectedElement terminal, int followSetID, bento.language.bentocomp.resource.bento.grammar.BentoContainmentTrace containmentTrace) {
		super();
	...
	public bento.language.bentocomp.resource.bento.IBentoExpectedElement getTerminal() {
		return terminal;
	}
	...
	public boolean equals(Object o) {
		...
		BentoExpectedTerminal otherExpectedTerminal = (BentoExpectedTerminal) o;
	...
	public bento.language.bentocomp.resource.bento.grammar.BentoContainmentTrace getContainmentTrace() {
