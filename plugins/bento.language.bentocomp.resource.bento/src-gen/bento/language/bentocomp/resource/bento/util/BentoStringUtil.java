...
public class BentoStringUtil {
	 ...
	 */
	public static <T> String explode(java.util.Collection<T> parts, String glue, bento.language.bentocomp.resource.bento.IBentoFunction1<String, T> toStringFunction) {
	 ...
	 * is used to convert the parts to strings.
	 */
	public static <T> String explode(T[] parts, String glue, bento.language.bentocomp.resource.bento.IBentoFunction1<String, T> toStringFunction) {
