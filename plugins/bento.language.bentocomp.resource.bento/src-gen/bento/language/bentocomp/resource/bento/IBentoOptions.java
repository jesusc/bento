 ...
 */
public interface IBentoOptions {
	
	/**
	 * The key for the option to provide a stream pre-processor.
	 */
	public String INPUT_STREAM_PREPROCESSOR_PROVIDER = new bento.language.bentocomp.resource.bento.mopp.BentoMetaInformation().getInputStreamPreprocessorProviderOptionKey();
	
	/**
	 * The key for the option to provide a resource post-processor.
	 */
	public String RESOURCE_POSTPROCESSOR_PROVIDER = new bento.language.bentocomp.resource.bento.mopp.BentoMetaInformation().getResourcePostProcessorProviderOptionKey();
