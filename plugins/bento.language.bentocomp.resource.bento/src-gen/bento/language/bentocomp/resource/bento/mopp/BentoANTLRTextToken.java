...
public class BentoANTLRTextToken extends bento.language.bentocomp.resource.bento.mopp.BentoTextToken {
	
	private final static bento.language.bentocomp.resource.bento.IBentoMetaInformation metaInformation = new bento.language.bentocomp.resource.bento.mopp.BentoMetaInformation();
	
	public BentoANTLRTextToken(org.antlr.runtime3_4_0.Token antlrToken) {
