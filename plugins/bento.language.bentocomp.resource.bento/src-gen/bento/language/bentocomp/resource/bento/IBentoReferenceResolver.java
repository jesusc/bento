 ...
 * resolver
 */
public interface IBentoReferenceResolver<ContainerType extends org.eclipse.emf.ecore.EObject, ReferenceType extends org.eclipse.emf.ecore.EObject> extends bento.language.bentocomp.resource.bento.IBentoConfigurable {
	 ...
	 * operation.
	 */
	public void resolve(String identifier, ContainerType container, org.eclipse.emf.ecore.EReference reference, int position, boolean resolveFuzzy, bento.language.bentocomp.resource.bento.IBentoReferenceResolveResult<ReferenceType> result);
