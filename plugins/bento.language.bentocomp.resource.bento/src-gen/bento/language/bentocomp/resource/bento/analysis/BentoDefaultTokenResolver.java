 ...
 */
public class BentoDefaultTokenResolver implements bento.language.bentocomp.resource.bento.IBentoTokenResolver {
	 ...
	 */
	public BentoDefaultTokenResolver() {
		this(false);
	}
	 ...
	 */
	public BentoDefaultTokenResolver(boolean escapeKeywords) {
		super();
	...
	public void resolve(String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, bento.language.bentocomp.resource.bento.IBentoTokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
		// Step 1: unescape keywords if required
		if (escapeKeywords && lexem.startsWith("_")) {
			for (String keyword : bento.language.bentocomp.resource.bento.grammar.BentoGrammarInformationProvider.INSTANCE.getKeywords()) {
