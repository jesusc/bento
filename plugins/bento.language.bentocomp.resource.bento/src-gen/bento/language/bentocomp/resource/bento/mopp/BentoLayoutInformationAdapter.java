...
/**
 * A BentoLayoutInformationAdapter is used to store layout information that is
 ...
 * BentoLayoutInformationAdapters are attached to EObjects and aggregate multiple
 ...
 */
public class BentoLayoutInformationAdapter implements org.eclipse.emf.common.notify.Adapter {
	 ...
	 * reference.
	 */
	private java.util.List<bento.language.bentocomp.resource.bento.mopp.BentoLayoutInformation> layoutInformations = new java.util.ArrayList<bento.language.bentocomp.resource.bento.mopp.BentoLayoutInformation>();
	...
	public java.util.List<bento.language.bentocomp.resource.bento.mopp.BentoLayoutInformation> getLayoutInformations() {
		return layoutInformations;
	}
	
	public void addLayoutInformation(bento.language.bentocomp.resource.bento.mopp.BentoLayoutInformation layoutInformation) {
