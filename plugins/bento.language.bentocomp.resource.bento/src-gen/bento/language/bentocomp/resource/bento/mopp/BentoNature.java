...
public class BentoNature implements org.eclipse.core.resources.IProjectNature {
	
	public static final String NATURE_ID = "bento.language.bentocomp.resource.bento.nature";
	 ...
	 */
	public final static String[] BUILDER_IDS = {bento.language.bentocomp.resource.bento.mopp.BentoBuilderAdapter.BUILDER_ID};
	...
	public void configure() throws org.eclipse.core.runtime.CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(bento.language.bentocomp.resource.bento.mopp.BentoBuilderAdapter.BUILDER_ID)) {
				return;
			}
		}
