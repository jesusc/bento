...
public class BentoDebugValue extends bento.language.bentocomp.resource.bento.debug.BentoDebugElement implements org.eclipse.debug.core.model.IValue {
	...
	public BentoDebugValue(bento.language.bentocomp.resource.bento.debug.BentoDebugTarget target, String id, String valueString, String referenceTypeName, java.util.Map<String, Long> children) {
		super(target);
