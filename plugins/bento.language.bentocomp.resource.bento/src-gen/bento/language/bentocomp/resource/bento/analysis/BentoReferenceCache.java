 ...
 * given name.
 */
public class BentoReferenceCache extends org.eclipse.emf.common.notify.impl.AdapterImpl implements bento.language.bentocomp.resource.bento.IBentoReferenceCache {
	...
	private bento.language.bentocomp.resource.bento.IBentoNameProvider nameProvider;
	
	public BentoReferenceCache(bento.language.bentocomp.resource.bento.IBentoNameProvider nameProvider) {
		super();
