...
/**
 * BentoLayoutInformation objects are used to store layout information that is
 ...
 * BentoLayoutInformations are aggregated in LayoutInformationAdapters. One
 * BentoLayoutInformation contains the layout that was found before a keyword,
 * attribute or reference.
 */
public class BentoLayoutInformation {
	 ...
	 */
	private final bento.language.bentocomp.resource.bento.grammar.BentoSyntaxElement syntaxElement;
	...
	public BentoLayoutInformation(bento.language.bentocomp.resource.bento.grammar.BentoSyntaxElement syntaxElement, Object object, int startOffset, String hiddenTokenText, String visibleTokenText) {
		super();
	...
	public bento.language.bentocomp.resource.bento.grammar.BentoSyntaxElement getSyntaxElement() {
