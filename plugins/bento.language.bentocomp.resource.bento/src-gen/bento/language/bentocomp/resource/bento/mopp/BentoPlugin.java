 ...
 */
public class BentoPlugin extends org.eclipse.core.runtime.Plugin {
	
	public static final String PLUGIN_ID = "bento.language.bentocomp.resource.bento";
	/**
	...
	private static BentoPlugin plugin;
	...
	public static BentoPlugin getDefault() {
		return plugin;
	}
	...
	protected static org.eclipse.core.runtime.IStatus log(int type, String message, Throwable throwable) {
		...
		if (throwable != null) {
			status = new org.eclipse.core.runtime.Status(type, BentoPlugin.PLUGIN_ID, 0, message, throwable);
		} else {
			status = new org.eclipse.core.runtime.Status(type, BentoPlugin.PLUGIN_ID, message);
		}
		final BentoPlugin pluginInstance = BentoPlugin.getDefault();
