...
public class BentoRuntimeUtil {
	...
	public void logError(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			bento.language.bentocomp.resource.bento.mopp.BentoPlugin.logError(message, exception);
			return;
		}
	...
	public void logWarning(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			bento.language.bentocomp.resource.bento.mopp.BentoPlugin.logWarning(message, exception);
			return;
		}
		System.err.println(message);
		if (exception != null) {
