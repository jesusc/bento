 ...
 */
public class BentoLaunchConfigurationDelegate extends org.eclipse.debug.core.model.LaunchConfigurationDelegate {
	...
	public void launch(org.eclipse.debug.core.ILaunchConfiguration configuration, String mode, org.eclipse.debug.core.ILaunch launch, org.eclipse.core.runtime.IProgressMonitor monitor) throws org.eclipse.core.runtime.CoreException {
		...
		new bento.language.bentocomp.resource.bento.launch.BentoLaunchConfigurationHelper().launch(configuration, mode, launch, monitor);
	}
