 ...
 * to 4 bytes).
 */
public class BentoUnicodeConverter extends bento.language.bentocomp.resource.bento.mopp.BentoInputStreamProcessor {
	 ...
	 */
	public BentoUnicodeConverter(java.io.InputStream inputStream) {
