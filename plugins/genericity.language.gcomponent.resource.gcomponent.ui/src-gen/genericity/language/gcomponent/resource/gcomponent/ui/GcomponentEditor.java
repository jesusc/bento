...
public class GcomponentEditor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider, org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener, org.eclipse.emf.common.ui.viewer.IViewerProvider, genericity.language.gcomponent.resource.gcomponent.IGcomponentResourceProvider, genericity.language.gcomponent.resource.gcomponent.ui.IGcomponentBracketHandlerProvider, genericity.language.gcomponent.resource.gcomponent.ui.IGcomponentAnnotationModelProvider {
	...
	private genericity.language.gcomponent.resource.gcomponent.ui.GcomponentHighlighting highlighting;
	private org.eclipse.jface.text.source.projection.ProjectionSupport projectionSupport;
	private genericity.language.gcomponent.resource.gcomponent.ui.GcomponentCodeFoldingManager codeFoldingManager;
	private genericity.language.gcomponent.resource.gcomponent.ui.GcomponentBackgroundParsingStrategy bgParsingStrategy = new genericity.language.gcomponent.resource.gcomponent.ui.GcomponentBackgroundParsingStrategy();
	private java.util.Collection<genericity.language.gcomponent.resource.gcomponent.IGcomponentBackgroundParsingListener> bgParsingListeners = new java.util.ArrayList<genericity.language.gcomponent.resource.gcomponent.IGcomponentBackgroundParsingListener>();
	private genericity.language.gcomponent.resource.gcomponent.ui.GcomponentColorManager colorManager = new genericity.language.gcomponent.resource.gcomponent.ui.GcomponentColorManager();
	private genericity.language.gcomponent.resource.gcomponent.ui.GcomponentOutlinePage outlinePage;
	...
	private genericity.language.gcomponent.resource.gcomponent.ui.GcomponentPropertySheetPage propertySheetPage;
	...
	private genericity.language.gcomponent.resource.gcomponent.ui.IGcomponentBracketHandler bracketHandler;
	...
	private final class DocumentListener implements org.eclipse.jface.text.IDocumentListener {
		...
		public void documentChanged(org.eclipse.jface.text.DocumentEvent event) {
			bgParsingStrategy.parse(event, getResource(), GcomponentEditor.this);
		}
	}
	...
	private class ModelResourceChangeListener implements org.eclipse.core.resources.IResourceChangeListener {
		public void resourceChanged(org.eclipse.core.resources.IResourceChangeEvent event) {
			...
			try {
					...
					public boolean visit(org.eclipse.core.resources.IResourceDelta delta) {
						...
						if (deltaKind == org.eclipse.core.resources.IResourceDelta.CHANGED && delta.getFlags() != org.eclipse.core.resources.IResourceDelta.MARKERS) {
							...
							if (changedResource != null) {
								...
								genericity.language.gcomponent.resource.gcomponent.IGcomponentTextResource currentResource = getResource();
				...
				genericity.language.gcomponent.resource.gcomponent.ui.GcomponentUIPlugin.logError("Unexpected Error: ", exception);
			}
		}
	}
	...
	public void initializeEditor() {
		...
		setEditorContextMenuId("genericity.language.gcomponent.resource.gcomponent.EditorContext");
		setRulerContextMenuId("genericity.language.gcomponent.resource.gcomponent.EditorRuler");
	}
	...
	public void createPartControl(org.eclipse.swt.widgets.Composite parent) {
		...
		highlighting = new genericity.language.gcomponent.resource.gcomponent.ui.GcomponentHighlighting(getResource(), viewer, colorManager, this);
		...
		codeFoldingManager = new genericity.language.gcomponent.resource.gcomponent.ui.GcomponentCodeFoldingManager(viewer, this);
	}
	...
	private void initializeResourceObject(org.eclipse.ui.IEditorInput editorInput) {
		...
		genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentNature.activate(inputFile.getProject());
		...
		genericity.language.gcomponent.resource.gcomponent.IGcomponentTextResource loadedResource = (genericity.language.gcomponent.resource.gcomponent.IGcomponentTextResource) resourceSet.getResource(uri, false);
		if (loadedResource == null) {
			try {
				...
				genericity.language.gcomponent.resource.gcomponent.IGcomponentTextResource currentResource = this.resource;
				...
				if (demandLoadedResource instanceof genericity.language.gcomponent.resource.gcomponent.IGcomponentTextResource) {
					setResource((genericity.language.gcomponent.resource.gcomponent.IGcomponentTextResource) demandLoadedResource);
				} else {
					// the resource was not loaded by an EMFText resource, but some other EMF resource
					genericity.language.gcomponent.resource.gcomponent.ui.GcomponentUIPlugin.showErrorDialog("No EMFText resource.", "The file '" + uri.lastSegment() + "' of type '" + uri.fileExtension() + "' can not be handled by the GcomponentEditor.");
					// close this editor because it can not present the resource
					close(false);
				}
			} catch (Exception e) {
				genericity.language.gcomponent.resource.gcomponent.ui.GcomponentUIPlugin.logError("Exception while loading resource in " + this.getClass().getSimpleName() + ".", e);
			}
		} else {
	...
	private void setResource(genericity.language.gcomponent.resource.gcomponent.IGcomponentTextResource resource) {
	...
	private Object getOutlinePage() {
		if (outlinePage == null) {
			outlinePage = new genericity.language.gcomponent.resource.gcomponent.ui.GcomponentOutlinePage(this);
	...
	public org.eclipse.ui.views.properties.IPropertySheetPage getPropertySheetPage() {
		if (propertySheetPage == null) {
			propertySheetPage = new genericity.language.gcomponent.resource.gcomponent.ui.GcomponentPropertySheetPage();
	...
	public void setCaret(org.eclipse.emf.ecore.EObject element, String text) {
		try {
			...
			genericity.language.gcomponent.resource.gcomponent.IGcomponentTextScanner lexer = getResource().getMetaInformation().createLexer();
			try {
				lexer.setText(viewer.getDocument().get(destination, length));
				genericity.language.gcomponent.resource.gcomponent.IGcomponentTextToken token = lexer.getNextToken();
			...
			genericity.language.gcomponent.resource.gcomponent.ui.GcomponentUIPlugin.logError("Exception in setCaret()", e);
		}
	}
	...
	protected org.eclipse.jface.text.source.ISourceViewer createSourceViewer(org.eclipse.swt.widgets.Composite parent, org.eclipse.jface.text.source.IVerticalRuler ruler, int styles) {
		org.eclipse.jface.text.source.ISourceViewer viewer = new org.eclipse.jface.text.source.projection.ProjectionViewer(parent, ruler, getOverviewRuler(), isOverviewRulerVisible(), styles) {
			...
			public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
				if (!GcomponentEditor.this.setSelection(selection, reveal)) {
	...
	public void addBackgroundParsingListener(genericity.language.gcomponent.resource.gcomponent.IGcomponentBackgroundParsingListener listener) {
		bgParsingListeners.add(listener);
	}
	
	public void notifyBackgroundParsingFinished() {
		for (genericity.language.gcomponent.resource.gcomponent.IGcomponentBackgroundParsingListener listener : bgParsingListeners) {
			listener.parsingCompleted(getResource());
		}
	}
	
	public genericity.language.gcomponent.resource.gcomponent.ui.IGcomponentBracketHandler getBracketHandler() {
		return bracketHandler;
	}
	
	public void setBracketHandler(genericity.language.gcomponent.resource.gcomponent.ui.IGcomponentBracketHandler bracketHandler) {
