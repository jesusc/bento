 ...
 */
public class GcomponentCompletionProposal implements java.lang.Comparable<GcomponentCompletionProposal> {
	 ...
	 */
	private genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentExpectedTerminal expectedTerminal;
	...
	public GcomponentCompletionProposal(genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container) {
		super();
	...
	public GcomponentCompletionProposal(genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.swt.graphics.Image image) {
	...
	public genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentExpectedTerminal getExpectedTerminal() {
		return expectedTerminal;
	}
	
	public boolean equals(Object object) {
		if (object instanceof GcomponentCompletionProposal) {
			GcomponentCompletionProposal other = (GcomponentCompletionProposal) object;
	...
	public int compareTo(GcomponentCompletionProposal object) {
		if (object instanceof GcomponentCompletionProposal) {
			GcomponentCompletionProposal other = (GcomponentCompletionProposal) object;
