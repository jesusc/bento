 ...
 */
public class GcomponentBracketSet {
	...
	private java.util.ArrayList<genericity.language.gcomponent.resource.gcomponent.IGcomponentBracketPair> bracketPairs;
	 ...
	 */
	private class BracketPair implements genericity.language.gcomponent.resource.gcomponent.IGcomponentBracketPair {
	 ...
	 */
	private class ClosingListener implements genericity.language.gcomponent.resource.gcomponent.ui.IGcomponentBracketHandler, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.ModifyListener, org.eclipse.swt.custom.VerifyKeyListener {
		...
		public void verifyText(org.eclipse.swt.events.VerifyEvent e) {
			...
			if (caret > 0 && caret < textWidget.getCharCount()) {
				genericity.language.gcomponent.resource.gcomponent.IGcomponentBracketPair bracketPair = getBracketPair(textWidget.getTextRange(caret - 1, 1), textWidget.getTextRange(caret, 1));
	 ...
	 */
	public GcomponentBracketSet(genericity.language.gcomponent.resource.gcomponent.ui.GcomponentEditor editor, org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		languageID = new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentMetaInformation().getSyntaxName();
		this.bracketPairs = new java.util.ArrayList<genericity.language.gcomponent.resource.gcomponent.IGcomponentBracketPair>();
	 ...
	 */
	public genericity.language.gcomponent.resource.gcomponent.IGcomponentBracketPair getBracketPair(String opening, String closing) {
		for (genericity.language.gcomponent.resource.gcomponent.IGcomponentBracketPair bracketPair : bracketPairs) {
	...
	public genericity.language.gcomponent.resource.gcomponent.IGcomponentBracketPair getBracketPair(int index) {
		try {
	 ...
	 */
	public boolean setClosingEnabledInside(genericity.language.gcomponent.resource.gcomponent.IGcomponentBracketPair bracketPair, boolean closingEnabledInside) {
	...
	public boolean resetBrackets() {
		String bracketPairs = preferenceStore.getString(languageID + genericity.language.gcomponent.resource.gcomponent.ui.GcomponentPreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	 ...
	 */
	public genericity.language.gcomponent.resource.gcomponent.IGcomponentBracketPair remove(String opening, String closing) {
		for (genericity.language.gcomponent.resource.gcomponent.IGcomponentBracketPair bracketPair : bracketPairs) {
			if (bracketPair.getOpeningBracket().equals(opening) && bracketPair.getClosingBracket().equals(closing)) {
	...
	public boolean setBrackets(String bracketSet) {
		...
		bracketPairs = new java.util.ArrayList<genericity.language.gcomponent.resource.gcomponent.IGcomponentBracketPair>();
	...
	public void matchingBrackets() {
		...
		if (position != -1 && position != document.getLength()) {
			positionHelper.addPosition(document, genericity.language.gcomponent.resource.gcomponent.ui.GcomponentPositionCategory.BRACKET.toString(), position, 1);
			positionHelper.addPosition(document, genericity.language.gcomponent.resource.gcomponent.ui.GcomponentPositionCategory.BRACKET.toString(), caretOffset - 1, 1);
		}
	}
