 ...
 */
public class GcomponentNewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	 ...
	 */
	public GcomponentNewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");
		setTitle("Create new gcomponent file");
