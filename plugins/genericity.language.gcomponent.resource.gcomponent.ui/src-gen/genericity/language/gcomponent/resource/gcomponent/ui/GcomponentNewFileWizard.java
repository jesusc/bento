...
public class GcomponentNewFileWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard {
	
	private String categoryId = null;
	private genericity.language.gcomponent.resource.gcomponent.ui.GcomponentNewFileWizardPage page;
	private org.eclipse.jface.viewers.ISelection selection;
	private String newName = null;
	
	public GcomponentNewFileWizard() {
		super();
	...
	public void addPages() {
		page = new genericity.language.gcomponent.resource.gcomponent.ui.GcomponentNewFileWizardPage(selection, getFileExtension());
		addPage(page);
	}
	...
	public boolean performFinish() {
		...
		try {
			...
			genericity.language.gcomponent.resource.gcomponent.ui.GcomponentUIPlugin.logError("Exception while initializing new file", e1);
			return false;
		}
		...
		try {
			...
			genericity.language.gcomponent.resource.gcomponent.ui.GcomponentUIPlugin.logError("Exception while initializing new file", e);
			return false;
		}
		return true;
	}
	...
	private java.io.InputStream openContentStream() {
		return new java.io.ByteArrayInputStream(new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentMetaInformation().getNewFileContentProvider().getNewFileContent(newName).getBytes());
	}
	...
	public String getFileExtension() {
		return new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentMetaInformation().getSyntaxName();
	}
	
	public genericity.language.gcomponent.resource.gcomponent.IGcomponentMetaInformation getMetaInformation() {
