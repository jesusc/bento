 ...
 * @since 3.2
 */
public class GcomponentBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private genericity.language.gcomponent.resource.gcomponent.ui.GcomponentDocBrowserInformationControlInput fInput;
	 ...
	 */
	public GcomponentBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, boolean resizable) {
	 ...
	 */
	public GcomponentBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, String statusFieldText) {
	 ...
	 * @since 3.4
	 */
	public GcomponentBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, org.eclipse.jface.action.ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof genericity.language.gcomponent.resource.gcomponent.ui.GcomponentDocBrowserInformationControlInput);
		...
		fInput= (genericity.language.gcomponent.resource.gcomponent.ui.GcomponentDocBrowserInformationControlInput) input;
		...
		genericity.language.gcomponent.resource.gcomponent.ui.GcomponentHTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = genericity.language.gcomponent.resource.gcomponent.ui.GcomponentHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	 ...
	 */
	public genericity.language.gcomponent.resource.gcomponent.ui.GcomponentDocBrowserInformationControlInput getInput() {
		return fInput;
	}
