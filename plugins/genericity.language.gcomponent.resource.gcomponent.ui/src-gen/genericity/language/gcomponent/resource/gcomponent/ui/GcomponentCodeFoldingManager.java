 ...
 */
public class GcomponentCodeFoldingManager {
	
	private class FoldingUpdateListener implements genericity.language.gcomponent.resource.gcomponent.IGcomponentBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(genericity.language.gcomponent.resource.gcomponent.ui.GcomponentEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof genericity.language.gcomponent.resource.gcomponent.ui.GcomponentEditor) {
				genericity.language.gcomponent.resource.gcomponent.ui.GcomponentEditor editor = (genericity.language.gcomponent.resource.gcomponent.ui.GcomponentEditor) workbenchPart;
	...
	protected genericity.language.gcomponent.resource.gcomponent.ui.GcomponentEditor editor;
	 ...
	 */
	public GcomponentCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,genericity.language.gcomponent.resource.gcomponent.ui.GcomponentEditor textEditor) {
	...
	private void addCloseListener(final genericity.language.gcomponent.resource.gcomponent.ui.GcomponentEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			genericity.language.gcomponent.resource.gcomponent.ui.GcomponentUIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
			return "";
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		genericity.language.gcomponent.resource.gcomponent.IGcomponentTextResource textResource = (genericity.language.gcomponent.resource.gcomponent.IGcomponentTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
