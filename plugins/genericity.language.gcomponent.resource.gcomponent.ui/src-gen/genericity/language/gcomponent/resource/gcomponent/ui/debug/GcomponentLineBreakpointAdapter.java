...
public class GcomponentLineBreakpointAdapter implements org.eclipse.debug.ui.actions.IToggleBreakpointsTarget {
	...
	public void toggleLineBreakpoints(org.eclipse.ui.IWorkbenchPart part, org.eclipse.jface.viewers.ISelection selection) throws org.eclipse.core.runtime.CoreException {
		...
		if (textEditor != null) {
			...
			org.eclipse.debug.core.model.IBreakpoint[] breakpoints = org.eclipse.debug.core.DebugPlugin.getDefault().getBreakpointManager().getBreakpoints(genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentPlugin.DEBUG_MODEL_ID);
			...
			genericity.language.gcomponent.resource.gcomponent.debug.GcomponentLineBreakpoint lineBreakpoint = new genericity.language.gcomponent.resource.gcomponent.debug.GcomponentLineBreakpoint(resource, lineNumber + 1);
