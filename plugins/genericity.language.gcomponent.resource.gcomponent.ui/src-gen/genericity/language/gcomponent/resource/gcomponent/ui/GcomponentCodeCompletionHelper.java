...
public class GcomponentCodeCompletionHelper {
	...
	private genericity.language.gcomponent.resource.gcomponent.IGcomponentMetaInformation metaInformation = new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentMetaInformation();
	...
	public genericity.language.gcomponent.resource.gcomponent.ui.GcomponentCompletionProposal[] computeCompletionProposals(genericity.language.gcomponent.resource.gcomponent.IGcomponentTextResource originalResource, String content, int cursorOffset) {
		...
		for (genericity.language.gcomponent.resource.gcomponent.ui.GcomponentCompletionProposal leftProposal : leftProposals) {
		...
		for (genericity.language.gcomponent.resource.gcomponent.ui.GcomponentCompletionProposal proposal : sortedProposals) {
	 ...
	 * the same position.
	 */
	protected void removeDuplicateEntries(java.util.List<genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentExpectedTerminal> expectedElements) {
		...
		java.util.Map<Integer, java.util.List<genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentExpectedTerminal>> map = new java.util.LinkedHashMap<Integer, java.util.List<genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentExpectedTerminal>>();
		for (int i = 0; i < size; i++) {
			...
			java.util.List<genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentExpectedTerminal> list = map.get(start1);
			if (list == null) {
				list = new java.util.ArrayList<genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentExpectedTerminal>();
				map.put(start1, list);
			}
		...
		for (int position : map.keySet()) {
			java.util.List<genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentExpectedTerminal> list = map.get(position);
	 ...
	 */
	protected void removeDuplicateEntriesFromBucket(java.util.List<genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentExpectedTerminal> expectedElements) {
		int size = expectedElements.size();
		for (int i = 0; i < size - 1; i++) {
			genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentExpectedTerminal elementAtIndex = expectedElements.get(i);
			genericity.language.gcomponent.resource.gcomponent.IGcomponentExpectedElement terminal = elementAtIndex.getTerminal();
	...
	protected void removeInvalidEntriesAtEnd(java.util.List<genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentExpectedTerminal> expectedElements) {
		for (int i = 0; i < expectedElements.size() - 1;) {
			...
			// rule.
			genericity.language.gcomponent.resource.gcomponent.grammar.GcomponentSyntaxElement symtaxElementOfThis = elementAtIndex.getTerminal().getSymtaxElement();
			genericity.language.gcomponent.resource.gcomponent.grammar.GcomponentSyntaxElement symtaxElementOfNext = elementAtNext.getTerminal().getSymtaxElement();
	 ...
	 */
	protected void removeKeywordsEndingBeforeIndex(java.util.Collection<genericity.language.gcomponent.resource.gcomponent.ui.GcomponentCompletionProposal> proposals, int index) {
		java.util.List<genericity.language.gcomponent.resource.gcomponent.ui.GcomponentCompletionProposal> toRemove = new java.util.ArrayList<genericity.language.gcomponent.resource.gcomponent.ui.GcomponentCompletionProposal>();
		for (genericity.language.gcomponent.resource.gcomponent.ui.GcomponentCompletionProposal proposal : proposals) {
			genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentExpectedTerminal expectedTerminal = proposal.getExpectedTerminal();
			genericity.language.gcomponent.resource.gcomponent.IGcomponentExpectedElement terminal = expectedTerminal.getTerminal();
			if (terminal instanceof genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentExpectedCsString) {
				genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentExpectedCsString csString = (genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentExpectedCsString) terminal;
	...
	protected String findPrefix(java.util.List<genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentExpectedTerminal> expectedElements, genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentExpectedTerminal expectedAtCursor, String content, int cursorOffset) {
		if (cursorOffset < 0) {
			return "";
		}
		int end = 0;
	...
	protected java.util.Collection<genericity.language.gcomponent.resource.gcomponent.ui.GcomponentCompletionProposal> deriveProposals(final genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentExpectedTerminal expectedTerminal, String content, genericity.language.gcomponent.resource.gcomponent.IGcomponentTextResource resource, int cursorOffset) {
		...
		if (expectedElement instanceof genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentExpectedCsString) {
			...
			final genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentExpectedStructuralFeature expectedFeature = (genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentExpectedStructuralFeature) expectedElement;
			...
			// completed.
			final java.util.Collection<genericity.language.gcomponent.resource.gcomponent.ui.GcomponentCompletionProposal> proposals = new java.util.ArrayList<genericity.language.gcomponent.resource.gcomponent.ui.GcomponentCompletionProposal>();
	...
	protected java.util.Collection<genericity.language.gcomponent.resource.gcomponent.ui.GcomponentCompletionProposal> handleEnumAttribute(genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentExpectedTerminal expectedTerminal, genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentExpectedStructuralFeature expectedFeature, org.eclipse.emf.ecore.EEnum enumType, String prefix, org.eclipse.emf.ecore.EObject container) {
		...
		for (org.eclipse.emf.ecore.EEnumLiteral literal : enumLiterals) {
			...
			result.add(new genericity.language.gcomponent.resource.gcomponent.ui.GcomponentCompletionProposal(expectedTerminal, resolvedLiteral, prefix, matchesPrefix, expectedFeature.getFeature(), container));
		}
		return result;
	}
	
	protected java.util.Collection<genericity.language.gcomponent.resource.gcomponent.ui.GcomponentCompletionProposal> handleNCReference(genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentExpectedTerminal expectedTerminal, org.eclipse.emf.ecore.EObject container, org.eclipse.emf.ecore.EReference reference, String prefix, String tokenName) {
		...
		if (mappings != null) {
			...
			for (genericity.language.gcomponent.resource.gcomponent.IGcomponentReferenceMapping<org.eclipse.emf.ecore.EObject> mapping : mappings) {
				...
				if (mapping instanceof genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentElementMapping<?>) {
					...
					resultSet.add(new genericity.language.gcomponent.resource.gcomponent.ui.GcomponentCompletionProposal(expectedTerminal, identifier, prefix, matchesPrefix, reference, container, image));
				}
			}
			return resultSet;
		}
				...
				if (defaultValue != null) {
					...
					if (tokenName != null) {
						...
						if (tokenResolver != null) {
							...
							resultSet.add(new genericity.language.gcomponent.resource.gcomponent.ui.GcomponentCompletionProposal(expectedTerminal, defaultValueAsString, prefix, matchesPrefix, expectedFeature.getFeature(), container));
						}
					}
				}
			}
	 ...
	 */
	protected java.util.Collection<genericity.language.gcomponent.resource.gcomponent.ui.GcomponentCompletionProposal> handleKeyword(genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentExpectedTerminal expectedTerminal, genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentExpectedCsString csString, String prefix) {
		String proposal = csString.getValue();
		boolean matchesPrefix = matches(proposal, prefix);
		return java.util.Collections.singleton(new genericity.language.gcomponent.resource.gcomponent.ui.GcomponentCompletionProposal(expectedTerminal, proposal, prefix, matchesPrefix, null, null));
	}
	
	/**
	 * Creates a set of (two) completion proposals from the given boolean terminal.
	 */
	protected java.util.Collection<genericity.language.gcomponent.resource.gcomponent.ui.GcomponentCompletionProposal> handleBooleanTerminal(genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentExpectedTerminal expectedTerminal, genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentExpectedBooleanTerminal expectedBooleanTerminal, String prefix) {
	 ...
	 */
	protected java.util.Collection<genericity.language.gcomponent.resource.gcomponent.ui.GcomponentCompletionProposal> handleEnumerationTerminal(genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentExpectedTerminal expectedTerminal, genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentExpectedEnumerationTerminal expectedEnumerationTerminal, String prefix) {
		java.util.Collection<genericity.language.gcomponent.resource.gcomponent.ui.GcomponentCompletionProposal> result = new java.util.LinkedHashSet<genericity.language.gcomponent.resource.gcomponent.ui.GcomponentCompletionProposal>(2);
	...
	protected java.util.Collection<genericity.language.gcomponent.resource.gcomponent.ui.GcomponentCompletionProposal> handleLiteral(genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentExpectedTerminal expectedTerminal, org.eclipse.emf.ecore.EAttribute attribute, String prefix, String literal) {
		if ("".equals(literal)) {
			return java.util.Collections.emptySet();
		}
		boolean matchesPrefix = matches(literal, prefix);
		return java.util.Collections.singleton(new genericity.language.gcomponent.resource.gcomponent.ui.GcomponentCompletionProposal(expectedTerminal, literal, prefix, matchesPrefix, null, null));
	}
	 ...
	 * element is expected.
	 */
	protected void setPrefixes(java.util.List<genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentExpectedTerminal> expectedElements, String content, int cursorOffset) {
		if (cursorOffset < 0) {
			return;
		}
		for (genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentExpectedTerminal expectedElement : expectedElements) {
	 ...
	 */
	protected int getEnd(genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentExpectedTerminal[] allExpectedElements, int indexInList) {
	...
	protected org.eclipse.emf.ecore.EObject findCorrectContainer(genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentExpectedTerminal expectedTerminal) {
		...
		genericity.language.gcomponent.resource.gcomponent.grammar.GcomponentContainmentTrace containmentTrace = expectedTerminal.getContainmentTrace();
		org.eclipse.emf.ecore.EClass startClass = containmentTrace.getStartClass();
		genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentContainedFeature currentLink = null;
		genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentContainedFeature previousLink = null;
		genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentContainedFeature[] containedFeatures = containmentTrace.getPath();
			...
			if (hookableParent != null) {
				...
				if (parent != null) {
					if (previousParent == null) {
						...
						genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentContainedFeature link = previousLink;
						genericity.language.gcomponent.resource.gcomponent.util.GcomponentEObjectUtil.setFeature(parent, link.getFeature(), previousParent, false);
					}
				}
			}
		}
		...
		if (parent != null && hookableParent != null) {
			expectedTerminal.setAttachmentCode(new Runnable() {
				...
				public void run() {
					genericity.language.gcomponent.resource.gcomponent.util.GcomponentEObjectUtil.setFeature(finalHookableParent, finalFeature, finalParent, false);
				}
			});
		}
		return correctContainer;
	 ...
	 */
	protected org.eclipse.emf.ecore.EObject findHookParent(org.eclipse.emf.ecore.EObject container, org.eclipse.emf.ecore.EClass startClass, genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentContainedFeature currentLink, org.eclipse.emf.ecore.EObject object) {
		org.eclipse.emf.ecore.EClass containerClass = currentLink.getContainerClass();
