 ...
 * hovers, is a proxy.
 */
public class GcomponentHyperlinkDetector implements org.eclipse.jface.text.hyperlink.IHyperlinkDetector {
	 ...
	 */
	public GcomponentHyperlinkDetector(org.eclipse.emf.ecore.resource.Resource resource) {
		textResource = (genericity.language.gcomponent.resource.gcomponent.IGcomponentTextResource) resource;
	}
		...
		for (org.eclipse.emf.ecore.EObject eObject : elementsAtOffset) {
			if (eObject.eIsProxy()) {
				...
				if (resolvedEObject.eResource() != null) {
					org.eclipse.jface.text.hyperlink.IHyperlink hyperlink = new genericity.language.gcomponent.resource.gcomponent.ui.GcomponentHyperlink(new org.eclipse.jface.text.Region(offset, length), resolvedEObject, text);
