 ...
 */
public class GcomponentHighlighting implements org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener {
	
	private final static genericity.language.gcomponent.resource.gcomponent.ui.GcomponentPositionHelper positionHelper = new genericity.language.gcomponent.resource.gcomponent.ui.GcomponentPositionHelper();
	...
	private genericity.language.gcomponent.resource.gcomponent.ui.GcomponentTokenScanner scanner;
	...
	private genericity.language.gcomponent.resource.gcomponent.ui.GcomponentEditor editor;
	private org.eclipse.jface.text.source.projection.ProjectionViewer projectionViewer;
	private genericity.language.gcomponent.resource.gcomponent.ui.GcomponentOccurrence occurrence;
	private genericity.language.gcomponent.resource.gcomponent.ui.GcomponentBracketSet bracketSet;
	 ...
	 */
	private final class UpdateHighlightingListener implements org.eclipse.swt.events.KeyListener, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.MouseListener, genericity.language.gcomponent.resource.gcomponent.IGcomponentBackgroundParsingListener {
	 ...
	 * @param editor
	 */
	public GcomponentHighlighting(genericity.language.gcomponent.resource.gcomponent.IGcomponentTextResource textResource, org.eclipse.jface.text.source.projection.ProjectionViewer sourceviewer, genericity.language.gcomponent.resource.gcomponent.ui.GcomponentColorManager colorManager, genericity.language.gcomponent.resource.gcomponent.ui.GcomponentEditor editor) {
		this.display = org.eclipse.swt.widgets.Display.getCurrent();
		sourceviewer.getSelectionProvider();
		preferenceStore = genericity.language.gcomponent.resource.gcomponent.ui.GcomponentUIPlugin.getDefault().getPreferenceStore();
		this.editor = editor;
		textWidget = sourceviewer.getTextWidget();
		projectionViewer = sourceviewer;
		scanner = new genericity.language.gcomponent.resource.gcomponent.ui.GcomponentTokenScanner(textResource, colorManager);
		occurrence = new genericity.language.gcomponent.resource.gcomponent.ui.GcomponentOccurrence(textResource, sourceviewer, scanner);
		bracketSet = new genericity.language.gcomponent.resource.gcomponent.ui.GcomponentBracketSet(editor, sourceviewer);
		this.colorManager = colorManager;
		isHighlightBrackets = preferenceStore.getBoolean(genericity.language.gcomponent.resource.gcomponent.ui.GcomponentPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		bracketColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, genericity.language.gcomponent.resource.gcomponent.ui.GcomponentPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));
		black = colorManager.getColor(new org.eclipse.swt.graphics.RGB(0, 0, 0));
		
		addListeners(editor);
	}
	
	private void addListeners(genericity.language.gcomponent.resource.gcomponent.ui.GcomponentEditor editor) {
	...
	private void setBracketHighlighting(org.eclipse.jface.text.IDocument document) {
		...
		org.eclipse.jface.text.Position[] positions = positionHelper.getPositions(document, genericity.language.gcomponent.resource.gcomponent.ui.GcomponentPositionCategory.BRACKET.toString());
	...
	private void removeHighlighting() {
		...
		removeHighlightingCategory(document, genericity.language.gcomponent.resource.gcomponent.ui.GcomponentPositionCategory.BRACKET.toString());
	}
	...
	private void removeHighlightingCategory(org.eclipse.jface.text.IDocument document, String category) {
		...
		if (category.equals(genericity.language.gcomponent.resource.gcomponent.ui.GcomponentPositionCategory.BRACKET.toString())) {
		...
		display.asyncExec(new Runnable() {
			public void run() {
				...
				if (selectedEObject != null) {
					setSelection(new genericity.language.gcomponent.resource.gcomponent.ui.GcomponentEObjectSelection(selectedEObject, false));
				}
			}
		});
	}
