 ...
 * 
 */
package genericity.language.gcomponent.resource.gcomponent.ui.debug;

@SuppressWarnings("restriction")
public class GcomponentAdapterFactory implements org.eclipse.core.runtime.IAdapterFactory {
	...
	public Object getAdapter(Object adaptableObject, Class adapterType) {
		if (adaptableObject instanceof org.eclipse.ui.texteditor.ITextEditor) {
			...
			if (resource != null) {
				...
				if (extension != null && extension.equals(new genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentMetaInformation().getSyntaxName())) {
					return new genericity.language.gcomponent.resource.gcomponent.ui.debug.GcomponentLineBreakpointAdapter();
				}
			}
		}
		if (adapterType == org.eclipse.debug.internal.ui.viewers.model.provisional.IElementLabelProvider.class && adaptableObject instanceof genericity.language.gcomponent.resource.gcomponent.debug.GcomponentDebugVariable) {
			final genericity.language.gcomponent.resource.gcomponent.debug.GcomponentDebugVariable variable = (genericity.language.gcomponent.resource.gcomponent.debug.GcomponentDebugVariable) adaptableObject;
		...
		if (adapterType == org.eclipse.debug.internal.ui.viewers.model.provisional.IElementContentProvider.class && adaptableObject instanceof genericity.language.gcomponent.resource.gcomponent.debug.GcomponentDebugVariable) {
			final genericity.language.gcomponent.resource.gcomponent.debug.GcomponentDebugVariable variable = (genericity.language.gcomponent.resource.gcomponent.debug.GcomponentDebugVariable) adaptableObject;
				...
				public void update(org.eclipse.debug.internal.ui.viewers.model.provisional.IChildrenCountUpdate[] updates) {
					try {
						for (org.eclipse.debug.internal.ui.viewers.model.provisional.IChildrenCountUpdate update : updates) {
							...
							genericity.language.gcomponent.resource.gcomponent.debug.GcomponentDebugValue castedValue = (genericity.language.gcomponent.resource.gcomponent.debug.GcomponentDebugValue) value;
