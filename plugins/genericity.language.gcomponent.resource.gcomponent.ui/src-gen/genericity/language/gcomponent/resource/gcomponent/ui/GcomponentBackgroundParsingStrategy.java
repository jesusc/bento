 ...
 */
public class GcomponentBackgroundParsingStrategy {
	 ...
	 */
	public void parse(org.eclipse.jface.text.DocumentEvent event, final genericity.language.gcomponent.resource.gcomponent.IGcomponentTextResource resource, final genericity.language.gcomponent.resource.gcomponent.ui.GcomponentEditor editor) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(org.eclipse.jface.text.IDocument document, final genericity.language.gcomponent.resource.gcomponent.IGcomponentTextResource resource, final genericity.language.gcomponent.resource.gcomponent.ui.GcomponentEditor editor, long delay) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(final String contents, final genericity.language.gcomponent.resource.gcomponent.IGcomponentTextResource resource, final genericity.language.gcomponent.resource.gcomponent.ui.GcomponentEditor editor, long delay) {
		if (resource == null) {
			return;
		}
		if (contents == null) {
			...
			while (newContents != null ) {
				while (newContents != null) {
					try {
						...
						if (resource instanceof genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentResource) {
							genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentResource concreteResource = (genericity.language.gcomponent.resource.gcomponent.mopp.GcomponentResource) resource;
