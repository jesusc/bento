 ...
 * <ul>
 *   <li>{@link examples.flow_diagrams.report.impl.StateImpl#getPlaces <em>Places</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StateImpl extends EObjectImpl implements State {
	...
	protected EClass eStaticClass() {
		return ReportPackage.Literals.STATE;
	}
	 ...
	 * @generated
	 */
	public EList getPlaces() {
		if (places == null) {
			places = new EObjectContainmentEList(Place.class, this, ReportPackage.STATE__PLACES);
		}
		return places;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ReportPackage.STATE__PLACES:
