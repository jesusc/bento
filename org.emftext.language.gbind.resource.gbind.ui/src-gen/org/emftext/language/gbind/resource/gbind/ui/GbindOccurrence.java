 ...
 */
public class GbindOccurrence {
	
	public final static String OCCURRENCE_ANNOTATION_ID = "org.emftext.language.gbind.resource.gbind.ui.occurences";
	public final static String DECLARATION_ANNOTATION_ID = "org.emftext.language.gbind.resource.gbind.ui.occurences.declaration";
	...
	private org.emftext.language.gbind.resource.gbind.ui.GbindTokenScanner tokenScanner;
	...
	private org.emftext.language.gbind.resource.gbind.IGbindTextResource textResource;
	 ...
	 */
	public GbindOccurrence(org.emftext.language.gbind.resource.gbind.IGbindTextResource textResource, org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer, org.emftext.language.gbind.resource.gbind.ui.GbindTokenScanner tokenScanner) {
		this.textResource = textResource;
		this.projectionViewer = sourceViewer;
		
		quotedTokenArray = new java.util.ArrayList<String>();
		String[] tokenNames = new org.emftext.language.gbind.resource.gbind.mopp.GbindMetaInformation().getTokenNames();
	 ...
	 */
	public void handleOccurrenceHighlighting(org.emftext.language.gbind.resource.gbind.ui.GbindBracketSet bracketSet) {
		...
		if (resource.equals(textResource)) {
			...
			while (!token.isEOF()) {
				...
				if (text.equals(tokenText)) {
					...
					addAnnotation(document, org.emftext.language.gbind.resource.gbind.ui.GbindPositionCategory.DEFINTION, text);
					break;
				}
				token = tokenScanner.nextToken();
			}
			...
			if (text != null && text.equals(tokenText) && tokenScanner.getTokenOffset() != defPosition) {
				...
				if (occEO != null) {
					if ((isNull && elementsAtDefinition.contains(occEO)) || !isNull && definitionElement.equals(occEO)) {
						addAnnotation(document, org.emftext.language.gbind.resource.gbind.ui.GbindPositionCategory.PROXY, text);
					}
				}
			}
			token = tokenScanner.nextToken();
	...
	private void addAnnotation(org.eclipse.jface.text.IDocument document, org.emftext.language.gbind.resource.gbind.ui.GbindPositionCategory type, String text) {
		int tokenOffset = tokenScanner.getTokenOffset();
		int tokenLength = tokenScanner.getTokenLength();
		...
		if (type == org.emftext.language.gbind.resource.gbind.ui.GbindPositionCategory.DEFINTION) {
	...
	private void removeAnnotations() {
		removeAnnotations(org.emftext.language.gbind.resource.gbind.ui.GbindOccurrence.OCCURRENCE_ANNOTATION_ID);
		removeAnnotations(org.emftext.language.gbind.resource.gbind.ui.GbindOccurrence.DECLARATION_ANNOTATION_ID);
	}
