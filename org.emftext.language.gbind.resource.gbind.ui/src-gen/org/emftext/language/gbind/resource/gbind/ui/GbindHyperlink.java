 ...
 */
public class GbindHyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	 ...
	 */
	public GbindHyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				org.emftext.language.gbind.resource.gbind.mopp.GbindPlugin.logError("Exception while opening hyperlink target.", e);
			}
		}
	}
