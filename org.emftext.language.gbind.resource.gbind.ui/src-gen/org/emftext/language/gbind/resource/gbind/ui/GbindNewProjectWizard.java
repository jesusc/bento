...
public class GbindNewProjectWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard, org.eclipse.core.runtime.IExecutableExtension {
	 ...
	 */
	private String pageName = "New " + new org.emftext.language.gbind.resource.gbind.mopp.GbindMetaInformation().getSyntaxName() + " Project";
				...
				public void execute(org.eclipse.core.runtime.IProgressMonitor monitor) throws InterruptedException {
					try {
						...
						if (!project.exists()) {
							...
							org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle("org.emftext.language.gbind.resource.gbind.ui");
							...
							String natureID = org.emftext.language.gbind.resource.gbind.mopp.GbindNature.NATURE_ID;
							...
							for (String builderID : org.emftext.language.gbind.resource.gbind.mopp.GbindNature.BUILDER_IDS) {
							...
							if (defaultNewFile.exists()) {
								org.emftext.language.gbind.resource.gbind.mopp.GbindMetaInformation info = new org.emftext.language.gbind.resource.gbind.mopp.GbindMetaInformation();
