 ...
 */
public class GbindLaunchShortcut implements org.eclipse.debug.ui.ILaunchShortcut2 {
	...
	private void launch(org.eclipse.core.resources.IFile file, String mode) {
		try {
			...
			org.eclipse.debug.core.ILaunchConfigurationType type = lm.getLaunchConfigurationType(new org.emftext.language.gbind.resource.gbind.mopp.GbindMetaInformation().getLaunchConfigurationType());
			...
			workingCopy.setAttribute(org.emftext.language.gbind.resource.gbind.launch.GbindLaunchConfigurationDelegate.ATTR_RESOURCE_URI, uri.toString());
			...
			org.emftext.language.gbind.resource.gbind.mopp.GbindPlugin.logError("Exception while launching selection", e);
		}
	}
