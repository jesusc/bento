 ...
 */
public class GbindCodeFoldingManager {
	
	private class FoldingUpdateListener implements org.emftext.language.gbind.resource.gbind.IGbindBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(org.emftext.language.gbind.resource.gbind.ui.GbindEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof org.emftext.language.gbind.resource.gbind.ui.GbindEditor) {
				org.emftext.language.gbind.resource.gbind.ui.GbindEditor editor = (org.emftext.language.gbind.resource.gbind.ui.GbindEditor) workbenchPart;
	...
	protected org.emftext.language.gbind.resource.gbind.ui.GbindEditor editor;
	 ...
	 */
	public GbindCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,org.emftext.language.gbind.resource.gbind.ui.GbindEditor textEditor) {
	...
	private void addCloseListener(final org.emftext.language.gbind.resource.gbind.ui.GbindEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			org.emftext.language.gbind.resource.gbind.ui.GbindUIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		org.emftext.language.gbind.resource.gbind.IGbindTextResource textResource = (org.emftext.language.gbind.resource.gbind.IGbindTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
