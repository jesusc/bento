 ...
 * 
 */
package org.emftext.language.gbind.resource.gbind.ui.debug;

@SuppressWarnings("restriction")
public class GbindAdapterFactory implements org.eclipse.core.runtime.IAdapterFactory {
	...
	public Object getAdapter(Object adaptableObject, Class adapterType) {
		if (adaptableObject instanceof org.eclipse.ui.texteditor.ITextEditor) {
			...
			if (resource != null) {
				...
				if (extension != null && extension.equals(new org.emftext.language.gbind.resource.gbind.mopp.GbindMetaInformation().getSyntaxName())) {
					return new org.emftext.language.gbind.resource.gbind.ui.debug.GbindLineBreakpointAdapter();
				}
			}
		}
		if (adapterType == org.eclipse.debug.internal.ui.viewers.model.provisional.IElementLabelProvider.class && adaptableObject instanceof org.emftext.language.gbind.resource.gbind.debug.GbindDebugVariable) {
			final org.emftext.language.gbind.resource.gbind.debug.GbindDebugVariable variable = (org.emftext.language.gbind.resource.gbind.debug.GbindDebugVariable) adaptableObject;
		...
		if (adapterType == org.eclipse.debug.internal.ui.viewers.model.provisional.IElementContentProvider.class && adaptableObject instanceof org.emftext.language.gbind.resource.gbind.debug.GbindDebugVariable) {
			final org.emftext.language.gbind.resource.gbind.debug.GbindDebugVariable variable = (org.emftext.language.gbind.resource.gbind.debug.GbindDebugVariable) adaptableObject;
				...
				public void update(org.eclipse.debug.internal.ui.viewers.model.provisional.IChildrenCountUpdate[] updates) {
					try {
						for (org.eclipse.debug.internal.ui.viewers.model.provisional.IChildrenCountUpdate update : updates) {
							...
							org.emftext.language.gbind.resource.gbind.debug.GbindDebugValue castedValue = (org.emftext.language.gbind.resource.gbind.debug.GbindDebugValue) value;
