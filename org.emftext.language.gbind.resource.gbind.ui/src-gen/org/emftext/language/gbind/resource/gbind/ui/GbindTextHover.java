 ...
 */
public class GbindTextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2 {
	...
	private org.emftext.language.gbind.resource.gbind.IGbindHoverTextProvider hoverTextProvider;
	/**
	 * The style sheet (css).
	 */
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final org.emftext.language.gbind.resource.gbind.ui.GbindBrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(org.emftext.language.gbind.resource.gbind.ui.GbindBrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			org.emftext.language.gbind.resource.gbind.ui.GbindDocBrowserInformationControlInput infoInput = (org.emftext.language.gbind.resource.gbind.ui.GbindDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					org.emftext.language.gbind.resource.gbind.ui.GbindHyperlink hyperlink = new org.emftext.language.gbind.resource.gbind.ui.GbindHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (org.emftext.language.gbind.resource.gbind.ui.GbindBrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				org.emftext.language.gbind.resource.gbind.ui.GbindBrowserInformationControl iControl = new org.emftext.language.gbind.resource.gbind.ui.GbindBrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(Object newInput) {
						...
						} else if (newInput instanceof org.emftext.language.gbind.resource.gbind.ui.GbindDocBrowserInformationControlInput) {
							org.emftext.language.gbind.resource.gbind.ui.GbindDocBrowserInformationControlInput input = (org.emftext.language.gbind.resource.gbind.ui.GbindDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (org.emftext.language.gbind.resource.gbind.ui.GbindBrowserInformationControl.isAvailable(parent)) {
				org.emftext.language.gbind.resource.gbind.ui.GbindBrowserInformationControl iControl = new org.emftext.language.gbind.resource.gbind.ui.GbindBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	 ...
	 */
	public GbindTextHover(org.emftext.language.gbind.resource.gbind.IGbindResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
		this.hoverTextProvider = new org.emftext.language.gbind.resource.gbind.ui.GbindUIMetaInformation().getHoverTextProvider();
	}
	...
	public String getHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		return ((org.emftext.language.gbind.resource.gbind.ui.GbindDocBrowserInformationControlInput) getHoverInfo2(textViewer, hoverRegion)).getHtml();
	}
	...
	private org.emftext.language.gbind.resource.gbind.ui.GbindDocBrowserInformationControlInput internalGetHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
	 ...
	 */
	private org.emftext.language.gbind.resource.gbind.ui.GbindDocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, org.emftext.language.gbind.resource.gbind.ui.GbindDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				org.emftext.language.gbind.resource.gbind.ui.GbindHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(containerObject, declarationObject));
			}
		} else {
			org.emftext.language.gbind.resource.gbind.ui.GbindHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			org.emftext.language.gbind.resource.gbind.ui.GbindHTMLPrinter.insertPageProlog(buffer, 0, org.emftext.language.gbind.resource.gbind.ui.GbindTextHover.getStyleSheet());
			org.emftext.language.gbind.resource.gbind.ui.GbindHTMLPrinter.addPageEpilog(buffer);
			return new org.emftext.language.gbind.resource.gbind.ui.GbindDocBrowserInformationControlInput(previousInput, declarationObject, resourceProvider.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		if (css != null) {
			...
			css = org.emftext.language.gbind.resource.gbind.ui.GbindHTMLPrinter.convertTopLevelFont(css, fontData);
		}
	...
	private static String loadStyleSheet() {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(org.emftext.language.gbind.resource.gbind.ui.GbindUIPlugin.PLUGIN_ID);
		java.net.URL styleSheetURL = bundle.getEntry("/css/hover_style.css");
		if (styleSheetURL != null) {
			try {
				return org.emftext.language.gbind.resource.gbind.util.GbindStreamUtil.getContent(styleSheetURL.openStream());
