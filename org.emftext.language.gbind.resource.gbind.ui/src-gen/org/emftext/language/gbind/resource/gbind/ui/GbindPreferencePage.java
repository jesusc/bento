 ...
 */
public class GbindPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	
	public void init(org.eclipse.ui.IWorkbench workbench) {
		setPreferenceStore(org.emftext.language.gbind.resource.gbind.ui.GbindUIPlugin.getDefault().getPreferenceStore());
		setDescription("Gbind Text Editor Preferences");
	}
