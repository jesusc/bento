...
public class GbindMarkerResolutionGenerator implements org.eclipse.ui.IMarkerResolutionGenerator {
	...
	public org.eclipse.ui.IMarkerResolution[] getResolutions(org.eclipse.core.resources.IMarker marker) {
		try {
			...
			if (resource instanceof org.eclipse.core.resources.IFile) {
				...
				rs.getLoadOptions().put(org.emftext.language.gbind.resource.gbind.IGbindOptions.DISABLE_CREATING_MARKERS_FOR_PROBLEMS, "true");
				org.eclipse.emf.ecore.resource.Resource emfResource = rs.getResource(uri, true);
				if (emfResource instanceof org.emftext.language.gbind.resource.gbind.mopp.GbindResource) {
					org.emftext.language.gbind.resource.gbind.mopp.GbindResource customResource = (org.emftext.language.gbind.resource.gbind.mopp.GbindResource) emfResource;
					org.eclipse.emf.ecore.util.EcoreUtil.resolveAll(customResource);
					java.util.Collection<org.emftext.language.gbind.resource.gbind.IGbindQuickFix> quickFixes = getQuickFixes(customResource, marker);
					java.util.List<org.eclipse.ui.IMarkerResolution2> resolutions = new java.util.ArrayList<org.eclipse.ui.IMarkerResolution2>();
					for (final org.emftext.language.gbind.resource.gbind.IGbindQuickFix quickFix : quickFixes) {
						resolutions.add(new org.eclipse.ui.IMarkerResolution2() {
							...
							public void run(org.eclipse.core.resources.IMarker marker) {
								...
								try {
									...
									org.emftext.language.gbind.resource.gbind.ui.GbindUIPlugin.logError("Exception while applying quick fix", e);
								}
							}
			...
			org.emftext.language.gbind.resource.gbind.ui.GbindUIPlugin.logError("Exception while computing quick fix resolutions", e);
		}
		return new org.eclipse.ui.IMarkerResolution[] {};
	}
	
	public java.util.Collection<org.emftext.language.gbind.resource.gbind.IGbindQuickFix> getQuickFixes(org.emftext.language.gbind.resource.gbind.IGbindTextResource resource, org.eclipse.core.resources.IMarker marker) {
		...
		try {
			...
			if (quickFixContexts != null) {
				...
				for (String quickFixContext : quickFixContextParts) {
					org.emftext.language.gbind.resource.gbind.IGbindQuickFix quickFix = resource.getQuickFix(quickFixContext);
					if (quickFix != null) {
