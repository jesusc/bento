...
public class GbindBracketSet {
	...
	private java.util.ArrayList<org.emftext.language.gbind.resource.gbind.IGbindBracketPair> bracketPairs;
	 ...
	 */
	private class BracketPair implements org.emftext.language.gbind.resource.gbind.IGbindBracketPair {
	 ...
	 */
	private class ClosingListener implements org.emftext.language.gbind.resource.gbind.ui.IGbindBracketHandler, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.ModifyListener, org.eclipse.swt.custom.VerifyKeyListener {
		...
		public void verifyText(org.eclipse.swt.events.VerifyEvent e) {
			...
			if (caret > 0 && caret < textWidget.getCharCount()) {
				org.emftext.language.gbind.resource.gbind.IGbindBracketPair bracketPair = getBracketPair(textWidget.getTextRange(caret - 1, 1), textWidget.getTextRange(caret, 1));
	 ...
	 */
	public GbindBracketSet(org.emftext.language.gbind.resource.gbind.ui.GbindEditor editor, org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		languageID = new org.emftext.language.gbind.resource.gbind.mopp.GbindMetaInformation().getSyntaxName();
		this.bracketPairs = new java.util.ArrayList<org.emftext.language.gbind.resource.gbind.IGbindBracketPair>();
	 ...
	 */
	public org.emftext.language.gbind.resource.gbind.IGbindBracketPair getBracketPair(String opening, String closing) {
		for (org.emftext.language.gbind.resource.gbind.IGbindBracketPair bracketPair : bracketPairs) {
	...
	public org.emftext.language.gbind.resource.gbind.IGbindBracketPair getBracketPair(int index) {
		try {
	 ...
	 */
	public boolean setClosingEnabledInside(org.emftext.language.gbind.resource.gbind.IGbindBracketPair bracketPair, boolean closingEnabledInside) {
	...
	public boolean resetBrackets() {
		String bracketPairs = preferenceStore.getString(languageID + org.emftext.language.gbind.resource.gbind.ui.GbindPreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	 ...
	 */
	public org.emftext.language.gbind.resource.gbind.IGbindBracketPair remove(String opening, String closing) {
		for (org.emftext.language.gbind.resource.gbind.IGbindBracketPair bracketPair : bracketPairs) {
			if (bracketPair.getOpeningBracket().equals(opening) && bracketPair.getClosingBracket().equals(closing)) {
	...
	public boolean setBrackets(String bracketSet) {
		...
		bracketPairs = new java.util.ArrayList<org.emftext.language.gbind.resource.gbind.IGbindBracketPair>();
	...
	public void matchingBrackets() {
		...
		if (position != -1 && position != document.getLength()) {
			positionHelper.addPosition(document, org.emftext.language.gbind.resource.gbind.ui.GbindPositionCategory.BRACKET.toString(), position, 1);
			positionHelper.addPosition(document, org.emftext.language.gbind.resource.gbind.ui.GbindPositionCategory.BRACKET.toString(), caretOffset - 1, 1);
		}
	}
