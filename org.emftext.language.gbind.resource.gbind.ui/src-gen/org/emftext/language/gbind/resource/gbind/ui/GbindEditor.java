...
/**
 * A text editor for 'gbind' models.
 */
public class GbindEditor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider, org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener, org.eclipse.emf.common.ui.viewer.IViewerProvider, org.emftext.language.gbind.resource.gbind.IGbindResourceProvider, org.emftext.language.gbind.resource.gbind.ui.IGbindBracketHandlerProvider, org.emftext.language.gbind.resource.gbind.ui.IGbindAnnotationModelProvider {
	
	private org.emftext.language.gbind.resource.gbind.ui.GbindHighlighting highlighting;
	private org.eclipse.jface.text.source.projection.ProjectionSupport projectionSupport;
	private org.emftext.language.gbind.resource.gbind.ui.GbindCodeFoldingManager codeFoldingManager;
	private org.emftext.language.gbind.resource.gbind.ui.GbindBackgroundParsingStrategy bgParsingStrategy = new org.emftext.language.gbind.resource.gbind.ui.GbindBackgroundParsingStrategy();
	private java.util.Collection<org.emftext.language.gbind.resource.gbind.IGbindBackgroundParsingListener> bgParsingListeners = new java.util.ArrayList<org.emftext.language.gbind.resource.gbind.IGbindBackgroundParsingListener>();
	private org.emftext.language.gbind.resource.gbind.ui.GbindColorManager colorManager = new org.emftext.language.gbind.resource.gbind.ui.GbindColorManager();
	private org.emftext.language.gbind.resource.gbind.ui.GbindOutlinePage outlinePage;
	...
	private org.emftext.language.gbind.resource.gbind.ui.GbindPropertySheetPage propertySheetPage;
	...
	private org.emftext.language.gbind.resource.gbind.ui.IGbindBracketHandler bracketHandler;
	...
	public GbindEditor() {
		super();
		setSourceViewerConfiguration(new org.emftext.language.gbind.resource.gbind.ui.GbindEditorConfiguration(this, this, this, colorManager));
	...
	private final class DocumentListener implements org.eclipse.jface.text.IDocumentListener {
		...
		public void documentChanged(org.eclipse.jface.text.DocumentEvent event) {
			bgParsingStrategy.parse(event, getResource(), GbindEditor.this);
		}
	}
	...
	private class ModelResourceChangeListener implements org.eclipse.core.resources.IResourceChangeListener {
		public void resourceChanged(org.eclipse.core.resources.IResourceChangeEvent event) {
			...
			try {
					...
					public boolean visit(org.eclipse.core.resources.IResourceDelta delta) {
						...
						if (deltaKind == org.eclipse.core.resources.IResourceDelta.CHANGED && delta.getFlags() != org.eclipse.core.resources.IResourceDelta.MARKERS) {
							...
							if (changedResource != null) {
								...
								org.emftext.language.gbind.resource.gbind.IGbindTextResource currentResource = getResource();
				...
				org.emftext.language.gbind.resource.gbind.ui.GbindUIPlugin.logError("Unexpected Error: ", exception);
			}
		}
	}
	...
	public void initializeEditor() {
		...
		setEditorContextMenuId("org.emftext.language.gbind.resource.gbind.EditorContext");
		setRulerContextMenuId("org.emftext.language.gbind.resource.gbind.EditorRuler");
	}
	...
	public void createPartControl(org.eclipse.swt.widgets.Composite parent) {
		...
		highlighting = new org.emftext.language.gbind.resource.gbind.ui.GbindHighlighting(getResource(), viewer, colorManager, this);
		...
		codeFoldingManager = new org.emftext.language.gbind.resource.gbind.ui.GbindCodeFoldingManager(viewer, this);
	}
	...
	private void initializeResourceObject(org.eclipse.ui.IEditorInput editorInput) {
		...
		org.emftext.language.gbind.resource.gbind.mopp.GbindNature.activate(inputFile.getProject());
		...
		org.emftext.language.gbind.resource.gbind.IGbindTextResource loadedResource = (org.emftext.language.gbind.resource.gbind.IGbindTextResource) resourceSet.getResource(uri, false);
		if (loadedResource == null) {
			try {
				...
				org.emftext.language.gbind.resource.gbind.IGbindTextResource currentResource = this.resource;
				...
				if (demandLoadedResource instanceof org.emftext.language.gbind.resource.gbind.IGbindTextResource) {
					setResource((org.emftext.language.gbind.resource.gbind.IGbindTextResource) demandLoadedResource);
				} else {
					// the resource was not loaded by an EMFText resource, but some other EMF resource
					org.emftext.language.gbind.resource.gbind.ui.GbindUIPlugin.showErrorDialog("No EMFText resource.", "The file '" + uri.lastSegment() + "' of type '" + uri.fileExtension() + "' can not be handled by the GbindEditor.");
					// close this editor because it can not present the resource
					close(false);
				}
			} catch (Exception e) {
				org.emftext.language.gbind.resource.gbind.ui.GbindUIPlugin.logError("Exception while loading resource in " + this.getClass().getSimpleName() + ".", e);
			}
		} else {
	...
	private void setResource(org.emftext.language.gbind.resource.gbind.IGbindTextResource resource) {
	...
	private Object getOutlinePage() {
		if (outlinePage == null) {
			outlinePage = new org.emftext.language.gbind.resource.gbind.ui.GbindOutlinePage(this);
	...
	public org.eclipse.ui.views.properties.IPropertySheetPage getPropertySheetPage() {
		if (propertySheetPage == null) {
			propertySheetPage = new org.emftext.language.gbind.resource.gbind.ui.GbindPropertySheetPage();
	...
	public void setCaret(org.eclipse.emf.ecore.EObject element, String text) {
		try {
			...
			org.eclipse.jface.text.source.ISourceViewer viewer = getSourceViewer();
			org.emftext.language.gbind.resource.gbind.IGbindTextResource textResource = (org.emftext.language.gbind.resource.gbind.IGbindTextResource) element.eResource();
			org.emftext.language.gbind.resource.gbind.IGbindLocationMap locationMap = textResource.getLocationMap();
			int destination = locationMap.getCharStart(element);
			int length = locationMap.getCharEnd(element) + 1 - destination;
			
			org.emftext.language.gbind.resource.gbind.IGbindTextScanner lexer = getResource().getMetaInformation().createLexer();
			try {
				lexer.setText(viewer.getDocument().get(destination, length));
				org.emftext.language.gbind.resource.gbind.IGbindTextToken token = lexer.getNextToken();
			...
			org.emftext.language.gbind.resource.gbind.ui.GbindUIPlugin.logError("Exception in setCaret()", e);
		}
	}
	...
	protected org.eclipse.jface.text.source.ISourceViewer createSourceViewer(org.eclipse.swt.widgets.Composite parent, org.eclipse.jface.text.source.IVerticalRuler ruler, int styles) {
		org.eclipse.jface.text.source.ISourceViewer viewer = new org.eclipse.jface.text.source.projection.ProjectionViewer(parent, ruler, getOverviewRuler(), isOverviewRulerVisible(), styles) {
			...
			public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
				if (!GbindEditor.this.setSelection(selection, reveal)) {
	...
	public void addBackgroundParsingListener(org.emftext.language.gbind.resource.gbind.IGbindBackgroundParsingListener listener) {
		bgParsingListeners.add(listener);
	}
	
	public void notifyBackgroundParsingFinished() {
		for (org.emftext.language.gbind.resource.gbind.IGbindBackgroundParsingListener listener : bgParsingListeners) {
			listener.parsingCompleted(getResource());
		}
	}
	
	public org.emftext.language.gbind.resource.gbind.ui.IGbindBracketHandler getBracketHandler() {
		return bracketHandler;
	}
	
	public void setBracketHandler(org.emftext.language.gbind.resource.gbind.ui.IGbindBracketHandler bracketHandler) {
