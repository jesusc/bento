 ...
 */
public class GbindSyntaxColoringPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	public GbindSyntaxColoringPreferencePage() {
		super();
		
		org.emftext.language.gbind.resource.gbind.IGbindMetaInformation syntaxPlugin = new org.emftext.language.gbind.resource.gbind.mopp.GbindMetaInformation();
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = org.emftext.language.gbind.resource.gbind.ui.GbindSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.gbind.resource.gbind.ui.GbindSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = org.emftext.language.gbind.resource.gbind.ui.GbindSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.gbind.resource.gbind.ui.GbindSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = org.emftext.language.gbind.resource.gbind.ui.GbindSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.gbind.resource.gbind.ui.GbindSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = org.emftext.language.gbind.resource.gbind.ui.GbindSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.gbind.resource.gbind.ui.GbindSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = org.emftext.language.gbind.resource.gbind.ui.GbindSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.gbind.resource.gbind.ui.GbindSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = org.emftext.language.gbind.resource.gbind.ui.GbindSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.gbind.resource.gbind.ui.GbindSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(org.eclipse.swt.widgets.Composite composite, int horizontalSpan) {
		org.emftext.language.gbind.resource.gbind.ui.GbindPixelConverter pixelConverter = new org.emftext.language.gbind.resource.gbind.ui.GbindPixelConverter(composite);
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof org.emftext.language.gbind.resource.gbind.ui.GbindEditor) {
			org.emftext.language.gbind.resource.gbind.ui.GbindEditor emfTextEditor = (org.emftext.language.gbind.resource.gbind.ui.GbindEditor) editor;
