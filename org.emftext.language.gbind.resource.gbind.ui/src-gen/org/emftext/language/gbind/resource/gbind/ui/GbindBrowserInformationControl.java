 ...
 * @since 3.2
 */
public class GbindBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private org.emftext.language.gbind.resource.gbind.ui.GbindDocBrowserInformationControlInput fInput;
	 ...
	 */
	public GbindBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, boolean resizable) {
	 ...
	 */
	public GbindBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, String statusFieldText) {
	 ...
	 * @since 3.4
	 */
	public GbindBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, org.eclipse.jface.action.ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof org.emftext.language.gbind.resource.gbind.ui.GbindDocBrowserInformationControlInput);
		...
		fInput= (org.emftext.language.gbind.resource.gbind.ui.GbindDocBrowserInformationControlInput) input;
		...
		org.emftext.language.gbind.resource.gbind.ui.GbindHTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = org.emftext.language.gbind.resource.gbind.ui.GbindHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	 ...
	 */
	public org.emftext.language.gbind.resource.gbind.ui.GbindDocBrowserInformationControlInput getInput() {
		return fInput;
	}
