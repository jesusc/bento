 ...
 */
public class GbindUIPlugin extends org.eclipse.ui.plugin.AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "org.emftext.language.gbind.resource.gbind.ui";
	public static final String EDITOR_ID = "org.emftext.language.gbind.resource.gbind.ui.GbindEditor";
	...
	private static GbindUIPlugin plugin;
	
	public GbindUIPlugin() {
		super();
	}
	...
	public static GbindUIPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, GbindUIPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, GbindUIPlugin.PLUGIN_ID, message);
		}
		final GbindUIPlugin pluginInstance = GbindUIPlugin.getDefault();
