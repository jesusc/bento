 ...
 */
public class GbindImageProvider {
	
	public final static GbindImageProvider INSTANCE = new GbindImageProvider();
	...
	public org.eclipse.swt.graphics.Image getImage(String key) {
		...
		org.eclipse.jface.resource.ImageDescriptor descriptor = org.eclipse.jface.resource.ImageDescriptor.createFromURL(org.eclipse.core.runtime.FileLocator.find(org.emftext.language.gbind.resource.gbind.ui.GbindUIPlugin.getDefault().getBundle(), path, null));
		if (org.eclipse.jface.resource.ImageDescriptor.getMissingImageDescriptor().equals(descriptor) || descriptor == null) {
			...
			try {
				...
				org.emftext.language.gbind.resource.gbind.ui.GbindUIPlugin.logError("IconProvider can't load image (URL is malformed).", mue);
			}
		}
